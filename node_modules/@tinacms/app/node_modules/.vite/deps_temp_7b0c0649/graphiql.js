...
var require_encode = __commonJS({
  "node_modules/mdurl/encode.js"(exports, module) {
    ...
    function encode2(string, exclude, keepEscaped) {
      var i9, l11, code, nextCode, cache, result = "";
      ...
      for (i9 = 0, l11 = string.length; i9 < l11; i9++) {
        code = string.charCodeAt(i9);
        if (keepEscaped && code === 37 && i9 + 2 < l11) {
        ...
        if (code >= 55296 && code <= 57343) {
          if (code >= 55296 && code <= 56319 && i9 + 1 < l11) {
  ...
  "node_modules/mdurl/decode.js"(exports, module) {
    ...
    function decode2(string, exclude) {
      ...
      return string.replace(/(%[a-f0-9]{2})+/gi, function(seq) {
        var i9, l11, b1, b22, b32, b42, chr, result = "";
        for (i9 = 0, l11 = seq.length; i9 < l11; i9 += 3) {
          b1 = parseInt(seq.slice(i9 + 1, i9 + 3), 16);
          if (b1 < 128) {
            result += cache[b1];
            continue;
          }
          if ((b1 & 224) === 192 && i9 + 3 < l11) {
...
var require_parse = __commonJS({
  "node_modules/mdurl/parse.js"(exports, module) {
    ...
    Url.prototype.parse = function(url, slashesDenoteHost) {
      var i9, l11, lowerProto, hec, slashes, rest = url;
      rest = rest.trim();
      ...
      if (!hostlessProtocol[proto] && (slashes || proto && !slashedProtocol[proto])) {
        ...
        if (!ipv6Hostname) {
          ...
          for (i9 = 0, l11 = hostparts.length; i9 < l11; i9++) {
...
var require_utils = __commonJS({
  "node_modules/markdown-it/lib/common/utils.js"(exports) {
    ...
    function isValidEntityCode(c15) {
      if (c15 >= 55296 && c15 <= 57343) {
        return false;
      }
      if (c15 >= 64976 && c15 <= 65007) {
        return false;
      }
      if ((c15 & 65535) === 65535 || (c15 & 65535) === 65534) {
        return false;
      }
      if (c15 >= 0 && c15 <= 8) {
        return false;
    ...
    function fromCodePoint(c15) {
      if (c15 > 65535) {
        c15 -= 65536;
        var surrogate1 = 55296 + (c15 >> 10), surrogate2 = 56320 + (c15 & 1023);
        return String.fromCharCode(surrogate1, surrogate2);
      }
      return String.fromCharCode(c15);
    }
...
var require_renderer = __commonJS({
  "node_modules/markdown-it/lib/renderer.js"(exports, module) {
    ...
    Renderer.prototype.renderAttrs = function renderAttrs(token) {
      ...
      result = "";
      for (i9 = 0, l11 = token.attrs.length; i9 < l11; i9++) {
...
var require_inline = __commonJS({
  "node_modules/markdown-it/lib/rules_core/inline.js"(exports, module) {
    ...
    module.exports = function inline(state) {
      var tokens = state.tokens, tok, i9, l11;
      for (i9 = 0, l11 = tokens.length; i9 < l11; i9++) {
        tok = tokens[i9];
        if (tok.type === "inline") {
...
var require_linkify = __commonJS({
  "node_modules/markdown-it/lib/rules_core/linkify.js"(exports, module) {
    ...
    module.exports = function linkify(state) {
      var i9, j7, l11, tokens, token, currentToken, nodes, ln2, text, pos, lastPos, level, htmlLinkLevel, url, fullUrl, urlText, blockTokens = state.tokens, links;
      ...
      for (j7 = 0, l11 = blockTokens.length; j7 < l11; j7++) {
        ...
        for (i9 = tokens.length - 1; i9 >= 0; i9--) {
          ...
          if (currentToken.type === "text" && state.md.linkify.test(currentToken.content)) {
            ...
            blockTokens[j7].children = tokens = arrayReplaceAt(tokens, i9, nodes);
          }
        }
      }
    };
...
var require_smartquotes = __commonJS({
  "node_modules/markdown-it/lib/rules_core/smartquotes.js"(exports, module) {
    ...
    function process_inlines(tokens, state) {
      var i9, token, text, t17, pos, max, thisLevel, item, lastChar, nextChar, isLastPunctChar, isNextPunctChar, isLastWhiteSpace, isNextWhiteSpace, canOpen, canClose, j7, isSingle, stack, openQuote, closeQuote;
      stack = [];
      for (i9 = 0; i9 < tokens.length; i9++) {
        ...
        OUTER:
          while (pos < max) {
            ...
            lastChar = 32;
            if (t17.index - 1 >= 0) {
              lastChar = text.charCodeAt(t17.index - 1);
            } else {
              for (j7 = i9 - 1; j7 >= 0; j7--) {
            ...
            if (pos < max) {
              ...
              for (j7 = i9 + 1; j7 < tokens.length; j7++) {
                if (tokens[j7].type === "softbreak" || tokens[j7].type === "hardbreak")
                  break;
                if (!tokens[j7].content)
                  continue;
            ...
            if (!canOpen && !canClose) {
              if (isSingle) {
                token.content = replaceAt(token.content, t17.index, APOSTROPHE);
              }
              continue;
            }
            if (canClose) {
              for (j7 = stack.length - 1; j7 >= 0; j7--) {
                ...
                if (item.single === isSingle && stack[j7].level === thisLevel) {
                  ...
                  token.content = replaceAt(token.content, t17.index, closeQuote);
...
var require_parser_core = __commonJS({
  "node_modules/markdown-it/lib/parser_core.js"(exports, module) {
    ...
    Core.prototype.process = function(state) {
      ...
      for (i9 = 0, l11 = rules.length; i9 < l11; i9++) {
        rules[i9](state);
      }
    };
...
var require_table = __commonJS({
  "node_modules/markdown-it/lib/rules_block/table.js"(exports, module) {
    ...
    module.exports = function table(state, startLine, endLine, silent) {
      var ch, lineText, pos, i9, l11, nextLine, columns, columnCount, token, aligns, t17, tableLines, tbodyLines, oldParentType, terminate, terminatorRules, firstCh, secondCh;
      ...
      for (i9 = 0; i9 < columns.length; i9++) {
        ...
        if (t17.charCodeAt(t17.length - 1) === 58) {
          aligns.push(t17.charCodeAt(0) === 58 ? "center" : "right");
        } else if (t17.charCodeAt(0) === 58) {
          aligns.push("left");
        } else {
          aligns.push("");
        }
      ...
      for (nextLine = startLine + 2; nextLine < endLine; nextLine++) {
        ...
        terminate = false;
        for (i9 = 0, l11 = terminatorRules.length; i9 < l11; i9++) {
...
var require_blockquote = __commonJS({
  "node_modules/markdown-it/lib/rules_block/blockquote.js"(exports, module) {
    ...
    module.exports = function blockquote(state, startLine, endLine, silent) {
      var adjustTab, ch, i9, initial, l11, lastLineEmpty, lines, nextLine, offset, oldBMarks, oldBSCount, oldIndent, oldParentType, oldSCount, oldTShift, spaceAfterMarker, terminate, terminatorRules, token, isOutdented, oldLineMax = state.lineMax, pos = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine];
      if (state.sCount[startLine] - state.blkIndent >= 4) {
        return false;
      }
...
var require_list = __commonJS({
  "node_modules/markdown-it/lib/rules_block/list.js"(exports, module) {
    ...
    function markTightParagraphs(state, idx) {
      var i9, l11, level = state.level + 2;
      for (i9 = idx + 2, l11 = state.tokens.length - 2; i9 < l11; i9++) {
    ...
    module.exports = function list(state, startLine, endLine, silent) {
      var ch, contentStart, i9, indent, indentAfterMarker, initial, isOrdered, itemLines, l11, listLines, listTokIdx, markerCharCode, markerValue, max, nextLine, offset, oldListIndent, oldParentType, oldSCount, oldTShift, oldTight, pos, posAfterMarker, prevEmptyEnd, start, terminate, terminatorRules, token, isTerminatingParagraph = false, tight = true;
      if (state.sCount[startLine] - state.blkIndent >= 4) {
        return false;
      }
...
var require_reference = __commonJS({
  "node_modules/markdown-it/lib/rules_block/reference.js"(exports, module) {
    ...
    module.exports = function reference(state, startLine, _endLine, silent) {
      var ch, destEndPos, destEndLineNo, endLine, href, i9, l11, label, labelEnd, oldParentType, res, start, str, terminate, terminatorRules, title, lines = 0, pos = state.bMarks[startLine] + state.tShift[startLine], max = state.eMarks[startLine], nextLine = startLine + 1;
      if (state.sCount[startLine] - state.blkIndent >= 4) {
        return false;
      }
...
var require_lheading = __commonJS({
  "node_modules/markdown-it/lib/rules_block/lheading.js"(exports, module) {
    ...
    module.exports = function lheading(state, startLine, endLine) {
      var content, terminate, i9, l11, token, pos, max, level, marker, nextLine = startLine + 1, oldParentType, terminatorRules = state.md.block.ruler.getRules("paragraph");
      if (state.sCount[startLine] - state.blkIndent >= 4) {
        return false;
      }
      oldParentType = state.parentType;
...
var require_paragraph = __commonJS({
  "node_modules/markdown-it/lib/rules_block/paragraph.js"(exports, module) {
    ...
    module.exports = function paragraph(state, startLine) {
      var content, terminate, i9, l11, token, oldParentType, nextLine = startLine + 1, terminatorRules = state.md.block.ruler.getRules("paragraph"), endLine = state.lineMax;
      oldParentType = state.parentType;
      state.parentType = "paragraph";
      for (; nextLine < endLine && !state.isEmpty(nextLine); nextLine++) {
        if (state.sCount[nextLine] - state.blkIndent > 3) {
...
var require_strikethrough = __commonJS({
  "node_modules/markdown-it/lib/rules_inline/strikethrough.js"(exports, module) {
    ...
    function postProcess(state, delimiters) {
      var i9, j7, startDelim, endDelim, token, loneMarkers = [], max = delimiters.length;
      for (i9 = 0; i9 < max; i9++) {
      ...
      while (loneMarkers.length) {
        ...
        if (i9 !== j7) {
          ...
          state.tokens[j7] = state.tokens[i9];
...
var require_linkify_it = __commonJS({
  "node_modules/linkify-it/index.js"(exports, module) {
    ...
    LinkifyIt.prototype.test = function test2(text) {
      ...
      var m12, ml, me5, len, shift, next, re6, tld_pos, at_pos;
      if (this.re.schema_test.test(text)) {
        re6 = this.re.schema_search;
        re6.lastIndex = 0;
        while ((m12 = re6.exec(text)) !== null) {
          len = this.testSchemaAt(text, m12[2], re6.lastIndex);
          if (len) {
    ...
    decode = function(input) {
      ...
      for (let index2 = basic > 0 ? basic + 1 : 0; index2 < inputLength; ) {
        ...
        for (let w6 = 1, k2 = base; ; k2 += base) {
          ...
          i9 += digit * w6;
          const t17 = k2 <= bias ? tMin : k2 >= bias + tMax ? tMax : k2 - bias;
          if (digit < t17) {
            break;
          }
          const baseMinusT = base - t17;
        ...
        for (const currentValue of input) {
          ...
          if (currentValue === n7) {
            ...
            for (let k2 = base; ; k2 += base) {
              ...
              const qMinusT = q6 - t17;
              const baseMinusT = base - t17;
              output.push(
                stringFromCharCode(digitToBasic(t17 + qMinusT % baseMinusT, 0))
              );
...
function sortTransformProps(a15, b8) {
  return transformProps.indexOf(a15) - transformProps.indexOf(b8);
}
...
var splitColor = (aName, bName, cName) => (v5) => {
  if (!isString(v5))
    return v5;
  const [a15, b8, c15, alpha2] = v5.match(floatRegex);
  return {
    [aName]: parseFloat(a15),
    [bName]: parseFloat(b8),
    [cName]: parseFloat(c15),
...
function createTransformer(v5) {
  ...
  return (v6) => {
    ...
    for (let i9 = 0; i9 < numValues; i9++) {
      output = output.replace(i9 < numColors ? colorToken : numberToken, i9 < numColors ? color.transform(v6[i9]) : sanitize(v6[i9]));
    }
    return output;
  };
}
...
function pointFromTouch(e5, pointType) {
  ...
  var primaryTouch = e5.touches[0] || e5.changedTouches[0];
...
function findSpring({ duration = 800, bounce = 0.25, velocity = 0, mass = 1 }) {
  ...
  if (dampingRatio < 1) {
    envelope = (undampedFreq2) => {
      ...
      const c15 = Math.exp(-delta);
      return safeMin - a15 / b8 * c15;
    };
    derivative = (undampedFreq2) => {
      const exponentialDecay = undampedFreq2 * dampingRatio;
      const delta = exponentialDecay * duration;
      const d13 = delta * velocity + velocity;
      const e5 = Math.pow(dampingRatio, 2) * Math.pow(undampedFreq2, 2) * duration;
      const f14 = Math.exp(-delta);
      const g6 = calcAngularFreq(Math.pow(undampedFreq2, 2), dampingRatio);
      const factor = -envelope(undampedFreq2) + safeMin > 0 ? -1 : 1;
      return factor * ((d13 - e5) * f14) / g6;
    };
  } else {
    envelope = (undampedFreq2) => {
      const a15 = Math.exp(-undampedFreq2 * duration);
      const b8 = (undampedFreq2 - velocity) * duration + 1;
      return -safeMin + a15 * b8;
    };
    derivative = (undampedFreq2) => {
      const a15 = Math.exp(-undampedFreq2 * duration);
...
function spring(_a) {
  ...
  function createSpring() {
    ...
    if (dampingRatio < 1) {
      ...
      resolveSpring = (t17) => {
        const envelope = Math.exp(-dampingRatio * undampedAngularFreq * t17);
        return to3 - envelope * ((initialVelocity + dampingRatio * undampedAngularFreq * initialDelta) / angularFreq * Math.sin(angularFreq * t17) + initialDelta * Math.cos(angularFreq * t17));
      };
      resolveVelocity = (t17) => {
        const envelope = Math.exp(-dampingRatio * undampedAngularFreq * t17);
        return dampingRatio * undampedAngularFreq * envelope * (Math.sin(angularFreq * t17) * (initialVelocity + dampingRatio * undampedAngularFreq * initialDelta) / angularFreq + initialDelta * Math.cos(angularFreq * t17)) - envelope * (Math.cos(angularFreq * t17) * (initialVelocity + dampingRatio * undampedAngularFreq * initialDelta) - angularFreq * initialDelta * Math.sin(angularFreq * t17));
      };
    } else if (dampingRatio === 1) {
      resolveSpring = (t17) => to3 - Math.exp(-undampedAngularFreq * t17) * (initialDelta + (initialVelocity + undampedAngularFreq * initialDelta) * t17);
    } else {
      const dampedAngularFreq = undampedAngularFreq * Math.sqrt(dampingRatio * dampingRatio - 1);
      resolveSpring = (t17) => {
        const envelope = Math.exp(-dampingRatio * undampedAngularFreq * t17);
        const freqForT = Math.min(dampedAngularFreq * t17, 300);
  ...
  return {
    next: (t17) => {
      const current = resolveSpring(t17);
      if (!isResolvedFromDuration) {
        const currentVelocity = resolveVelocity(t17) * 1e3;
...
spring.needsInterpolation = (a15, b8) => typeof a15 === "string" || typeof b8 === "string";
var zero = (_t3) => 0;
...
function hueToRgb(p7, q6, t17) {
  if (t17 < 0)
    t17 += 1;
  if (t17 > 1)
    t17 -= 1;
  if (t17 < 1 / 6)
    return p7 + (q6 - p7) * 6 * t17;
  if (t17 < 1 / 2)
    return q6;
  if (t17 < 2 / 3)
    return p7 + (q6 - p7) * (2 / 3 - t17) * 6;
  return p7;
}
...
var combineFunctions = (a15, b8) => (v5) => b8(a15(v5));
...
var mixArray = (from, to3) => {
  ...
  const blendValue = from.map((fromThis, i9) => getMixer(fromThis, to3[i9]));
  return (v5) => {
    for (let i9 = 0; i9 < numValues; i9++) {
      output[i9] = blendValue[i9](v5);
    }
    return output;
  };
};
...
var mixNumber = (from, to3) => (p7) => mix(from, to3, p7);
  ...
  return (v5) => {
    ...
    if (!foundMixerIndex) {
      ...
      for (; i9 < inputLength; i9++) {
        if (input[i9] > v5 || i9 === lastInputIndex) {
          break;
        }
      }
      mixerIndex = i9 - 1;
...
function decay({ velocity = 0, from = 0, power = 0.8, timeConstant = 350, restDelta = 0.5, modifyTarget }) {
  ...
  return {
    next: (t17) => {
      const delta = -amplitude * Math.exp(-t17 / timeConstant);
...
var distance1D = (a15, b8) => Math.abs(a15 - b8);
function distance(a15, b8) {
  if (isNum(a15) && isNum(b8)) {
    return distance1D(a15, b8);
  } else if (isPoint(a15) && isPoint(b8)) {
    const xDelta = distance1D(a15.x, b8.x);
    const yDelta = distance1D(a15.y, b8.y);
    const zDelta = isPoint3D(a15) && isPoint3D(b8) ? distance1D(a15.z, b8.z) : 0;
...
var c = (a1) => 3 * a1;
var calcBezier = (t17, a1, a22) => ((a(a1, a22) * t17 + b(a1, a22)) * t17 + c(a1)) * t17;
var getSlope = (t17, a1, a22) => 3 * a(a1, a22) * t17 * t17 + 2 * b(a1, a22) * t17 + c(a1);
...
var SubscriptionManager = (
  ...
  function() {
    ...
    SubscriptionManager2.prototype.notify = function(a15, b8, c15) {
      var numSubscriptions = this.subscriptions.length;
      if (!numSubscriptions)
        return;
      if (numSubscriptions === 1) {
        this.subscriptions[0](a15, b8, c15);
      } else {
        for (var i9 = 0; i9 < numSubscriptions; i9++) {
          var handler = this.subscriptions[i9];
          handler && handler(a15, b8, c15);
        }
      }
    };
...
function sortByTreeOrder(a15, b8) {
  return a15.sortNodePosition(b8);
}
...
function subtractPoint(a15, b8) {
  return { x: a15.x - b8.x, y: a15.y - b8.y };
}
...
function convertBoxToBoundingBox(_a) {
  var x6 = _a.x, y8 = _a.y;
  return { top: y8.min, right: x6.max, bottom: y8.max, left: x6.min };
}
...
function applyBoxDelta(box, _a) {
  var x6 = _a.x, y8 = _a.y;
  applyAxisDelta(box.x, x6.translate, x6.scale, x6.originPoint);
...
var positionalValues = {
  ...
  width: function(_a, _b) {
    ...
    return x6.max - x6.min - parseFloat(paddingLeft) - parseFloat(paddingRight);
  },
  height: function(_a, _b) {
    var y8 = _a.y;
    var _c = _b.paddingTop, paddingTop = _c === void 0 ? "0" : _c, _d = _b.paddingBottom, paddingBottom = _d === void 0 ? "0" : _d;
    return y8.max - y8.min - parseFloat(paddingTop) - parseFloat(paddingBottom);
  },
  ...
  bottom: function(_a, _b) {
    var y8 = _a.y;
    var top = _b.top;
    return parseFloat(top) + (y8.max - y8.min);
  },
  right: function(_a, _b) {
    var x6 = _a.x;
    var left = _b.left;
    return parseFloat(left) + (x6.max - x6.min);
  },
  // Transform
  ...
  targetPositionalKeys.forEach(function(key) {
    ...
    if (isKeyframesTarget(to3)) {
      ...
      for (var i9 = fromIndex; i9 < numKeyframes; i9++) {
        if (!toType) {
          toType = findDimensionValueType(to3[i9]);
          invariant(toType === fromType || isNumOrPxType(fromType) && isNumOrPxType(toType), "Keyframes must be of the same dimension as the current value");
        } else {
          invariant(findDimensionValueType(to3[i9]) === toType, "All keyframes must be of the same type");
        }
      }
    } else {
...
var htmlConfig = {
  ...
  sortNodePosition: function(a15, b8) {
    return a15.compareDocumentPosition(b8) & 2 ? 1 : -1;
  },
...
var correctBorderRadius = {
  correct: function(latest, node) {
    ...
    var x6 = pixelsToPercent(latest, node.target.x);
    var y8 = pixelsToPercent(latest, node.target.y);
    return "".concat(x6, "% ").concat(y8, "%");
  }
};
...
function boxEquals(a15, b8) {
  return a15.x.min === b8.x.min && a15.x.max === b8.x.max && a15.y.min === b8.y.min && a15.y.max === b8.y.max;
}
...
var compareByDepth = function(a15, b8) {
  return a15.depth - b8.depth;
};
  ...
  return (
    ...
    function() {
      ...
      ProjectionNode.prototype.getProjectionStyles = function(styleProp) {
        ...
        var _g = this.projectionDelta, x6 = _g.x, y8 = _g.y;
        styles.transformOrigin = "".concat(x6.origin * 100, "% ").concat(y8.origin * 100, "% 0");
...
function mixAxis(output, from, to3, p7) {
  output.min = mix(from.min, to3.min, p7);
  output.max = mix(from.max, to3.max, p7);
}
function mixBox(output, from, to3, p7) {
  mixAxis(output.x, from.x, to3.x, p7);
  mixAxis(output.y, from.y, to3.y, p7);
}
...
function compareMin(a15, b8) {
  return a15.layout.min - b8.layout.min;
}
...
var calcBezier2 = (t17, a1, a22) => (((1 - 3 * a22 + 3 * a1) * t17 + (3 * a22 - 6 * a1)) * t17 + 3 * a1) * t17;
var subdivisionPrecision2 = 1e-7;
var subdivisionMaxIterations2 = 12;
function binarySubdivide2(x6, lowerBound, upperBound, mX1, mX2) {
  let currentX;
  let currentT;
  let i9 = 0;
  do {
    currentT = lowerBound + (upperBound - lowerBound) / 2;
    currentX = calcBezier2(currentT, mX1, mX2) - x6;
    if (currentX > 0) {
      upperBound = currentT;
    } else {
      lowerBound = currentT;
...
function cubicBezier2(mX1, mY1, mX2, mY2) {
  ...
  return (t17) => t17 === 0 || t17 === 1 ? t17 : calcBezier2(getTForX(t17), mY1, mY2);
}
...
function calcGeneratorVelocity(resolveValue, t17, current) {
  const prevT = Math.max(t17 - sampleT, 0);
  return velocityPerSecond2(current - resolveValue(prevT), t17 - prevT);
}
...
var spring2 = ({ stiffness = defaults2.stiffness, damping = defaults2.damping, mass = defaults2.mass, from = 0, to: to3 = 1, velocity = 0, restSpeed, restDistance } = {}) => {
  ...
  if (dampingRatio < 1) {
    ...
    resolveSpring = (t17) => to3 - Math.exp(-dampingRatio * undampedAngularFreq * t17) * ((-velocity + dampingRatio * undampedAngularFreq * initialDelta) / angularFreq * Math.sin(angularFreq * t17) + initialDelta * Math.cos(angularFreq * t17));
  } else {
    resolveSpring = (t17) => {
      return to3 - Math.exp(-undampedAngularFreq * t17) * (initialDelta + (-velocity + undampedAngularFreq * initialDelta) * t17);
    };
  }
  return (t17) => {
    state.current = resolveSpring(t17);
    const currentVelocity = t17 === 0 ? velocity : calcGeneratorVelocity(resolveSpring, t17, state.current);
    const isBelowVelocityThreshold = Math.abs(currentVelocity) <= restSpeed;
...
var glide = ({ from = 0, velocity = 0, power = 0.8, decay: decay2 = 0.325, bounceDamping, bounceStiffness, changeTarget, min, max, restDistance = 0.5, restSpeed }) => {
  ...
  if (target !== ideal)
    amplitude = target - from;
  const calcDelta = (t17) => -amplitude * Math.exp(-t17 / decay2);
  const calcLatest = (t17) => target + calcDelta(t17);
  const applyFriction = (t17) => {
    const delta = calcDelta(t17);
    const latest = calcLatest(t17);
    state.done = Math.abs(delta) <= restDistance;
    state.current = state.done ? target : latest;
  };
  let timeReachedBoundary;
  let spring$1;
  const checkCatchBoundary = (t17) => {
    if (!isOutOfBounds(state.current))
      return;
    timeReachedBoundary = t17;
    spring$1 = spring2({
      from: state.current,
      to: nearestBoundary(state.current),
      velocity: calcGeneratorVelocity(calcLatest, t17, state.current),
  ...
  return (t17) => {
    ...
    if (!spring$1 && timeReachedBoundary === void 0) {
      ...
      applyFriction(t17);
      checkCatchBoundary(t17);
    }
    if (timeReachedBoundary !== void 0 && t17 > timeReachedBoundary) {
      state.hasReachedTarget = true;
      return spring$1(t17 - timeReachedBoundary);
    } else {
      state.hasReachedTarget = false;
      !hasUpdatedFrame && applyFriction(t17);
      return state;
    }
  };
};
        ...
        if (shouldUseGenerator) {
          ...
          if (prevGenerator) {
            ...
            if (numKeyframes === 1 || numKeyframes === 2 && keyframes3[0] === null) {
              velocity = calcGeneratorVelocity((t17) => prevGenerator(t17).current, currentTime, prevGeneratorCurrent);
            }
          } else {
...
function $a093c7e1ec25a057$var$isPointInPolygon(point, polygon) {
  const { x: x6, y: y8 } = point;
  let inside = false;
  for (let i9 = 0, j7 = polygon.length - 1; i9 < polygon.length; j7 = i9++) {
    const xi = polygon[i9].x;
    const yi = polygon[i9].y;
    const xj = polygon[j7].x;
    const yj = polygon[j7].y;
    const intersect = yi > y8 !== yj > y8 && x6 < (xj - xi) * (y8 - yi) / (yj - yi) + xi;
    if (intersect)
      inside = !inside;
  }
  return inside;
...
function $a093c7e1ec25a057$var$getHullPresorted(points) {
  ...
  for (let i9 = 0; i9 < points.length; i9++) {
    ...
    while (upperHull.length >= 2) {
      const q6 = upperHull[upperHull.length - 1];
      const r9 = upperHull[upperHull.length - 2];
      if ((q6.x - r9.x) * (p7.y - r9.y) >= (q6.y - r9.y) * (p7.x - r9.x))
        upperHull.pop();
      else
        break;
    }
  ...
  for (let i1 = points.length - 1; i1 >= 0; i1--) {
    ...
    while (lowerHull.length >= 2) {
      const q6 = lowerHull[lowerHull.length - 1];
...
// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-iso-morphic-effect.js
var l = (e5, f14) => {
  s.isServer ? (0, import_react53.useEffect)(e5, f14) : (0, import_react53.useLayoutEffect)(e5, f14);
};

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-latest-value.js
var import_react54 = __toESM(require_react(), 1);
function s2(e5) {
  let r9 = (0, import_react54.useRef)(e5);
  return l(() => {
    r9.current = e5;
  }, [e5]), r9;
}
...
// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-computed.js
function i2(e5, o13) {
  let [u10, t17] = (0, import_react55.useState)(e5), r9 = s2(e5);
  return l(() => t17(r9.current), [r9, t17, ...o13]), u10;
}
...
function t3(e5) {
  typeof queueMicrotask == "function" ? queueMicrotask(e5) : Promise.resolve().then(e5).catch((o13) => setTimeout(() => {
    throw o13;
  }));
}
...
function o2() {
  let n7 = [], r9 = { addEventListener(e5, t17, s18, a15) {
    return e5.addEventListener(t17, s18, a15), r9.add(() => e5.removeEventListener(t17, s18, a15));
    ...
    let a15 = e5.style.getPropertyValue(t17);
    return Object.assign(e5.style, { [t17]: s18 }), this.add(() => {
      Object.assign(e5.style, { [t17]: a15 });
    });
  }, group(e5) {
    let t17 = o2();
    ...
    return n7.push(e5), () => {
      ...
      if (t17 >= 0)
        for (let s18 of n7.splice(t17, 1))
          s18();
    };
  }, dispose() {
...
// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-disposables.js
function p() {
  let [e5] = (0, import_react56.useState)(o2);
  return (0, import_react56.useEffect)(() => () => e5.dispose(), [e5]), e5;
}
...
var o4 = function(t17) {
  let e5 = s2(t17);
  return import_react57.default.useCallback((...r9) => e5.current(...r9), [e5]);
};
...
// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-id.js
var o5;
var I = (o5 = import_react58.default.useId) != null ? o5 : function() {
  let n7 = l2(), [e5, u10] = import_react58.default.useState(n7 ? () => s.nextId() : null);
  return l(() => {
...
function u(r9, n7, ...a15) {
  if (r9 in n7) {
    let e5 = n7[r9];
    return typeof e5 == "function" ? e5(...a15) : e5;
  }
...
var c3 = ["[contentEditable=true]", "[tabindex]", "a[href]", "area[href]", "button:not([disabled])", "iframe", "input:not([disabled])", "select:not([disabled])", "textarea:not([disabled])"].map((e5) => `${e5}:not([tabindex='-1'])`).join(",");
...
function f(e5 = document.body) {
  return e5 == null ? [] : Array.from(e5.querySelectorAll(c3)).sort((r9, t17) => Math.sign((r9.tabIndex || Number.MAX_SAFE_INTEGER) - (t17.tabIndex || Number.MAX_SAFE_INTEGER)));
}
...
function O(e5, r9, { sorted: t17 = true, relativeTo: l11 = null, skipElements: o13 = [] } = {}) {
  let i9 = Array.isArray(e5) ? e5.length > 0 ? e5[0].ownerDocument : document : e5.ownerDocument, n7 = Array.isArray(e5) ? t17 ? I2(e5) : e5 : f(e5);
  o13.length > 0 && n7.length > 1 && (n7 = n7.filter((s18) => !o13.includes(s18))), l11 = l11 != null ? l11 : i9.activeElement;
  let E9 = (() => {
    if (r9 & 5)
      return 1;
    if (r9 & 10)
    ...
    if (r9 & 8)
      return n7.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), p7 = r9 & 32 ? { preventScroll: true } : {}, d13 = 0, a15 = n7.length, u10;
  do {
    if (d13 >= a15 || d13 + a15 <= 0)
      return 0;
    let s18 = x6 + d13;
    if (r9 & 16)
      s18 = (s18 + a15) % a15;
    ...
    u10 = n7[s18], u10 == null || u10.focus(p7), d13 += E9;
...
// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-outside-click.js
function h2(s18, m12, a15 = true) {
  let i9 = (0, import_react61.useRef)(false);
  ...
  function c15(e5, r9) {
    ...
    return !h(t17, T.Loose) && t17.tabIndex !== -1 && e5.preventDefault(), m12(e5, t17);
  }
  let o13 = (0, import_react61.useRef)(null);
  d2("pointerdown", (e5) => {
    var r9, t17;
    i9.current && (o13.current = ((t17 = (r9 = e5.composedPath) == null ? void 0 : r9.call(e5)) == null ? void 0 : t17[0]) || e5.target);
  }, true), d2("mousedown", (e5) => {
    var r9, t17;
    i9.current && (o13.current = ((t17 = (r9 = e5.composedPath) == null ? void 0 : r9.call(e5)) == null ? void 0 : t17[0]) || e5.target);
  }, true), d2("click", (e5) => {
    o13.current && (c15(e5, () => o13.current), o13.current = null);
  }, true), d2("touchend", (e5) => c15(e5, () => e5.target instanceof HTMLElement ? e5.target : null), true), s6("blur", (e5) => c15(e5, () => window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null), true);
}
...
function s7(t17, e5) {
  let [n7, u10] = (0, import_react62.useState)(() => i3(t17));
  return l(() => {
    u10(i3(t17));
  }, [t17.type, t17.as]), l(() => {
...
function y2(...t17) {
  let n7 = (0, import_react63.useRef)(t17);
  (0, import_react63.useEffect)(() => {
    n7.current = t17;
  }, [t17]);
  let c15 = o4((e5) => {
    for (let o13 of n7.current)
      o13 != null && (typeof o13 == "function" ? o13(e5) : o13.current = e5);
  });
  return t17.every((e5) => e5 == null || (e5 == null ? void 0 : e5[u2])) ? void 0 : c15;
}

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-tree-walker.js
var import_react64 = __toESM(require_react(), 1);
function F2({ container: e5, accept: t17, walk: r9, enabled: c15 = true }) {
  let o13 = (0, import_react64.useRef)(t17), l11 = (0, import_react64.useRef)(r9);
  (0, import_react64.useEffect)(() => {
    o13.current = t17, l11.current = r9;
  }, [t17, r9]), l(() => {
    if (!e5 || !c15)
      return;
    let n7 = e(e5);
    if (!n7)
      return;
    let f14 = o13.current, p7 = l11.current, d13 = Object.assign((i9) => f14(i9), { acceptNode: f14 }), u10 = n7.createTreeWalker(e5, NodeFilter.SHOW_ELEMENT, d13, false);
    for (; u10.nextNode(); )
      p7(u10.currentNode);
  }, [e5, c15, o13, l11]);
}
...
function x(r9, n7) {
  ...
  if (t17.length <= 0)
    return null;
  let l11 = n7.resolveActiveIndex(), s18 = l11 != null ? l11 : -1, d13 = (() => {
    switch (r9.focus) {
      case 0:
        return t17.findIndex((e5) => !n7.resolveDisabled(e5));
      case 1: {
        let e5 = t17.slice().reverse().findIndex((i9, c15, u10) => s18 !== -1 && u10.length - c15 - 1 >= s18 ? false : !n7.resolveDisabled(i9));
        return e5 === -1 ? e5 : t17.length - 1 - e5;
      }
      case 2:
        return t17.findIndex((e5, i9) => i9 <= s18 ? false : !n7.resolveDisabled(e5));
      case 3: {
...
function X({ ourProps: r9, theirProps: t17, slot: e5, defaultTag: a15, features: s18, visible: n7 = true, name: f14 }) {
  let o13 = N2(t17, r9);
  if (n7)
    return c4(o13, e5, a15, f14);
  let u10 = s18 != null ? s18 : 0;
  if (u10 & 2) {
    let { static: l11 = false, ...p7 } = o13;
    if (l11)
      return c4(p7, e5, a15, f14);
  }
  if (u10 & 1) {
    let { unmount: l11 = true, ...p7 } = o13;
    return u(l11 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
      return c4({ ...p7, hidden: true, style: { display: "none" } }, e5, a15, f14);
    } });
  }
  return c4(o13, e5, a15, f14);
}
function c4(r9, t17 = {}, e5, a15) {
  let { as: s18 = e5, children: n7, refName: f14 = "ref", ...o13 } = g(r9, ["unmount", "static"]), u10 = r9.ref !== void 0 ? { [f14]: r9.ref } : {}, l11 = typeof n7 == "function" ? n7(t17) : n7;
  "className" in o13 && o13.className && typeof o13.className == "function" && (o13.className = o13.className(t17));
  let p7 = {};
  if (t17) {
    let i9 = false, m12 = [];
    for (let [y8, d13] of Object.entries(t17))
      typeof d13 == "boolean" && (i9 = true), d13 === true && m12.push(y8);
    i9 && (p7["data-headlessui-state"] = m12.join(" "));
  }
  if (s18 === import_react65.Fragment && Object.keys(R(o13)).length > 0) {
    if (!(0, import_react65.isValidElement)(l11) || Array.isArray(l11) && l11.length > 1)
      throw new Error(['Passing props on "Fragment"!', "", `The current component <${a15} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(o13).map((d13) => `  - ${d13}`).join(`
...
`)].join(`
`));
    let i9 = l11.props, m12 = typeof (i9 == null ? void 0 : i9.className) == "function" ? (...d13) => t6(i9 == null ? void 0 : i9.className(...d13), o13.className) : t6(i9 == null ? void 0 : i9.className, o13.className), y8 = m12 ? { className: m12 } : {};
    return (0, import_react65.cloneElement)(l11, Object.assign({}, N2(l11.props, R(g(o13, ["ref"]))), p7, u10, w2(l11.ref, u10.ref), y8));
  }
  return (0, import_react65.createElement)(s18, Object.assign({}, g(o13, ["ref"]), s18 !== import_react65.Fragment && u10, s18 !== import_react65.Fragment && p7), l11);
}
function w2(...r9) {
...
function N2(...r9) {
  ...
  for (let s18 of r9)
    for (let n7 in s18)
      n7.startsWith("on") && typeof s18[n7] == "function" ? ((a15 = e5[n7]) != null || (e5[n7] = []), e5[n7].push(s18[n7])) : t17[n7] = s18[n7];
  if (t17.disabled || t17["aria-disabled"])
    return Object.assign(t17, Object.fromEntries(Object.keys(e5).map((s18) => [s18, void 0])));
  for (let s18 in e5)
    Object.assign(t17, { [s18](n7, ...f14) {
      let o13 = e5[s18];
      for (let u10 of o13) {
...
function D2(r9) {
  var t17;
  return Object.assign((0, import_react65.forwardRef)(r9), { displayName: (t17 = r9.displayName) != null ? t17 : r9.name });
}
function R(r9) {
...
function o7(i9, s18, t17) {
  if (Array.isArray(t17))
    for (let [r9, n7] of t17.entries())
      o7(i9, f4(s18, r9.toString()), n7);
  else
    t17 instanceof Date ? i9.push([s18, t17.toISOString()]) : typeof t17 == "boolean" ? i9.push([s18, t17 ? "1" : "0"]) : typeof t17 == "string" ? i9.push([s18, t17]) : typeof t17 == "number" ? i9.push([s18, `${t17}`]) : t17 == null ? i9.push([s18, ""]) : e2(t17, s18, i9);
}
function p2(i9) {
  var t17, r9;
  let s18 = (t17 = i9 == null ? void 0 : i9.form) != null ? t17 : i9.closest("form");
  if (s18) {
...
function s8(t17, o13) {
  let { features: n7 = 1, ...e5 } = t17, d13 = { ref: o13, "aria-hidden": (n7 & 2) === 2 ? true : void 0, style: { position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(n7 & 4) === 4 && (n7 & 2) !== 2 && { display: "none" } } };
...
var n = (0, import_react66.createContext)(null);
n.displayName = "OpenClosedContext";
var d5 = ((e5) => (e5[e5.Open = 1] = "Open", e5[e5.Closed = 2] = "Closed", e5[e5.Closing = 4] = "Closing", e5[e5.Opening = 8] = "Opening", e5))(d5 || {});
function C() {
  return (0, import_react66.useContext)(n);
}
function c6({ value: o13, children: r9 }) {
  return import_react66.default.createElement(n.Provider, { value: o13 }, r9);
}
...
function u3() {
  let e5 = (0, import_react69.useRef)([-1, -1]);
  return { wasMoved(r9) {
    let n7 = t8(r9);
...
function n3(...e5) {
  return (0, import_react70.useMemo)(() => e(...e5), [...e5]);
}
...
function ae(t17, a15 = (e5) => e5) {
  let e5 = t17.activeOptionIndex !== null ? t17.options[t17.activeOptionIndex] : null, r9 = I2(a15(t17.options.slice()), (b8) => b8.dataRef.current.domRef.current), l11 = e5 ? r9.indexOf(e5) : null;
  return l11 === -1 && (l11 = null), { options: r9, activeOptionIndex: l11 };
}
var Ge = { [1](t17) {
  var a15;
  return (a15 = t17.dataRef.current) != null && a15.disabled || t17.comboboxState === 1 ? t17 : { ...t17, activeOptionIndex: null, comboboxState: 1 };
}, [0](t17) {
  var e5;
  if ((e5 = t17.dataRef.current) != null && e5.disabled || t17.comboboxState === 0)
    return t17;
  let a15 = t17.activeOptionIndex;
  if (t17.dataRef.current) {
    let { isSelected: r9 } = t17.dataRef.current, l11 = t17.options.findIndex((b8) => r9(b8.dataRef.current.value));
    l11 !== -1 && (a15 = l11);
  }
  return { ...t17, comboboxState: 0, activeOptionIndex: a15 };
}, [2](t17, a15) {
  var l11, b8, n7, d13;
  if ((l11 = t17.dataRef.current) != null && l11.disabled || (b8 = t17.dataRef.current) != null && b8.optionsRef.current && !((n7 = t17.dataRef.current) != null && n7.optionsPropsRef.current.static) && t17.comboboxState === 1)
    return t17;
  let e5 = ae(t17);
  if (e5.activeOptionIndex === null) {
    let o13 = e5.options.findIndex((i9) => !i9.dataRef.current.disabled);
    o13 !== -1 && (e5.activeOptionIndex = o13);
  }
  let r9 = x(a15, { resolveItems: () => e5.options, resolveActiveIndex: () => e5.activeOptionIndex, resolveId: (o13) => o13.id, resolveDisabled: (o13) => o13.dataRef.current.disabled });
  return { ...t17, ...e5, activeOptionIndex: r9, activationTrigger: (d13 = a15.trigger) != null ? d13 : 1 };
}, [3]: (t17, a15) => {
  var b8, n7;
  let e5 = { id: a15.id, dataRef: a15.dataRef }, r9 = ae(t17, (d13) => [...d13, e5]);
  t17.activeOptionIndex === null && (b8 = t17.dataRef.current) != null && b8.isSelected(a15.dataRef.current.value) && (r9.activeOptionIndex = r9.options.indexOf(e5));
...
function J(t17) {
  let a15 = (0, import_react71.useContext)(ie);
  if (a15 === null) {
    let e5 = new Error(`<${t17} /> is missing a parent <Combobox /> component.`);
...
function Xe(t17, a15) {
  return u(a15.type, Ge, t17, a15);
}
var je = import_react71.Fragment;
function Je(t17, a15) {
  let { value: e5, defaultValue: r9, onChange: l11, form: b8, name: n7, by: d13 = (u10, T9) => u10 === T9, disabled: o13 = false, __demoMode: i9 = false, nullable: A6 = false, multiple: O4 = false, ...C5 } = t17, [f14 = O4 ? [] : void 0, g6] = T4(e5, l11, r9), [m12, c15] = (0, import_react71.useReducer)(Xe, { dataRef: (0, import_react71.createRef)(), comboboxState: i9 ? 0 : 1, options: [], activeOptionIndex: null, activationTrigger: 1, labelId: null }), D6 = (0, import_react71.useRef)(false), _7 = (0, import_react71.useRef)({ static: false, hold: false }), w6 = (0, import_react71.useRef)(null), U5 = (0, import_react71.useRef)(null), N7 = (0, import_react71.useRef)(null), K5 = (0, import_react71.useRef)(null), h11 = o4(typeof d13 == "string" ? (u10, T9) => {
    let v5 = d13;
    return (u10 == null ? void 0 : u10[v5]) === (T9 == null ? void 0 : T9[v5]);
  } : d13), H7 = (0, import_react71.useCallback)((u10) => u(p7.mode, { [1]: () => f14.some((T9) => h11(T9, u10)), [0]: () => h11(f14, u10) }), [f14]), p7 = (0, import_react71.useMemo)(() => ({ ...m12, optionsPropsRef: _7, labelRef: w6, inputRef: U5, buttonRef: N7, optionsRef: K5, value: f14, defaultValue: r9, disabled: o13, mode: O4 ? 1 : 0, get activeOptionIndex() {
    if (D6.current && m12.activeOptionIndex === null && m12.options.length > 0) {
      let u10 = m12.options.findIndex((T9) => !T9.dataRef.current.disabled);
      if (u10 !== -1)
        return u10;
    }
    return m12.activeOptionIndex;
  }, compare: h11, isSelected: H7, nullable: A6, __demoMode: i9 }), [f14, r9, o13, O4, A6, i9, m12]), y8 = (0, import_react71.useRef)(p7.activeOptionIndex !== null ? p7.options[p7.activeOptionIndex] : null);
  (0, import_react71.useEffect)(() => {
    let u10 = p7.activeOptionIndex !== null ? p7.options[p7.activeOptionIndex] : null;
    y8.current !== u10 && (y8.current = u10);
  }), l(() => {
    m12.dataRef.current = p7;
  }, [p7]), h2([p7.buttonRef, p7.inputRef, p7.optionsRef], () => te5.closeCombobox(), p7.comboboxState === 0);
  let E9 = (0, import_react71.useMemo)(() => ({ open: p7.comboboxState === 0, disabled: o13, activeIndex: p7.activeOptionIndex, activeOption: p7.activeOptionIndex === null ? null : p7.options[p7.activeOptionIndex].dataRef.current.value, value: f14 }), [p7, o13, f14]), B3 = o4((u10) => {
    let T9 = p7.options.find((v5) => v5.id === u10);
    T9 && V4(T9.dataRef.current.value);
  }), s18 = o4(() => {
    if (p7.activeOptionIndex !== null) {
      let { dataRef: u10, id: T9 } = p7.options[p7.activeOptionIndex];
      V4(u10.current.value), te5.goToOption(a3.Specific, T9);
    }
  }), W2 = o4(() => {
    c15({ type: 0 }), D6.current = true;
  }), L3 = o4(() => {
    c15({ type: 1 }), D6.current = false;
  }), $7 = o4((u10, T9, v5) => (D6.current = false, u10 === a3.Specific ? c15({ type: 2, focus: a3.Specific, id: T9, trigger: v5 }) : c15({ type: 2, focus: u10, trigger: v5 }))), P5 = o4((u10, T9) => (c15({ type: 3, id: u10, dataRef: T9 }), () => {
    var v5;
    ((v5 = y8.current) == null ? void 0 : v5.id) === u10 && (D6.current = true), c15({ type: 4, id: u10 });
  })), F8 = o4((u10) => (c15({ type: 5, id: u10 }), () => c15({ type: 5, id: null }))), V4 = o4((u10) => u(p7.mode, { [0]() {
    return g6 == null ? void 0 : g6(u10);
  }, [1]() {
    let T9 = p7.value.slice(), v5 = T9.findIndex((q6) => h11(q6, u10));
    return v5 === -1 ? T9.push(u10) : T9.splice(v5, 1), g6 == null ? void 0 : g6(T9);
  } })), te5 = (0, import_react71.useMemo)(() => ({ onChange: V4, registerOption: P5, registerLabel: F8, goToOption: $7, closeCombobox: L3, openCombobox: W2, selectActiveOption: s18, selectOption: B3 }), []), Te4 = a15 === null ? {} : { ref: a15 }, z6 = (0, import_react71.useRef)(null), me5 = p();
  return (0, import_react71.useEffect)(() => {
    z6.current && r9 !== void 0 && me5.addEventListener(z6.current, "reset", () => {
      g6 == null || g6(r9);
    });
  }, [z6, g6]), import_react71.default.createElement(le.Provider, { value: te5 }, import_react71.default.createElement(ie.Provider, { value: p7 }, import_react71.default.createElement(c6, { value: u(p7.comboboxState, { [0]: d5.Open, [1]: d5.Closed }) }, n7 != null && f14 != null && e2({ [n7]: f14 }).map(([u10, T9], v5) => import_react71.default.createElement(c5, { features: p3.Hidden, ref: v5 === 0 ? (q6) => {
    var ue6;
    z6.current = (ue6 = q6 == null ? void 0 : q6.closest("form")) != null ? ue6 : null;
  } : void 0, ...R({ key: u10, as: "input", type: "hidden", hidden: true, readOnly: true, form: b8, name: u10, value: T9 }) })), X({ ourProps: Te4, theirProps: C5, slot: E9, defaultTag: je, name: "Combobox" }))));
}
var Ke = "input";
function We(t17, a15) {
  var p7, y8, E9, B3;
  let e5 = I(), { id: r9 = `headlessui-combobox-input-${e5}`, onChange: l11, displayValue: b8, type: n7 = "text", ...d13 } = t17, o13 = J("Combobox.Input"), i9 = Z("Combobox.Input"), A6 = y2(o13.inputRef, a15), O4 = n3(o13.inputRef), C5 = (0, import_react71.useRef)(false), f14 = p(), g6 = o4(() => {
    i9.onChange(null), o13.optionsRef.current && (o13.optionsRef.current.scrollTop = 0), i9.goToOption(a3.Nothing);
  }), m12 = function() {
    var s18;
    return typeof b8 == "function" && o13.value !== void 0 ? (s18 = b8(o13.value)) != null ? s18 : "" : typeof o13.value == "string" ? o13.value : "";
  }();
  m4(([s18, W2], [L3, $7]) => {
    if (C5.current)
      return;
    let P5 = o13.inputRef.current;
    P5 && (($7 === 0 && W2 === 1 || s18 !== L3) && (P5.value = s18), requestAnimationFrame(() => {
      if (C5.current || !P5 || (O4 == null ? void 0 : O4.activeElement) !== P5)
        return;
      let { selectionStart: F8, selectionEnd: V4 } = P5;
      Math.abs((V4 != null ? V4 : 0) - (F8 != null ? F8 : 0)) === 0 && F8 === 0 && P5.setSelectionRange(P5.value.length, P5.value.length);
    }));
  }, [m12, o13.comboboxState, O4]), m4(([s18], [W2]) => {
    if (s18 === 0 && W2 === 1) {
      if (C5.current)
        return;
      let L3 = o13.inputRef.current;
      if (!L3)
        return;
      let $7 = L3.value, { selectionStart: P5, selectionEnd: F8, selectionDirection: V4 } = L3;
      L3.value = "", L3.value = $7, V4 !== null ? L3.setSelectionRange(P5, F8, V4) : L3.setSelectionRange(P5, F8);
    }
  }, [o13.comboboxState]);
  let c15 = (0, import_react71.useRef)(false), D6 = o4(() => {
    c15.current = true;
  }), _7 = o4(() => {
    f14.nextFrame(() => {
      c15.current = false;
    ...
    switch (C5.current = true, s18.key) {
      case o8.Enter:
        if (C5.current = false, o13.comboboxState !== 0 || c15.current)
          return;
        if (s18.preventDefault(), s18.stopPropagation(), o13.activeOptionIndex === null) {
          i9.closeCombobox();
          return;
        }
        i9.selectActiveOption(), o13.mode === 0 && i9.closeCombobox();
        break;
      case o8.ArrowDown:
        return C5.current = false, s18.preventDefault(), s18.stopPropagation(), u(o13.comboboxState, { [0]: () => {
          i9.goToOption(a3.Next);
        }, [1]: () => {
          i9.openCombobox();
        } });
      case o8.ArrowUp:
        return C5.current = false, s18.preventDefault(), s18.stopPropagation(), u(o13.comboboxState, { [0]: () => {
          i9.goToOption(a3.Previous);
        }, [1]: () => {
          i9.openCombobox(), f14.nextFrame(() => {
            o13.value || i9.goToOption(a3.Last);
          });
        } });
      case o8.Home:
        if (s18.shiftKey)
          break;
        return C5.current = false, s18.preventDefault(), s18.stopPropagation(), i9.goToOption(a3.First);
      case o8.PageUp:
        return C5.current = false, s18.preventDefault(), s18.stopPropagation(), i9.goToOption(a3.First);
      case o8.End:
        if (s18.shiftKey)
          break;
        return C5.current = false, s18.preventDefault(), s18.stopPropagation(), i9.goToOption(a3.Last);
      case o8.PageDown:
        return C5.current = false, s18.preventDefault(), s18.stopPropagation(), i9.goToOption(a3.Last);
      case o8.Escape:
        return C5.current = false, o13.comboboxState !== 0 ? void 0 : (s18.preventDefault(), o13.optionsRef.current && !o13.optionsPropsRef.current.static && s18.stopPropagation(), o13.nullable && o13.mode === 0 && o13.value === null && g6(), i9.closeCombobox());
      case o8.Tab:
        if (C5.current = false, o13.comboboxState !== 0)
          return;
        o13.mode === 0 && i9.selectActiveOption(), i9.closeCombobox();
        break;
    }
  }), U5 = o4((s18) => {
    l11 == null || l11(s18), o13.nullable && o13.mode === 0 && s18.target.value === "" && g6(), i9.openCombobox();
  }), N7 = o4(() => {
    C5.current = false;
  }), K5 = i2(() => {
    if (o13.labelId)
      return [o13.labelId].join(" ");
  }, [o13.labelId]), h11 = (0, import_react71.useMemo)(() => ({ open: o13.comboboxState === 0, disabled: o13.disabled }), [o13]), H7 = { ref: A6, id: r9, role: "combobox", type: n7, "aria-controls": (p7 = o13.optionsRef.current) == null ? void 0 : p7.id, "aria-expanded": o13.comboboxState === 0, "aria-activedescendant": o13.activeOptionIndex === null || (y8 = o13.options[o13.activeOptionIndex]) == null ? void 0 : y8.id, "aria-labelledby": K5, "aria-autocomplete": "list", defaultValue: (B3 = (E9 = t17.defaultValue) != null ? E9 : o13.defaultValue !== void 0 ? b8 == null ? void 0 : b8(o13.defaultValue) : null) != null ? B3 : o13.defaultValue, disabled: o13.disabled, onCompositionStart: D6, onCompositionEnd: _7, onKeyDown: w6, onChange: U5, onBlur: N7 };
  return X({ ourProps: H7, theirProps: d13, slot: h11, defaultTag: Ke, name: "Combobox.Input" });
}
var $e = "button";
function qe(t17, a15) {
  var g6;
  let e5 = J("Combobox.Button"), r9 = Z("Combobox.Button"), l11 = y2(e5.buttonRef, a15), b8 = I(), { id: n7 = `headlessui-combobox-button-${b8}`, ...d13 } = t17, o13 = p(), i9 = o4((m12) => {
    switch (m12.key) {
      case o8.ArrowDown:
        return m12.preventDefault(), m12.stopPropagation(), e5.comboboxState === 1 && r9.openCombobox(), o13.nextFrame(() => {
          var c15;
          return (c15 = e5.inputRef.current) == null ? void 0 : c15.focus({ preventScroll: true });
        });
      case o8.ArrowUp:
        return m12.preventDefault(), m12.stopPropagation(), e5.comboboxState === 1 && (r9.openCombobox(), o13.nextFrame(() => {
          e5.value || r9.goToOption(a3.Last);
        })), o13.nextFrame(() => {
          var c15;
          return (c15 = e5.inputRef.current) == null ? void 0 : c15.focus({ preventScroll: true });
        });
      case o8.Escape:
        return e5.comboboxState !== 0 ? void 0 : (m12.preventDefault(), e5.optionsRef.current && !e5.optionsPropsRef.current.static && m12.stopPropagation(), r9.closeCombobox(), o13.nextFrame(() => {
          var c15;
          return (c15 = e5.inputRef.current) == null ? void 0 : c15.focus({ preventScroll: true });
        }));
      default:
    ...
    if (r2(m12.currentTarget))
      return m12.preventDefault();
    e5.comboboxState === 0 ? r9.closeCombobox() : (m12.preventDefault(), r9.openCombobox()), o13.nextFrame(() => {
      var c15;
      return (c15 = e5.inputRef.current) == null ? void 0 : c15.focus({ preventScroll: true });
    });
  }), O4 = i2(() => {
  ...
  }, [e5.labelId, n7]), C5 = (0, import_react71.useMemo)(() => ({ open: e5.comboboxState === 0, disabled: e5.disabled, value: e5.value }), [e5]), f14 = { ref: l11, id: n7, type: s7(t17, e5.buttonRef), tabIndex: -1, "aria-haspopup": "listbox", "aria-controls": (g6 = e5.optionsRef.current) == null ? void 0 : g6.id, "aria-expanded": e5.comboboxState === 0, "aria-labelledby": O4, disabled: e5.disabled, onClick: A6, onKeyDown: i9 };
  return X({ ourProps: f14, theirProps: d13, slot: C5, defaultTag: $e, name: "Combobox.Button" });
}
var Qe = "label";
function Ye(t17, a15) {
  let e5 = I(), { id: r9 = `headlessui-combobox-label-${e5}`, ...l11 } = t17, b8 = J("Combobox.Label"), n7 = Z("Combobox.Label"), d13 = y2(b8.labelRef, a15);
  l(() => n7.registerLabel(r9), [r9]);
  let o13 = o4(() => {
    var O4;
    return (O4 = b8.inputRef.current) == null ? void 0 : O4.focus({ preventScroll: true });
  }), i9 = (0, import_react71.useMemo)(() => ({ open: b8.comboboxState === 0, disabled: b8.disabled }), [b8]);
  return X({ ourProps: { ref: d13, id: r9, onClick: o13 }, theirProps: l11, slot: i9, defaultTag: Qe, name: "Combobox.Label" });
}
var Ze = "ul";
var ze = S2.RenderStrategy | S2.Static;
function eo(t17, a15) {
  let e5 = I(), { id: r9 = `headlessui-combobox-options-${e5}`, hold: l11 = false, ...b8 } = t17, n7 = J("Combobox.Options"), d13 = y2(n7.optionsRef, a15), o13 = C(), i9 = (() => o13 !== null ? (o13 & d5.Open) === d5.Open : n7.comboboxState === 0)();
  l(() => {
    var f14;
  ...
  }, [n7.labelId, n7.buttonRef.current]), O4 = (0, import_react71.useMemo)(() => ({ open: n7.comboboxState === 0 }), [n7]), C5 = { "aria-labelledby": A6, role: "listbox", "aria-multiselectable": n7.mode === 1 ? true : void 0, id: r9, ref: d13 };
  return X({ ourProps: C5, theirProps: b8, slot: O4, defaultTag: Ze, features: ze, visible: i9, name: "Combobox.Options" });
}
var oo = "li";
function to(t17, a15) {
  var H7, p7;
  let e5 = I(), { id: r9 = `headlessui-combobox-option-${e5}`, disabled: l11 = false, value: b8, ...n7 } = t17, d13 = J("Combobox.Option"), o13 = Z("Combobox.Option"), i9 = d13.activeOptionIndex !== null ? d13.options[d13.activeOptionIndex].id === r9 : false, A6 = d13.isSelected(b8), O4 = (0, import_react71.useRef)(null), C5 = s2({ disabled: l11, value: b8, domRef: O4, textValue: (p7 = (H7 = O4.current) == null ? void 0 : H7.textContent) == null ? void 0 : p7.toLowerCase() }), f14 = y2(a15, O4), g6 = o4(() => o13.selectOption(r9));
  l(() => o13.registerOption(r9, C5), [C5, r9]);
  let m12 = (0, import_react71.useRef)(!d13.__demoMode);
  l(() => {
    if (!d13.__demoMode)
      return;
    let y8 = o2();
    ...
    if (d13.comboboxState !== 0 || !i9 || !m12.current || d13.activationTrigger === 0)
      return;
    let y8 = o2();
    return y8.requestAnimationFrame(() => {
      var E9, B3;
  ...
  let c15 = o4((y8) => {
    ...
    g6(), d13.mode === 0 && o13.closeCombobox(), n2() || requestAnimationFrame(() => {
      var E9;
    ...
    o13.goToOption(a3.Specific, r9);
  }), _7 = u3(), w6 = o4((y8) => _7.update(y8)), U5 = o4((y8) => {
    _7.wasMoved(y8) && (l11 || i9 || o13.goToOption(a3.Specific, r9, 0));
  }), N7 = o4((y8) => {
    _7.wasMoved(y8) && (l11 || i9 && (d13.optionsPropsRef.current.hold || o13.goToOption(a3.Nothing)));
  }), K5 = (0, import_react71.useMemo)(() => ({ active: i9, selected: A6, disabled: l11 }), [i9, A6, l11]);
  return X({ ourProps: { id: r9, ref: f14, role: "option", tabIndex: l11 === true ? void 0 : -1, "aria-disabled": l11 === true ? true : void 0, "aria-selected": A6, disabled: void 0, onClick: c15, onFocus: D6, onPointerEnter: w6, onMouseEnter: w6, onPointerMove: U5, onMouseMove: U5, onPointerLeave: N7, onMouseLeave: N7 }, theirProps: n7, slot: K5, defaultTag: oo, name: "Combobox.Option" });
}
var no = D2(Je);
var ro = D2(qe);
var ao = D2(We);
...
function n4() {
  let e5 = (0, import_react72.useRef)(0);
  return s6("keydown", (o13) => {
    o13.key === "Tab" && (e5.current = o13.shiftKey ? 1 : 0);
  }, true), e5;
}
...
function f7() {
  let e5 = (0, import_react73.useRef)(false);
...
function c7(t17) {
  let r9 = o4(t17), e5 = (0, import_react75.useRef)(false);
  (0, import_react75.useEffect)(() => (e5.current = false, () => {
    e5.current = true, t3(() => {
      e5.current && r9();
    });
  }), [r9]);
...
function X2(t17, r9) {
  let e5 = (0, import_react76.useRef)(null), o13 = y2(e5, r9), { initialFocus: u10, containers: i9, features: n7 = 30, ...l11 } = t17;
  l2() || (n7 = 1);
  let m12 = n3(e5);
  Y({ ownerDocument: m12 }, Boolean(n7 & 16));
  let c15 = Z2({ ownerDocument: m12, container: e5, initialFocus: u10 }, Boolean(n7 & 2));
  $({ ownerDocument: m12, container: e5, containers: i9, previousActiveElement: c15 }, Boolean(n7 & 8));
  let v5 = n4(), y8 = o4((s18) => {
    let T9 = e5.current;
    if (!T9)
      return;
    ((B3) => B3())(() => {
      u(v5.current, { [s10.Forwards]: () => {
        O(T9, M.First, { skipElements: [s18.relatedTarget] });
      }, [s10.Backwards]: () => {
        O(T9, M.Last, { skipElements: [s18.relatedTarget] });
      } });
    });
  }), _7 = p(), b8 = (0, import_react76.useRef)(false), j7 = { ref: o13, onKeyDown(s18) {
    s18.key == "Tab" && (b8.current = true, _7.requestAnimationFrame(() => {
      b8.current = false;
    }));
  }, onBlur(s18) {
    let T9 = P(i9);
    e5.current instanceof HTMLElement && T9.add(e5.current);
    let d13 = s18.relatedTarget;
    d13 instanceof HTMLElement && d13.dataset.headlessuiFocusGuard !== "true" && (S4(T9, d13) || (b8.current ? O(e5.current, u(v5.current, { [s10.Forwards]: () => M.Next, [s10.Backwards]: () => M.Previous }) | M.WrapAround, { relativeTo: s18.target }) : s18.target instanceof HTMLElement && y(s18.target)));
  } };
  return import_react76.default.createElement(import_react76.default.Fragment, null, Boolean(n7 & 4) && import_react76.default.createElement(c5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: y8, features: p3.Focusable }), X({ ourProps: j7, theirProps: l11, defaultTag: J2, name: "FocusTrap" }), Boolean(n7 & 4) && import_react76.default.createElement(c5, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: y8, features: p3.Focusable }));
}
var z = D2(X2);
...
function Q(t17 = true) {
  let r9 = (0, import_react76.useRef)(a5.slice());
  return m4(([e5], [o13]) => {
    o13 === true && e5 === false && t3(() => {
      r9.current.splice(0);
    }), o13 === false && e5 === true && (r9.current = a5.slice());
  }, [t17, a5, r9]), o4(() => {
    var e5;
    return (e5 = r9.current.find((o13) => o13 != null && o13.isConnected)) != null ? e5 : null;
  });
}
...
function Z2({ ownerDocument: t17, container: r9, initialFocus: e5 }, o13) {
  let u10 = (0, import_react76.useRef)(null), i9 = f7();
  return m4(() => {
    if (!o13)
      return;
    let n7 = r9.current;
...
function $({ ownerDocument: t17, container: r9, containers: e5, previousActiveElement: o13 }, u10) {
  let i9 = f7();
  E3(t17 == null ? void 0 : t17.defaultView, "focus", (n7) => {
    ...
    if (!m12)
      return;
    let c15 = n7.target;
    c15 && c15 instanceof HTMLElement ? S4(l11, c15) ? (o13.current = c15, y(c15)) : (n7.preventDefault(), n7.stopPropagation(), y(m12)) : y(o13.current);
  }, true);
}
function S4(t17, r9) {
  for (let e5 of t17)
...
var e3 = (0, import_react77.createContext)(false);
function l5() {
  return (0, import_react77.useContext)(e3);
}
function P2(o13) {
  return import_react77.default.createElement(e3.Provider, { value: o13.force }, o13.children);
}

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/components/portal/portal.js
function F3(p7) {
  let l11 = l5(), n7 = (0, import_react78.useContext)(v), e5 = n3(p7), [a15, o13] = (0, import_react78.useState)(() => {
  ...
  return (0, import_react78.useEffect)(() => {
    a15 !== null && (e5 != null && e5.body.contains(a15) || e5 == null || e5.body.appendChild(a15));
  }, [a15, e5]), (0, import_react78.useEffect)(() => {
    l11 || n7 !== null && o13(n7.current);
  }, [n7, o13, l11]), a15;
}
var U = import_react78.Fragment;
function N3(p7, l11) {
  let n7 = p7, e5 = (0, import_react78.useRef)(null), a15 = y2(T2((u10) => {
    e5.current = u10;
  }), l11), o13 = n3(e5), t17 = F3(e5), [r9] = (0, import_react78.useState)(() => {
    var u10;
    return s.isServer ? null : (u10 = o13 == null ? void 0 : o13.createElement("div")) != null ? u10 : null;
  }), i9 = (0, import_react78.useContext)(f8), C5 = l2();
  return l(() => {
  ...
  }), C5 ? !t17 || !r9 ? null : (0, import_react_dom.createPortal)(X({ ourProps: { ref: a15 }, theirProps: n7, defaultTag: U, name: "Portal" }), r9) : null;
}
var S5 = import_react78.Fragment;
var v = (0, import_react78.createContext)(null);
function j2(p7, l11) {
  let { target: n7, ...e5 } = p7, o13 = { ref: y2(l11) };
  return import_react78.default.createElement(v.Provider, { value: n7 }, X({ ourProps: o13, theirProps: e5, defaultTag: S5, name: "Popover.Group" }));
}
var f8 = (0, import_react78.createContext)(null);
function ae2() {
  let p7 = (0, import_react78.useContext)(f8), l11 = (0, import_react78.useRef)([]), n7 = o4((o13) => (l11.current.push(o13), p7 && p7.register(o13), () => e5(o13))), e5 = o4((o13) => {
    let t17 = l11.current.indexOf(o13);
    t17 !== -1 && l11.current.splice(t17, 1), p7 && p7.unregister(o13);
  }), a15 = (0, import_react78.useMemo)(() => ({ register: n7, unregister: e5, portals: l11 }), [n7, e5, l11]);
  return [l11, (0, import_react78.useMemo)(() => function({ children: t17 }) {
    return import_react78.default.createElement(f8.Provider, { value: a15 }, t17);
  }, [a15])];
}
var D3 = D2(N3);
var I3 = D2(j2);
...
var d8 = (0, import_react79.createContext)(null);
function f9() {
  let r9 = (0, import_react79.useContext)(d8);
  if (r9 === null) {
...
function M3() {
  let [r9, t17] = (0, import_react79.useState)([]);
  return [r9.length > 0 ? r9.join(" ") : void 0, (0, import_react79.useMemo)(() => function(e5) {
    let i9 = o4((s18) => (t17((o13) => [...o13, s18]), () => t17((o13) => {
      let p7 = o13.slice(), c15 = p7.indexOf(s18);
      return c15 !== -1 && p7.splice(c15, 1), p7;
    }))), n7 = (0, import_react79.useMemo)(() => ({ register: i9, slot: e5.slot, name: e5.name, props: e5.props }), [i9, e5.slot, e5.name, e5.props]);
    return import_react79.default.createElement(d8.Provider, { value: n7 }, e5.children);
  }, [t17])];
}
var S6 = "p";
function h5(r9, t17) {
  let a15 = I(), { id: e5 = `headlessui-description-${a15}`, ...i9 } = r9, n7 = f9(), s18 = y2(t17);
  l(() => n7.register(e5), [e5, n7.register]);
  let o13 = { ref: s18, ...n7.props, id: e5 };
  return X({ ourProps: o13, theirProps: i9, slot: n7.slot || {}, defaultTag: S6, name: n7.name || "Description" });
}
var y3 = D2(h5);
...
function y4(e5, t17, c15) {
  const a15 = t17(), [{ inst: n7 }, o13] = u6({ inst: { value: a15, getSnapshot: t17 } });
  return f10(() => {
    n7.value = a15, n7.getSnapshot = t17, r5(n7) && o13({ inst: n7 });
  }, [e5, a15, t17]), h6(() => (r5(n7) && o13({ inst: n7 }), e5(() => {
    r5(n7) && o13({ inst: n7 });
  })), [e5]), p5(a15), a15;
}
function r5(e5) {
  const t17 = e5.getSnapshot, c15 = e5.value;
  try {
    const a15 = t17();
    return !d10(c15, a15);
  } catch {
...
var s13 = !r6;
var c10 = s13 ? t14 : y4;
var a7 = "useSyncExternalStore" in e4 ? ((n7) => n7.useSyncExternalStore)(e4) : c10;
...
function a8(o13, r9) {
  let t17 = o13(), n7 = /* @__PURE__ */ new Set();
  return { getSnapshot() {
    return t17;
  }, subscribe(e5) {
    return n7.add(e5), () => n7.delete(e5);
  }, dispatch(e5, ...s18) {
    let i9 = r9[e5].call(t17, ...s18);
    i9 && (t17 = i9, n7.forEach((c15) => c15()));
  } };
}
...
function c11() {
  ...
  return { before({ doc: e5 }) {
    ...
    o13 = ((l11 = e5.defaultView) != null ? l11 : window).innerWidth - n7.clientWidth;
  }, after({ doc: e5, d: n7 }) {
    let t17 = e5.documentElement, l11 = t17.clientWidth - t17.offsetWidth, r9 = o13 - l11;
...
function T7() {
  ...
  }, after({ doc: o13, d: t17, meta: s18 }) {
    function i9(n7) {
      return s18.containers.flatMap((e5) => e5()).some((e5) => e5.contains(n7));
    }
    t17.microTask(() => {
      if (window.getComputedStyle(o13.documentElement).scrollBehavior !== "auto") {
        let e5 = o2();
        e5.style(o13.documentElement, "scroll-behavior", "auto"), t17.add(() => t17.microTask(() => e5.dispose()));
      }
      t17.style(o13.body, "marginTop", `-${l11}px`), window.scrollTo(0, 0);
      let n7 = null;
      t17.addEventListener(o13, "click", (e5) => {
        if (e5.target instanceof HTMLElement)
          try {
            let r9 = e5.target.closest("a");
            if (!r9)
              return;
            let { hash: c15 } = new URL(r9.href), a15 = o13.querySelector(c15);
            a15 && !i9(a15) && (n7 = a15);
          } catch {
          }
      }, true), t17.addEventListener(o13, "touchmove", (e5) => {
...
function l8() {
  return { before({ doc: e5, d: o13 }) {
    o13.style(e5.documentElement, "overflow", "hidden");
  } };
}
...
var a9 = a8(() => /* @__PURE__ */ new Map(), { PUSH(e5, n7) {
  var o13;
  let t17 = (o13 = this.get(e5)) != null ? o13 : { doc: e5, count: 0, d: o2(), meta: /* @__PURE__ */ new Set() };
  ...
  let o13 = { doc: e5, d: n7, meta: m8(t17) }, c15 = [T7(), c11(), l8()];
  c15.forEach(({ before: r9 }) => r9 == null ? void 0 : r9(o13)), c15.forEach(({ after: r9 }) => r9 == null ? void 0 : r9(o13));
}, SCROLL_ALLOW({ d: e5 }) {
  e5.dispose();
}, TEARDOWN({ doc: e5 }) {
  this.delete(e5);
...
a9.subscribe(() => {
  ...
  for (let t17 of e5.values()) {
    let o13 = n7.get(t17.doc) === "hidden", c15 = t17.count !== 0;
    (c15 && !o13 || !c15 && o13) && a9.dispatch(t17.count > 0 ? "SCROLL_PREVENT" : "SCROLL_ALLOW", t17), t17.count === 0 && a9.dispatch("TEARDOWN", t17);
  }
});
...
function p6(e5, r9, n7) {
  let f14 = S7(a9), o13 = e5 ? f14.get(e5) : void 0, i9 = o13 ? o13.count > 0 : false;
  return l(() => {
    if (!(!e5 || !r9))
...
function h7(r9, l11 = true) {
  l(() => {
    ...
    let f14 = (o13 = t15.get(e5)) != null ? o13 : 0;
    return t15.set(e5, f14 + 1), f14 !== 0 || (u7.set(e5, { "aria-hidden": e5.getAttribute("aria-hidden"), inert: e5.inert }), e5.setAttribute("aria-hidden", "true"), e5.inert = true), a15;
  }, [r9, l11]);
}
...
function j3({ defaultContainers: t17 = [], portals: r9, mainTreeNodeRef: u10 } = {}) {
  var c15;
  let o13 = (0, import_react81.useRef)((c15 = u10 == null ? void 0 : u10.current) != null ? c15 : null), l11 = n3(o13), f14 = o4(() => {
    var i9;
    let n7 = [];
    for (let e5 of t17)
    ...
    for (let e5 of (i9 = l11 == null ? void 0 : l11.querySelectorAll("html > *, body > *")) != null ? i9 : [])
      e5 !== document.body && e5 !== document.head && e5 instanceof HTMLElement && e5.id !== "headlessui-portal-root" && (e5.contains(o13.current) || n7.some((T9) => e5.contains(T9)) || n7.push(e5));
    return n7;
  });
  return { resolveContainers: f14, contains: o4((n7) => f14().some((i9) => i9.contains(n7))), mainTreeNodeRef: o13, MainTreeNode: (0, import_react81.useMemo)(() => function() {
    return u10 != null ? null : import_react81.default.createElement(c5, { features: p3.Hidden, ref: o13 });
  }, [o13, u10]) };
}
function y5() {
  let t17 = (0, import_react81.useRef)(null);
  return { mainTreeNodeRef: t17, MainTreeNode: (0, import_react81.useMemo)(() => function() {
    return import_react81.default.createElement(c5, { features: p3.Hidden, ref: t17 });
  }, [t17]) };
}
...
var I4 = (0, import_react82.createContext)(null);
I4.displayName = "DialogContext";
function b4(t17) {
  let e5 = (0, import_react82.useContext)(I4);
  if (e5 === null) {
    let o13 = new Error(`<${t17} /> is missing a parent <Dialog /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(o13, b4), o13;
  }
  return e5;
}
function we2(t17, e5, o13 = () => [document.body]) {
  p6(t17, e5, (i9) => {
    var n7;
    return { containers: [...(n7 = i9.containers) != null ? n7 : [], o13] };
  });
}
function Be(t17, e5) {
...
function Ne2(t17, e5) {
  var X6;
  let o13 = I(), { id: i9 = `headlessui-dialog-${o13}`, open: n7, onClose: l11, initialFocus: s18, __demoMode: g6 = false, ...T9 } = t17, [m12, h11] = (0, import_react82.useState)(0), a15 = C();
  n7 === void 0 && a15 !== null && (n7 = (a15 & d5.Open) === d5.Open);
  let D6 = (0, import_react82.useRef)(null), Q6 = y2(D6, e5), f14 = n3(D6), N7 = t17.hasOwnProperty("open") || a15 !== null, U5 = t17.hasOwnProperty("onClose");
  if (!N7 && !U5)
  ...
  let p7 = n7 ? 0 : 1, [S10, Z8] = (0, import_react82.useReducer)(Be, { titleId: null, descriptionId: null, panelRef: (0, import_react82.createRef)() }), P5 = o4(() => l11(false)), W2 = o4((r9) => Z8({ type: 0, id: r9 })), L3 = l2() ? g6 ? false : p7 === 0 : false, F8 = m12 > 1, Y5 = (0, import_react82.useContext)(I4) !== null, [ee7, te5] = ae2(), { resolveContainers: M12, mainTreeNodeRef: k2, MainTreeNode: oe5 } = j3({ portals: ee7, defaultContainers: [(X6 = S10.panelRef.current) != null ? X6 : D6.current] }), re6 = F8 ? "parent" : "leaf", $7 = a15 !== null ? (a15 & d5.Closing) === d5.Closing : false, ne6 = (() => Y5 || $7 ? false : L3)(), le5 = (0, import_react82.useCallback)(() => {
    var r9, c15;
    return (c15 = Array.from((r9 = f14 == null ? void 0 : f14.querySelectorAll("body > *")) != null ? r9 : []).find((d13) => d13.id === "headlessui-portal-root" ? false : d13.contains(k2.current) && d13 instanceof HTMLElement)) != null ? c15 : null;
  }, [k2]);
  h7(le5, ne6);
  let ae5 = (() => F8 ? true : L3)(), ie5 = (0, import_react82.useCallback)(() => {
    var r9, c15;
    return (c15 = Array.from((r9 = f14 == null ? void 0 : f14.querySelectorAll("[data-headlessui-portal]")) != null ? r9 : []).find((d13) => d13.contains(k2.current) && d13 instanceof HTMLElement)) != null ? c15 : null;
  }, [k2]);
  h7(ie5, ae5);
  let se6 = (() => !(!L3 || F8))();
  h2(M12, P5, se6);
  ...
  E3(f14 == null ? void 0 : f14.defaultView, "keydown", (r9) => {
    pe4 && (r9.defaultPrevented || r9.key === o8.Escape && (r9.preventDefault(), r9.stopPropagation(), P5()));
  });
  let de5 = (() => !($7 || p7 !== 0 || Y5))();
  we2(f14, de5, M12), (0, import_react82.useEffect)(() => {
    if (p7 !== 0 || !D6.current)
      return;
    let r9 = new ResizeObserver((c15) => {
      for (let d13 of c15) {
        let x6 = d13.target.getBoundingClientRect();
        x6.x === 0 && x6.y === 0 && x6.width === 0 && x6.height === 0 && P5();
      }
    });
    return r9.observe(D6.current), () => r9.disconnect();
  }, [p7, D6, P5]);
  let [ue6, fe5] = M3(), ge7 = (0, import_react82.useMemo)(() => [{ dialogState: p7, close: P5, setTitleId: W2 }, S10], [p7, S10, P5, W2]), J8 = (0, import_react82.useMemo)(() => ({ open: p7 === 0 }), [p7]), Te4 = { ref: Q6, id: i9, role: "dialog", "aria-modal": p7 === 0 ? true : void 0, "aria-labelledby": S10.titleId, "aria-describedby": ue6 };
  return import_react82.default.createElement(M4, { type: "Dialog", enabled: p7 === 0, element: D6, onUpdate: o4((r9, c15) => {
    c15 === "Dialog" && u(r9, { [s12.Add]: () => h11((d13) => d13 + 1), [s12.Remove]: () => h11((d13) => d13 - 1) });
  }) }, import_react82.default.createElement(P2, { force: true }, import_react82.default.createElement(pe2, null, import_react82.default.createElement(I4.Provider, { value: ge7 }, import_react82.default.createElement(pe2.Group, { target: D6 }, import_react82.default.createElement(P2, { force: false }, import_react82.default.createElement(fe5, { slot: J8, name: "Dialog.Description" }, import_react82.default.createElement(ge2, { initialFocus: s18, containers: M12, features: L3 ? u(re6, { parent: ge2.features.RestoreFocus, leaf: ge2.features.All & ~ge2.features.FocusLock }) : ge2.features.None }, import_react82.default.createElement(te5, null, X({ ourProps: Te4, theirProps: T9, slot: J8, defaultTag: He2, features: Ge2, visible: p7 === 0, name: "Dialog" }))))))))), import_react82.default.createElement(oe5, null));
}
var Ue2 = "div";
function We2(t17, e5) {
  let o13 = I(), { id: i9 = `headlessui-dialog-overlay-${o13}`, ...n7 } = t17, [{ dialogState: l11, close: s18 }] = b4("Dialog.Overlay"), g6 = y2(e5), T9 = o4((a15) => {
    if (a15.target === a15.currentTarget) {
      if (r2(a15.currentTarget))
        return a15.preventDefault();
      a15.preventDefault(), a15.stopPropagation(), s18();
    }
  }), m12 = (0, import_react82.useMemo)(() => ({ open: l11 === 0 }), [l11]);
  return X({ ourProps: { ref: g6, id: i9, "aria-hidden": true, onClick: T9 }, theirProps: n7, slot: m12, defaultTag: Ue2, name: "Dialog.Overlay" });
}
var Ye2 = "div";
function $e2(t17, e5) {
  let o13 = I(), { id: i9 = `headlessui-dialog-backdrop-${o13}`, ...n7 } = t17, [{ dialogState: l11 }, s18] = b4("Dialog.Backdrop"), g6 = y2(e5);
  (0, import_react82.useEffect)(() => {
    if (s18.panelRef.current === null)
      throw new Error("A <Dialog.Backdrop /> component is being used, but a <Dialog.Panel /> component is missing.");
  }, [s18.panelRef]);
  let T9 = (0, import_react82.useMemo)(() => ({ open: l11 === 0 }), [l11]);
  return import_react82.default.createElement(P2, { force: true }, import_react82.default.createElement(pe2, null, X({ ourProps: { ref: g6, id: i9, "aria-hidden": true }, theirProps: n7, slot: T9, defaultTag: Ye2, name: "Dialog.Backdrop" })));
}
var Je2 = "div";
function Xe2(t17, e5) {
  let o13 = I(), { id: i9 = `headlessui-dialog-panel-${o13}`, ...n7 } = t17, [{ dialogState: l11 }, s18] = b4("Dialog.Panel"), g6 = y2(e5, s18.panelRef), T9 = (0, import_react82.useMemo)(() => ({ open: l11 === 0 }), [l11]), m12 = o4((a15) => {
    a15.stopPropagation();
  });
  return X({ ourProps: { ref: g6, id: i9, onClick: m12 }, theirProps: n7, slot: T9, defaultTag: Je2, name: "Dialog.Panel" });
}
var je2 = "h2";
function Ke2(t17, e5) {
  let o13 = I(), { id: i9 = `headlessui-dialog-title-${o13}`, ...n7 } = t17, [{ dialogState: l11, setTitleId: s18 }] = b4("Dialog.Title"), g6 = y2(e5);
  (0, import_react82.useEffect)(() => (s18(i9), () => s18(null)), [i9, s18]);
  let T9 = (0, import_react82.useMemo)(() => ({ open: l11 === 0 }), [l11]);
  return X({ ourProps: { ref: g6, id: i9 }, theirProps: n7, slot: T9, defaultTag: je2, name: "Dialog.Title" });
}
var Ve = D2(Ne2);
var qe2 = D2($e2);
var ze2 = D2(Xe2);
...
var t16;
var a11 = (t16 = import_react83.default.startTransition) != null ? t16 : function(i9) {
  i9();
};

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/components/disclosure/disclosure.js
var q = ((o13) => (o13[o13.Open = 0] = "Open", o13[o13.Closed = 1] = "Closed", o13))(q || {});
...
var k = (0, import_react84.createContext)(null);
k.displayName = "DisclosureContext";
function M5(e5) {
  let n7 = (0, import_react84.useContext)(k);
  if (n7 === null) {
    let o13 = new Error(`<${e5} /> is missing a parent <Disclosure /> component.`);
    throw Error.captureStackTrace && Error.captureStackTrace(o13, M5), o13;
  }
  return n7;
}
...
var H3 = (0, import_react84.createContext)(null);
H3.displayName = "DisclosurePanelContext";
function V() {
  return (0, import_react84.useContext)(H3);
}
function Y2(e5, n7) {
  return u(n7.type, Q2, e5, n7);
}
var Z3 = import_react84.Fragment;
function ee2(e5, n7) {
  let { defaultOpen: o13 = false, ...u10 } = e5, T9 = (0, import_react84.useRef)(null), l11 = y2(n7, T2((a15) => {
    T9.current = a15;
  }, e5.as === void 0 || e5.as === import_react84.Fragment)), t17 = (0, import_react84.useRef)(null), f14 = (0, import_react84.useRef)(null), s18 = (0, import_react84.useReducer)(Y2, { disclosureState: o13 ? 0 : 1, linkedPanel: false, buttonRef: f14, panelRef: t17, buttonId: null, panelId: null }), [{ disclosureState: i9, buttonId: c15 }, D6] = s18, d13 = o4((a15) => {
    D6({ type: 1 });
    let r9 = e(T9);
    if (!r9 || !c15)
      return;
    let p7 = (() => a15 ? a15 instanceof HTMLElement ? a15 : a15.current instanceof HTMLElement ? a15.current : r9.getElementById(c15) : r9.getElementById(c15))();
    p7 == null || p7.focus();
  }), P5 = (0, import_react84.useMemo)(() => ({ close: d13 }), [d13]), b8 = (0, import_react84.useMemo)(() => ({ open: i9 === 0, close: d13 }), [i9, d13]), y8 = { ref: l11 };
  return import_react84.default.createElement(k.Provider, { value: s18 }, import_react84.default.createElement(v2.Provider, { value: P5 }, import_react84.default.createElement(c6, { value: u(i9, { [0]: d5.Open, [1]: d5.Closed }) }, X({ ourProps: y8, theirProps: u10, slot: b8, defaultTag: Z3, name: "Disclosure" }))));
}
var te = "button";
function ne(e5, n7) {
  let o13 = I(), { id: u10 = `headlessui-disclosure-button-${o13}`, ...T9 } = e5, [l11, t17] = M5("Disclosure.Button"), f14 = V(), s18 = f14 === null ? false : f14 === l11.panelId, i9 = (0, import_react84.useRef)(null), c15 = y2(i9, n7, s18 ? null : l11.buttonRef);
  ...
  let D6 = o4((r9) => {
    ...
    var p7;
    r2(r9.currentTarget) || e5.disabled || (s18 ? (t17({ type: 0 }), (p7 = l11.buttonRef.current) == null || p7.focus()) : t17({ type: 0 }));
  }), b8 = (0, import_react84.useMemo)(() => ({ open: l11.disclosureState === 0 }), [l11]), y8 = s7(e5, i9), a15 = s18 ? { ref: c15, type: y8, onKeyDown: D6, onClick: P5 } : { ref: c15, id: u10, type: y8, "aria-expanded": l11.disclosureState === 0, "aria-controls": l11.linkedPanel ? l11.panelId : void 0, onKeyDown: D6, onKeyUp: d13, onClick: P5 };
  return X({ ourProps: a15, theirProps: T9, slot: b8, defaultTag: te, name: "Disclosure.Button" });
}
var le2 = "div";
var oe = S2.RenderStrategy | S2.Static;
function re(e5, n7) {
  let o13 = I(), { id: u10 = `headlessui-disclosure-panel-${o13}`, ...T9 } = e5, [l11, t17] = M5("Disclosure.Panel"), { close: f14 } = w4("Disclosure.Panel"), s18 = y2(n7, l11.panelRef, (P5) => {
    a11(() => t17({ type: P5 ? 4 : 5 }));
  });
  (0, import_react84.useEffect)(() => (t17({ type: 3, panelId: u10 }), () => {
    t17({ type: 3, panelId: null });
  }), [u10, t17]);
  let i9 = C(), c15 = (() => i9 !== null ? (i9 & d5.Open) === d5.Open : l11.disclosureState === 0)(), D6 = (0, import_react84.useMemo)(() => ({ open: l11.disclosureState === 0, close: f14 }), [l11, f14]), d13 = { ref: s18, id: u10 };
  return import_react84.default.createElement(H3.Provider, { value: l11.panelId }, X({ ourProps: d13, theirProps: T9, slot: D6, defaultTag: le2, features: oe, visible: c15, name: "Disclosure.Panel" }));
}
var se2 = D2(ee2);
var ue = D2(ne);
var ie2 = D2(re);
...
// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-text-value.js
function b5(c15) {
  let t17 = (0, import_react85.useRef)(""), r9 = (0, import_react85.useRef)("");
  return o4(() => {
    let e5 = c15.current;
    if (!e5)
      return "";
...
function z3(e5, a15 = (n7) => n7) {
  let n7 = e5.activeOptionIndex !== null ? e5.options[e5.activeOptionIndex] : null, r9 = I2(a15(e5.options.slice()), (t17) => t17.dataRef.current.domRef.current), l11 = n7 ? r9.indexOf(n7) : null;
  return l11 === -1 && (l11 = null), { options: r9, activeOptionIndex: l11 };
}
var je3 = { [1](e5) {
  ...
  if (e5.dataRef.current.disabled || e5.listboxState === 0)
    return e5;
  let a15 = e5.activeOptionIndex, { isSelected: n7 } = e5.dataRef.current, r9 = e5.options.findIndex((l11) => n7(l11.dataRef.current.value));
  return r9 !== -1 && (a15 = r9), { ...e5, listboxState: 0, activeOptionIndex: a15 };
}, [2](e5, a15) {
  var l11;
  if (e5.dataRef.current.disabled || e5.listboxState === 1)
    return e5;
  let n7 = z3(e5), r9 = x(a15, { resolveItems: () => n7.options, resolveActiveIndex: () => n7.activeOptionIndex, resolveId: (t17) => t17.id, resolveDisabled: (t17) => t17.dataRef.current.disabled });
  return { ...e5, ...n7, searchQuery: "", activeOptionIndex: r9, activationTrigger: (l11 = a15.trigger) != null ? l11 : 1 };
}, [3]: (e5, a15) => {
  if (e5.dataRef.current.disabled || e5.listboxState === 1)
    return e5;
  let r9 = e5.searchQuery !== "" ? 0 : 1, l11 = e5.searchQuery + a15.value.toLowerCase(), p7 = (e5.activeOptionIndex !== null ? e5.options.slice(e5.activeOptionIndex + r9).concat(e5.options.slice(0, e5.activeOptionIndex + r9)) : e5.options).find((i9) => {
    var b8;
    return !i9.dataRef.current.disabled && ((b8 = i9.dataRef.current.textValue) == null ? void 0 : b8.startsWith(l11));
  ...
  let n7 = { id: a15.id, dataRef: a15.dataRef }, r9 = z3(e5, (l11) => [...l11, n7]);
  return e5.activeOptionIndex === null && e5.dataRef.current.isSelected(a15.dataRef.current.value) && (r9.activeOptionIndex = r9.options.indexOf(n7)), { ...e5, ...r9 };
}, [6]: (e5, a15) => {
  let n7 = z3(e5, (r9) => {
    let l11 = r9.findIndex((t17) => t17.id === a15.id);
    return l11 !== -1 && r9.splice(l11, 1), r9;
  });
  return { ...e5, ...n7, activationTrigger: 1 };
}, [7]: (e5, a15) => ({ ...e5, labelId: a15.id }) };
var J3 = (0, import_react86.createContext)(null);
J3.displayName = "ListboxActionsContext";
function _2(e5) {
  let a15 = (0, import_react86.useContext)(J3);
  if (a15 === null) {
...
function U2(e5) {
  let a15 = (0, import_react86.useContext)(q2);
  if (a15 === null) {
    let n7 = new Error(`<${e5} /> is missing a parent <Listbox /> component.`);
...
function Ve2(e5, a15) {
  return u(a15.type, je3, e5, a15);
}
var Ke3 = import_react86.Fragment;
function Qe3(e5, a15) {
  let { value: n7, defaultValue: r9, form: l11, name: t17, onChange: p7, by: u10 = (s18, c15) => s18 === c15, disabled: i9 = false, horizontal: b8 = false, multiple: R3 = false, ...m12 } = e5;
  const P5 = b8 ? "horizontal" : "vertical";
  let S10 = y2(a15), [L3 = R3 ? [] : void 0, y8] = T4(n7, p7, r9), [T9, o13] = (0, import_react86.useReducer)(Ve2, { dataRef: (0, import_react86.createRef)(), listboxState: 1, options: [], searchQuery: "", labelId: null, activeOptionIndex: null, activationTrigger: 1 }), x6 = (0, import_react86.useRef)({ static: false, hold: false }), E9 = (0, import_react86.useRef)(null), B3 = (0, import_react86.useRef)(null), W2 = (0, import_react86.useRef)(null), C5 = o4(typeof u10 == "string" ? (s18, c15) => {
    let O4 = u10;
    return (s18 == null ? void 0 : s18[O4]) === (c15 == null ? void 0 : c15[O4]);
  } : u10), A6 = (0, import_react86.useCallback)((s18) => u(d13.mode, { [1]: () => L3.some((c15) => C5(c15, s18)), [0]: () => C5(L3, s18) }), [L3]), d13 = (0, import_react86.useMemo)(() => ({ ...T9, value: L3, disabled: i9, mode: R3 ? 1 : 0, orientation: P5, compare: C5, isSelected: A6, optionsPropsRef: x6, labelRef: E9, buttonRef: B3, optionsRef: W2 }), [L3, i9, R3, T9]);
  l(() => {
    T9.dataRef.current = d13;
  }, [d13]), h2([d13.buttonRef, d13.optionsRef], (s18, c15) => {
    var O4;
    o13({ type: 1 }), h(c15, T.Loose) || (s18.preventDefault(), (O4 = d13.buttonRef.current) == null || O4.focus());
  }, d13.listboxState === 0);
  let H7 = (0, import_react86.useMemo)(() => ({ open: d13.listboxState === 0, disabled: i9, value: L3 }), [d13, i9, L3]), ie5 = o4((s18) => {
    let c15 = d13.options.find((O4) => O4.id === s18);
    c15 && X6(c15.dataRef.current.value);
  }), re6 = o4(() => {
    if (d13.activeOptionIndex !== null) {
      let { dataRef: s18, id: c15 } = d13.options[d13.activeOptionIndex];
      X6(s18.current.value), o13({ type: 2, focus: a3.Specific, id: c15 });
    }
  }), ae5 = o4(() => o13({ type: 0 })), le5 = o4(() => o13({ type: 1 })), se6 = o4((s18, c15, O4) => s18 === a3.Specific ? o13({ type: 2, focus: a3.Specific, id: c15, trigger: O4 }) : o13({ type: 2, focus: s18, trigger: O4 })), pe4 = o4((s18, c15) => (o13({ type: 5, id: s18, dataRef: c15 }), () => o13({ type: 6, id: s18 }))), ue6 = o4((s18) => (o13({ type: 7, id: s18 }), () => o13({ type: 7, id: null }))), X6 = o4((s18) => u(d13.mode, { [0]() {
    return y8 == null ? void 0 : y8(s18);
  }, [1]() {
    let c15 = d13.value.slice(), O4 = c15.findIndex((F8) => C5(F8, s18));
    return O4 === -1 ? c15.push(s18) : c15.splice(O4, 1), y8 == null ? void 0 : y8(c15);
  } })), de5 = o4((s18) => o13({ type: 3, value: s18 })), ce5 = o4(() => o13({ type: 4 })), fe5 = (0, import_react86.useMemo)(() => ({ onChange: X6, registerOption: pe4, registerLabel: ue6, goToOption: se6, closeListbox: le5, openListbox: ae5, selectActiveOption: re6, selectOption: ie5, search: de5, clearSearch: ce5 }), []), Te4 = { ref: S10 }, G2 = (0, import_react86.useRef)(null), be6 = p();
  return (0, import_react86.useEffect)(() => {
    G2.current && r9 !== void 0 && be6.addEventListener(G2.current, "reset", () => {
      y8 == null || y8(r9);
    });
  }, [G2, y8]), import_react86.default.createElement(J3.Provider, { value: fe5 }, import_react86.default.createElement(q2.Provider, { value: d13 }, import_react86.default.createElement(c6, { value: u(d13.listboxState, { [0]: d5.Open, [1]: d5.Closed }) }, t17 != null && L3 != null && e2({ [t17]: L3 }).map(([s18, c15], O4) => import_react86.default.createElement(c5, { features: p3.Hidden, ref: O4 === 0 ? (F8) => {
    var Y5;
    G2.current = (Y5 = F8 == null ? void 0 : F8.closest("form")) != null ? Y5 : null;
  } : void 0, ...R({ key: s18, as: "input", type: "hidden", hidden: true, readOnly: true, form: l11, name: s18, value: c15 }) })), X({ ourProps: Te4, theirProps: m12, slot: H7, defaultTag: Ke3, name: "Listbox" }))));
}
var We3 = "button";
function Xe3(e5, a15) {
  var y8;
  let n7 = I(), { id: r9 = `headlessui-listbox-button-${n7}`, ...l11 } = e5, t17 = U2("Listbox.Button"), p7 = _2("Listbox.Button"), u10 = y2(t17.buttonRef, a15), i9 = p(), b8 = o4((T9) => {
    switch (T9.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
        T9.preventDefault(), p7.openListbox(), i9.nextFrame(() => {
          t17.value || p7.goToOption(a3.First);
        });
        break;
      case o8.ArrowUp:
        T9.preventDefault(), p7.openListbox(), i9.nextFrame(() => {
          t17.value || p7.goToOption(a3.Last);
        });
        break;
    }
  }), R3 = o4((T9) => {
    ...
    if (r2(T9.currentTarget))
      return T9.preventDefault();
    t17.listboxState === 0 ? (p7.closeListbox(), i9.nextFrame(() => {
      var o13;
      return (o13 = t17.buttonRef.current) == null ? void 0 : o13.focus({ preventScroll: true });
    })) : (T9.preventDefault(), p7.openListbox());
  }), P5 = i2(() => {
    if (t17.labelId)
      return [t17.labelId, r9].join(" ");
  }, [t17.labelId, r9]), S10 = (0, import_react86.useMemo)(() => ({ open: t17.listboxState === 0, disabled: t17.disabled, value: t17.value }), [t17]), L3 = { ref: u10, id: r9, type: s7(e5, t17.buttonRef), "aria-haspopup": "listbox", "aria-controls": (y8 = t17.optionsRef.current) == null ? void 0 : y8.id, "aria-expanded": t17.listboxState === 0, "aria-labelledby": P5, disabled: t17.disabled, onKeyDown: b8, onKeyUp: R3, onClick: m12 };
  return X({ ourProps: L3, theirProps: l11, slot: S10, defaultTag: We3, name: "Listbox.Button" });
}
var $e3 = "label";
function ze3(e5, a15) {
  let n7 = I(), { id: r9 = `headlessui-listbox-label-${n7}`, ...l11 } = e5, t17 = U2("Listbox.Label"), p7 = _2("Listbox.Label"), u10 = y2(t17.labelRef, a15);
  l(() => p7.registerLabel(r9), [r9]);
  let i9 = o4(() => {
    var m12;
    return (m12 = t17.buttonRef.current) == null ? void 0 : m12.focus({ preventScroll: true });
  }), b8 = (0, import_react86.useMemo)(() => ({ open: t17.listboxState === 0, disabled: t17.disabled }), [t17]);
  return X({ ourProps: { ref: u10, id: r9, onClick: i9 }, theirProps: l11, slot: b8, defaultTag: $e3, name: "Listbox.Label" });
}
var Je3 = "ul";
var qe3 = S2.RenderStrategy | S2.Static;
function Ye3(e5, a15) {
  var T9;
  let n7 = I(), { id: r9 = `headlessui-listbox-options-${n7}`, ...l11 } = e5, t17 = U2("Listbox.Options"), p7 = _2("Listbox.Options"), u10 = y2(t17.optionsRef, a15), i9 = p(), b8 = p(), R3 = C(), m12 = (() => R3 !== null ? (R3 & d5.Open) === d5.Open : t17.listboxState === 0)();
  (0, import_react86.useEffect)(() => {
    var x6;
    let o13 = t17.optionsRef.current;
    o13 && t17.listboxState === 0 && o13 !== ((x6 = e(o13)) == null ? void 0 : x6.activeElement) && o13.focus({ preventScroll: true });
  ...
  let P5 = o4((o13) => {
    switch (b8.dispose(), o13.key) {
      ...
      case o8.Enter:
        if (o13.preventDefault(), o13.stopPropagation(), t17.activeOptionIndex !== null) {
      ...
      case u(t17.orientation, { vertical: o8.ArrowDown, horizontal: o8.ArrowRight }):
        return o13.preventDefault(), o13.stopPropagation(), p7.goToOption(a3.Next);
      case u(t17.orientation, { vertical: o8.ArrowUp, horizontal: o8.ArrowLeft }):
        return o13.preventDefault(), o13.stopPropagation(), p7.goToOption(a3.Previous);
      case o8.Home:
      case o8.PageUp:
        return o13.preventDefault(), o13.stopPropagation(), p7.goToOption(a3.First);
      case o8.End:
      case o8.PageDown:
        return o13.preventDefault(), o13.stopPropagation(), p7.goToOption(a3.Last);
      case o8.Escape:
    ...
    var o13, x6, E9;
    return (E9 = (o13 = t17.labelRef.current) == null ? void 0 : o13.id) != null ? E9 : (x6 = t17.buttonRef.current) == null ? void 0 : x6.id;
  }, [t17.labelRef.current, t17.buttonRef.current]), L3 = (0, import_react86.useMemo)(() => ({ open: t17.listboxState === 0 }), [t17]), y8 = { "aria-activedescendant": t17.activeOptionIndex === null || (T9 = t17.options[t17.activeOptionIndex]) == null ? void 0 : T9.id, "aria-multiselectable": t17.mode === 1 ? true : void 0, "aria-labelledby": S10, "aria-orientation": t17.orientation, id: r9, onKeyDown: P5, role: "listbox", tabIndex: 0, ref: u10 };
  return X({ ourProps: y8, theirProps: l11, slot: L3, defaultTag: Je3, features: qe3, visible: m12, name: "Listbox.Options" });
}
var Ze3 = "li";
function et(e5, a15) {
  let n7 = I(), { id: r9 = `headlessui-listbox-option-${n7}`, disabled: l11 = false, value: t17, ...p7 } = e5, u10 = U2("Listbox.Option"), i9 = _2("Listbox.Option"), b8 = u10.activeOptionIndex !== null ? u10.options[u10.activeOptionIndex].id === r9 : false, R3 = u10.isSelected(t17), m12 = (0, import_react86.useRef)(null), P5 = b5(m12), S10 = s2({ disabled: l11, value: t17, domRef: m12, get textValue() {
    return P5();
  } }), L3 = y2(a15, m12);
  l(() => {
    if (u10.listboxState !== 0 || !b8 || u10.activationTrigger === 0)
      return;
    let A6 = o2();
    return A6.requestAnimationFrame(() => {
      var d13, H7;
      (H7 = (d13 = m12.current) == null ? void 0 : d13.scrollIntoView) == null || H7.call(d13, { block: "nearest" });
    }), A6.dispose;
  }, [m12, b8, u10.listboxState, u10.activationTrigger, u10.activeOptionIndex]), l(() => i9.registerOption(r9, S10), [S10, r9]);
  let y8 = o4((A6) => {
    if (l11)
    ...
    if (l11)
      return i9.goToOption(a3.Nothing);
    i9.goToOption(a3.Specific, r9);
  }), o13 = u3(), x6 = o4((A6) => o13.update(A6)), E9 = o4((A6) => {
    o13.wasMoved(A6) && (l11 || b8 || i9.goToOption(a3.Specific, r9, 0));
  }), B3 = o4((A6) => {
    o13.wasMoved(A6) && (l11 || b8 && i9.goToOption(a3.Nothing));
  }), W2 = (0, import_react86.useMemo)(() => ({ active: b8, selected: R3, disabled: l11 }), [b8, R3, l11]);
  return X({ ourProps: { id: r9, ref: L3, role: "option", tabIndex: l11 === true ? void 0 : -1, "aria-disabled": l11 === true ? true : void 0, "aria-selected": R3, disabled: void 0, onClick: y8, onFocus: T9, onPointerEnter: x6, onMouseEnter: x6, onPointerMove: E9, onMouseMove: E9, onPointerLeave: B3, onMouseLeave: B3 }, theirProps: p7, slot: W2, defaultTag: Ze3, name: "Listbox.Option" });
}
var tt = D2(Qe3);
var ot = D2(Xe3);
var nt = D2(ze3);
...
function w5(e5, u10 = (r9) => r9) {
  let r9 = e5.activeItemIndex !== null ? e5.items[e5.activeItemIndex] : null, i9 = I2(u10(e5.items.slice()), (t17) => t17.dataRef.current.domRef.current), s18 = r9 ? i9.indexOf(r9) : null;
  return s18 === -1 && (s18 = null), { items: i9, activeItemIndex: s18 };
}
var Te = { [1](e5) {
  ...
  return { ...e5, ...r9, searchQuery: "", activeItemIndex: i9, activationTrigger: (s18 = u10.trigger) != null ? s18 : 1 };
}, [3]: (e5, u10) => {
  let i9 = e5.searchQuery !== "" ? 0 : 1, s18 = e5.searchQuery + u10.value.toLowerCase(), o13 = (e5.activeItemIndex !== null ? e5.items.slice(e5.activeItemIndex + i9).concat(e5.items.slice(0, e5.activeItemIndex + i9)) : e5.items).find((l11) => {
    var m12;
    return ((m12 = l11.dataRef.current.textValue) == null ? void 0 : m12.startsWith(s18)) && !l11.dataRef.current.disabled;
  }), a15 = o13 ? e5.items.indexOf(o13) : -1;
  return a15 === -1 || a15 === e5.activeItemIndex ? { ...e5, searchQuery: s18 } : { ...e5, searchQuery: s18, activeItemIndex: a15, activationTrigger: 1 };
}, [4](e5) {
  ...
  let r9 = w5(e5, (i9) => {
    let s18 = i9.findIndex((t17) => t17.id === u10.id);
    return s18 !== -1 && i9.splice(s18, 1), i9;
  });
  return { ...e5, ...r9, activationTrigger: 1 };
} };
var U3 = (0, import_react87.createContext)(null);
U3.displayName = "MenuContext";
function O2(e5) {
  let u10 = (0, import_react87.useContext)(U3);
  if (u10 === null) {
...
function Me2(e5, u10) {
  let { __demoMode: r9 = false, ...i9 } = e5, s18 = (0, import_react87.useReducer)(ye3, { __demoMode: r9, menuState: r9 ? 0 : 1, buttonRef: (0, import_react87.createRef)(), itemsRef: (0, import_react87.createRef)(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: t17, itemsRef: o13, buttonRef: a15 }, l11] = s18, m12 = y2(u10);
  h2([a15, o13], (g6, R3) => {
    var p7;
    l11({ type: 1 }), h(R3, T.Loose) || (g6.preventDefault(), (p7 = a15.current) == null || p7.focus());
  }, t17 === 0);
  let I7 = o4(() => {
    l11({ type: 1 });
  }), A6 = (0, import_react87.useMemo)(() => ({ open: t17 === 0, close: I7 }), [t17, I7]), f14 = { ref: m12 };
  return import_react87.default.createElement(U3.Provider, { value: s18 }, import_react87.default.createElement(c6, { value: u(t17, { [0]: d5.Open, [1]: d5.Closed }) }, X({ ourProps: f14, theirProps: i9, slot: A6, defaultTag: Ie2, name: "Menu" })));
}
var ge4 = "button";
function Re(e5, u10) {
  var R3;
  let r9 = I(), { id: i9 = `headlessui-menu-button-${r9}`, ...s18 } = e5, [t17, o13] = O2("Menu.Button"), a15 = y2(t17.buttonRef, u10), l11 = p(), m12 = o4((p7) => {
    switch (p7.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
        p7.preventDefault(), p7.stopPropagation(), o13({ type: 0 }), l11.nextFrame(() => o13({ type: 2, focus: a3.First }));
        break;
      case o8.ArrowUp:
        p7.preventDefault(), p7.stopPropagation(), o13({ type: 0 }), l11.nextFrame(() => o13({ type: 2, focus: a3.Last }));
        break;
    }
  }), I7 = o4((p7) => {
    switch (p7.key) {
    ...
    e5.disabled || (t17.menuState === 0 ? (o13({ type: 1 }), l11.nextFrame(() => {
      var M12;
      return (M12 = t17.buttonRef.current) == null ? void 0 : M12.focus({ preventScroll: true });
    })) : (p7.preventDefault(), o13({ type: 0 })));
  }), f14 = (0, import_react87.useMemo)(() => ({ open: t17.menuState === 0 }), [t17]), g6 = { ref: a15, id: i9, type: s7(e5, t17.buttonRef), "aria-haspopup": "menu", "aria-controls": (R3 = t17.itemsRef.current) == null ? void 0 : R3.id, "aria-expanded": t17.menuState === 0, onKeyDown: m12, onKeyUp: I7, onClick: A6 };
  return X({ ourProps: g6, theirProps: s18, slot: f14, defaultTag: ge4, name: "Menu.Button" });
}
var Ae = "div";
var be2 = S2.RenderStrategy | S2.Static;
function Ee(e5, u10) {
  var M12, b8;
  let r9 = I(), { id: i9 = `headlessui-menu-items-${r9}`, ...s18 } = e5, [t17, o13] = O2("Menu.Items"), a15 = y2(t17.itemsRef, u10), l11 = n3(t17.itemsRef), m12 = p(), I7 = C(), A6 = (() => I7 !== null ? (I7 & d5.Open) === d5.Open : t17.menuState === 0)();
  ...
  let f14 = o4((n7) => {
    ...
    switch (m12.dispose(), n7.key) {
      ...
      case o8.Enter:
        if (n7.preventDefault(), n7.stopPropagation(), o13({ type: 1 }), t17.activeItemIndex !== null) {
          let { dataRef: S10 } = t17.items[t17.activeItemIndex];
          (P5 = (E9 = S10.current) == null ? void 0 : E9.domRef.current) == null || P5.click();
        }
  ...
  }), R3 = (0, import_react87.useMemo)(() => ({ open: t17.menuState === 0 }), [t17]), p7 = { "aria-activedescendant": t17.activeItemIndex === null || (M12 = t17.items[t17.activeItemIndex]) == null ? void 0 : M12.id, "aria-labelledby": (b8 = t17.buttonRef.current) == null ? void 0 : b8.id, id: i9, onKeyDown: f14, onKeyUp: g6, role: "menu", tabIndex: 0, ref: a15 };
  return X({ ourProps: p7, theirProps: s18, slot: R3, defaultTag: Ae, features: be2, visible: A6, name: "Menu.Items" });
}
var Se = import_react87.Fragment;
function Pe2(e5, u10) {
  let r9 = I(), { id: i9 = `headlessui-menu-item-${r9}`, disabled: s18 = false, ...t17 } = e5, [o13, a15] = O2("Menu.Item"), l11 = o13.activeItemIndex !== null ? o13.items[o13.activeItemIndex].id === i9 : false, m12 = (0, import_react87.useRef)(null), I7 = y2(u10, m12);
  l(() => {
    if (o13.__demoMode || o13.menuState !== 0 || !l11 || o13.activationTrigger === 0)
      return;
    let T9 = o2();
    return T9.requestAnimationFrame(() => {
      var v5, B3;
  ...
  let A6 = b5(m12), f14 = (0, import_react87.useRef)({ disabled: s18, domRef: m12, get textValue() {
    return A6();
  } });
  l(() => {
    f14.current.disabled = s18;
  }, [f14, s18]), l(() => (a15({ type: 5, id: i9, dataRef: f14 }), () => a15({ type: 6, id: i9 })), [f14, i9]);
  let g6 = o4(() => {
    a15({ type: 1 });
  }), R3 = o4((T9) => {
    if (s18)
    ...
    a15({ type: 2, focus: a3.Specific, id: i9 });
  }), M12 = u3(), b8 = o4((T9) => M12.update(T9)), n7 = o4((T9) => {
    M12.wasMoved(T9) && (s18 || l11 || a15({ type: 2, focus: a3.Specific, id: i9, trigger: 0 }));
  }), E9 = o4((T9) => {
    M12.wasMoved(T9) && (s18 || l11 && a15({ type: 2, focus: a3.Nothing }));
  }), P5 = (0, import_react87.useMemo)(() => ({ active: l11, disabled: s18, close: g6 }), [l11, s18, g6]);
  return X({ ourProps: { id: i9, ref: I7, role: "menuitem", tabIndex: s18 === true ? void 0 : -1, "aria-disabled": s18 === true ? true : void 0, disabled: void 0, onClick: R3, onFocus: p7, onPointerEnter: b8, onMouseEnter: b8, onPointerMove: n7, onMouseMove: n7, onPointerLeave: E9, onMouseLeave: E9 }, theirProps: t17, slot: P5, defaultTag: Se, name: "Menu.Item" });
}
var ve2 = D2(Me2);
var xe3 = D2(Re);
var he = D2(Ee);
...
var _e2 = { [0]: (t17) => {
  let o13 = { ...t17, popoverState: u(t17.popoverState, { [0]: 1, [1]: 0 }) };
  return o13.popoverState === 0 && (o13.__demoMode = false), o13;
}, [1](t17) {
  return t17.popoverState === 1 ? t17 : { ...t17, popoverState: 1 };
}, [2](t17, o13) {
  return t17.button === o13.button ? t17 : { ...t17, button: o13.button };
}, [3](t17, o13) {
  return t17.buttonId === o13.buttonId ? t17 : { ...t17, buttonId: o13.buttonId };
}, [4](t17, o13) {
  return t17.panel === o13.panel ? t17 : { ...t17, panel: o13.panel };
}, [5](t17, o13) {
  return t17.panelId === o13.panelId ? t17 : { ...t17, panelId: o13.panelId };
} };
var ue2 = (0, import_react88.createContext)(null);
ue2.displayName = "PopoverContext";
function oe2(t17) {
  let o13 = (0, import_react88.useContext)(ue2);
  if (o13 === null) {
...
function fe2(t17) {
  let o13 = (0, import_react88.useContext)(ie3);
  if (o13 === null) {
    let u10 = new Error(`<${t17} /> is missing a parent <Popover /> component.`);
...
var Pe3 = (0, import_react88.createContext)(null);
Pe3.displayName = "PopoverGroupContext";
function Ee2() {
  return (0, import_react88.useContext)(Pe3);
}
...
function Ne4(t17, o13) {
  return u(o13.type, _e2, t17, o13);
}
var ke = "div";
function we3(t17, o13) {
  var D6;
  let { __demoMode: u10 = false, ...R3 } = t17, O4 = (0, import_react88.useRef)(null), n7 = y2(o13, T2((l11) => {
    O4.current = l11;
  })), e5 = (0, import_react88.useRef)([]), v5 = (0, import_react88.useReducer)(Ne4, { __demoMode: u10, popoverState: u10 ? 0 : 1, buttons: e5, button: null, buttonId: null, panel: null, panelId: null, beforePanelSentinel: (0, import_react88.createRef)(), afterPanelSentinel: (0, import_react88.createRef)() }), [{ popoverState: P5, button: s18, buttonId: I7, panel: p7, panelId: T9, beforePanelSentinel: m12, afterPanelSentinel: S10 }, i9] = v5, a15 = n3((D6 = O4.current) != null ? D6 : s18), E9 = (0, import_react88.useMemo)(() => {
    if (!s18 || !p7)
      return false;
    for (let K5 of document.querySelectorAll("body > *"))
      if (Number(K5 == null ? void 0 : K5.contains(s18)) ^ Number(K5 == null ? void 0 : K5.contains(p7)))
        return true;
    let l11 = f(), F8 = l11.indexOf(s18), q6 = (F8 + l11.length - 1) % l11.length, W2 = (F8 + 1) % l11.length, z6 = l11[q6], be6 = l11[W2];
    return !p7.contains(z6) && !p7.contains(be6);
  }, [s18, p7]), C5 = s2(I7), H7 = s2(T9), x6 = (0, import_react88.useMemo)(() => ({ buttonId: C5, panelId: H7, close: () => i9({ type: 1 }) }), [C5, H7, i9]), M12 = Ee2(), h11 = M12 == null ? void 0 : M12.registerPopover, f14 = o4(() => {
    var l11;
    return (l11 = M12 == null ? void 0 : M12.isFocusWithinPopoverGroup()) != null ? l11 : (a15 == null ? void 0 : a15.activeElement) && ((s18 == null ? void 0 : s18.contains(a15.activeElement)) || (p7 == null ? void 0 : p7.contains(a15.activeElement)));
  });
  (0, import_react88.useEffect)(() => h11 == null ? void 0 : h11(x6), [h11, x6]);
  let [y8, b8] = ae2(), d13 = j3({ mainTreeNodeRef: M12 == null ? void 0 : M12.mainTreeNodeRef, portals: y8, defaultContainers: [s18, p7] });
  E3(a15 == null ? void 0 : a15.defaultView, "focus", (l11) => {
    var F8, q6, W2, z6;
    l11.target !== window && l11.target instanceof HTMLElement && P5 === 0 && (f14() || s18 && p7 && (d13.contains(l11.target) || (q6 = (F8 = m12.current) == null ? void 0 : F8.contains) != null && q6.call(F8, l11.target) || (z6 = (W2 = S10.current) == null ? void 0 : W2.contains) != null && z6.call(W2, l11.target) || i9({ type: 1 })));
  }, true), h2(d13.resolveContainers, (l11, F8) => {
    i9({ type: 1 }), h(F8, T.Loose) || (l11.preventDefault(), s18 == null || s18.focus());
  }, P5 === 0);
  let L3 = o4((l11) => {
    i9({ type: 1 });
    let F8 = (() => l11 ? l11 instanceof HTMLElement ? l11 : "current" in l11 && l11.current instanceof HTMLElement ? l11.current : s18 : s18)();
    F8 == null || F8.focus();
  }), r9 = (0, import_react88.useMemo)(() => ({ close: L3, isPortalled: E9 }), [L3, E9]), c15 = (0, import_react88.useMemo)(() => ({ open: P5 === 0, close: L3 }), [P5, L3]), B3 = { ref: n7 };
  return import_react88.default.createElement(re2.Provider, { value: null }, import_react88.default.createElement(ue2.Provider, { value: v5 }, import_react88.default.createElement(ie3.Provider, { value: r9 }, import_react88.default.createElement(c6, { value: u(P5, { [0]: d5.Open, [1]: d5.Closed }) }, import_react88.default.createElement(b8, null, X({ ourProps: B3, theirProps: R3, slot: c15, defaultTag: ke, name: "Popover" }), import_react88.default.createElement(d13.MainTreeNode, null))))));
}
var Ue3 = "button";
function We4(t17, o13) {
  let u10 = I(), { id: R3 = `headlessui-popover-button-${u10}`, ...O4 } = t17, [n7, e5] = oe2("Popover.Button"), { isPortalled: v5 } = fe2("Popover.Button"), P5 = (0, import_react88.useRef)(null), s18 = `headlessui-focus-sentinel-${I()}`, I7 = Ee2(), p7 = I7 == null ? void 0 : I7.closeOthers, m12 = Ge4() !== null;
  ...
  let [S10] = (0, import_react88.useState)(() => Symbol()), i9 = y2(P5, o13, m12 ? null : (r9) => {
    if (r9)
      n7.buttons.current.push(S10);
    else {
      let c15 = n7.buttons.current.indexOf(S10);
      c15 !== -1 && n7.buttons.current.splice(c15, 1);
    }
  ...
  }), a15 = y2(P5, o13), E9 = n3(P5), C5 = o4((r9) => {
    var c15, B3, D6;
    if (m12) {
      ...
      switch (r9.key) {
        case o8.Space:
        case o8.Enter:
          r9.preventDefault(), (B3 = (c15 = r9.target).click) == null || B3.call(c15), e5({ type: 1 }), (D6 = n7.button) == null || D6.focus();
          break;
      }
    } else
      switch (r9.key) {
        ...
        case o8.Escape:
          ...
          if (!P5.current || E9 != null && E9.activeElement && !P5.current.contains(E9.activeElement))
            return;
          r9.preventDefault(), r9.stopPropagation(), e5({ type: 1 });
          break;
      }
  }), H7 = o4((r9) => {
    m12 || r9.key === o8.Space && r9.preventDefault();
  }), x6 = o4((r9) => {
    var c15, B3;
    r2(r9.currentTarget) || t17.disabled || (m12 ? (e5({ type: 1 }), (c15 = n7.button) == null || c15.focus()) : (r9.preventDefault(), r9.stopPropagation(), n7.popoverState === 1 && (p7 == null || p7(n7.buttonId)), e5({ type: 0 }), (B3 = n7.button) == null || B3.focus()));
  }), M12 = o4((r9) => {
    r9.preventDefault(), r9.stopPropagation();
  }), h11 = n7.popoverState === 0, f14 = (0, import_react88.useMemo)(() => ({ open: h11 }), [h11]), y8 = s7(t17, P5), b8 = m12 ? { ref: a15, type: y8, onKeyDown: C5, onClick: x6 } : { ref: i9, id: n7.buttonId, type: y8, "aria-expanded": n7.popoverState === 0, "aria-controls": n7.panel ? n7.panelId : void 0, onKeyDown: C5, onKeyUp: H7, onClick: x6, onMouseDown: M12 }, d13 = n4(), L3 = o4(() => {
    let r9 = n7.panel;
    if (!r9)
      return;
    function c15() {
  ...
  return import_react88.default.createElement(import_react88.default.Fragment, null, X({ ourProps: b8, theirProps: O4, slot: f14, defaultTag: Ue3, name: "Popover.Button" }), h11 && !m12 && v5 && import_react88.default.createElement(c5, { id: s18, features: p3.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: L3 }));
}
var Ke4 = "div";
var je4 = S2.RenderStrategy | S2.Static;
function Ve3(t17, o13) {
  let u10 = I(), { id: R3 = `headlessui-popover-overlay-${u10}`, ...O4 } = t17, [{ popoverState: n7 }, e5] = oe2("Popover.Overlay"), v5 = y2(o13), P5 = C(), s18 = (() => P5 !== null ? (P5 & d5.Open) === d5.Open : n7 === 0)(), I7 = o4((m12) => {
    if (r2(m12.currentTarget))
      return m12.preventDefault();
    e5({ type: 1 });
  }), p7 = (0, import_react88.useMemo)(() => ({ open: n7 === 0 }), [n7]);
  return X({ ourProps: { ref: v5, id: R3, "aria-hidden": true, onClick: I7 }, theirProps: O4, slot: p7, defaultTag: Ke4, features: je4, visible: s18, name: "Popover.Overlay" });
}
var $e4 = "div";
var Je4 = S2.RenderStrategy | S2.Static;
function Xe4(t17, o13) {
  let u10 = I(), { id: R3 = `headlessui-popover-panel-${u10}`, focus: O4 = false, ...n7 } = t17, [e5, v5] = oe2("Popover.Panel"), { close: P5, isPortalled: s18 } = fe2("Popover.Panel"), I7 = `headlessui-focus-sentinel-before-${I()}`, p7 = `headlessui-focus-sentinel-after-${I()}`, T9 = (0, import_react88.useRef)(null), m12 = y2(T9, o13, (f14) => {
    v5({ type: 4, panel: f14 });
  }), S10 = n3(T9);
  l(() => (v5({ type: 5, panelId: R3 }), () => {
    v5({ type: 5, panelId: null });
  }), [R3, v5]);
  let i9 = C(), a15 = (() => i9 !== null ? (i9 & d5.Open) === d5.Open : e5.popoverState === 0)(), E9 = o4((f14) => {
    var y8;
    switch (f14.key) {
      case o8.Escape:
        if (e5.popoverState !== 0 || !T9.current || S10 != null && S10.activeElement && !T9.current.contains(S10.activeElement))
          return;
  ...
  }, [e5.popoverState, t17.unmount, t17.static, v5]), (0, import_react88.useEffect)(() => {
    if (e5.__demoMode || !O4 || e5.popoverState !== 0 || !T9.current)
      return;
    let f14 = S10 == null ? void 0 : S10.activeElement;
    T9.current.contains(f14) || O(T9.current, M.First);
  }, [e5.__demoMode, O4, T9, e5.popoverState]);
  let C5 = (0, import_react88.useMemo)(() => ({ open: e5.popoverState === 0, close: P5 }), [e5, P5]), H7 = { ref: m12, id: R3, onKeyDown: E9, onBlur: O4 && e5.popoverState === 0 ? (f14) => {
    var b8, d13, L3, r9, c15;
    let y8 = f14.relatedTarget;
    y8 && T9.current && ((b8 = T9.current) != null && b8.contains(y8) || (v5({ type: 1 }), ((L3 = (d13 = e5.beforePanelSentinel.current) == null ? void 0 : d13.contains) != null && L3.call(d13, y8) || (c15 = (r9 = e5.afterPanelSentinel.current) == null ? void 0 : r9.contains) != null && c15.call(r9, y8)) && y8.focus({ preventScroll: true })));
  } : void 0, tabIndex: -1 }, x6 = n4(), M12 = o4(() => {
    let f14 = T9.current;
    if (!f14)
      return;
    function y8() {
      u(x6.current, { [s10.Forwards]: () => {
        ...
        var b8;
        (b8 = e5.button) == null || b8.focus({ preventScroll: true });
      } });
    }
    y8();
  }), h11 = o4(() => {
    ...
    function y8() {
      u(x6.current, { [s10.Forwards]: () => {
        ...
        if (!e5.button)
          return;
        let b8 = f(), d13 = b8.indexOf(e5.button), L3 = b8.slice(0, d13 + 1), c15 = [...b8.slice(d13 + 1), ...L3];
        for (let D6 of c15.slice())
          if (D6.dataset.headlessuiFocusGuard === "true" || (B3 = e5.panel) != null && B3.contains(D6)) {
            let l11 = c15.indexOf(D6);
            l11 !== -1 && c15.splice(l11, 1);
          }
        O(c15, M.First, { sorted: false });
      }, [s10.Backwards]: () => {
        var d13;
  ...
  return import_react88.default.createElement(re2.Provider, { value: R3 }, a15 && s18 && import_react88.default.createElement(c5, { id: I7, ref: e5.beforePanelSentinel, features: p3.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: M12 }), X({ ourProps: H7, theirProps: n7, slot: C5, defaultTag: $e4, features: Je4, visible: a15, name: "Popover.Panel" }), a15 && s18 && import_react88.default.createElement(c5, { id: p7, ref: e5.afterPanelSentinel, features: p3.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: h11 }));
}
var Ye4 = "div";
function qe4(t17, o13) {
  let u10 = (0, import_react88.useRef)(null), R3 = y2(u10, o13), [O4, n7] = (0, import_react88.useState)([]), e5 = y5(), v5 = o4((i9) => {
    n7((a15) => {
      let E9 = a15.indexOf(i9);
      if (E9 !== -1) {
        let C5 = a15.slice();
  ...
  }), P5 = o4((i9) => (n7((a15) => [...a15, i9]), () => v5(i9))), s18 = o4(() => {
    var E9;
    let i9 = e(u10);
    if (!i9)
      return false;
    let a15 = i9.activeElement;
    return (E9 = u10.current) != null && E9.contains(a15) ? true : O4.some((C5) => {
      var H7, x6;
      return ((H7 = i9.getElementById(C5.buttonId.current)) == null ? void 0 : H7.contains(a15)) || ((x6 = i9.getElementById(C5.panelId.current)) == null ? void 0 : x6.contains(a15));
    });
  }), I7 = o4((i9) => {
    for (let a15 of O4)
      a15.buttonId.current !== i9 && a15.close();
  }), p7 = (0, import_react88.useMemo)(() => ({ registerPopover: P5, unregisterPopover: v5, isFocusWithinPopoverGroup: s18, closeOthers: I7, mainTreeNodeRef: e5.mainTreeNodeRef }), [P5, v5, s18, I7, e5.mainTreeNodeRef]), T9 = (0, import_react88.useMemo)(() => ({}), []), m12 = t17, S10 = { ref: R3 };
  return import_react88.default.createElement(Pe3.Provider, { value: p7 }, X({ ourProps: S10, theirProps: m12, slot: T9, defaultTag: Ye4, name: "Popover.Group" }), import_react88.default.createElement(e5.MainTreeNode, null));
}
var ze4 = D2(we3);
var Qe4 = D2(We4);
var Ze4 = D2(Ve3);
...
function c12(a15 = 0) {
  let [l11, r9] = (0, import_react89.useState)(a15), t17 = f7(), o13 = (0, import_react89.useCallback)((e5) => {
    t17.current && r9((u10) => u10 | e5);
  }, [l11, t17]), m12 = (0, import_react89.useCallback)((e5) => Boolean(l11 & e5), [l11]), s18 = (0, import_react89.useCallback)((e5) => {
    t17.current && r9((u10) => u10 & ~e5);
  }, [r9, t17]), g6 = (0, import_react89.useCallback)((e5) => {
    t17.current && r9((u10) => u10 ^ e5);
  }, [r9]);
  return { flags: l11, addFlag: o13, hasFlag: m12, removeFlag: s18, toggleFlag: g6 };
}

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/components/label/label.js
var import_react90 = __toESM(require_react(), 1);
var d11 = (0, import_react90.createContext)(null);
function u9() {
  let o13 = (0, import_react90.useContext)(d11);
  if (o13 === null) {
...
function H5() {
  let [o13, t17] = (0, import_react90.useState)([]);
  return [o13.length > 0 ? o13.join(" ") : void 0, (0, import_react90.useMemo)(() => function(e5) {
    let s18 = o4((r9) => (t17((l11) => [...l11, r9]), () => t17((l11) => {
      let n7 = l11.slice(), p7 = n7.indexOf(r9);
      return p7 !== -1 && n7.splice(p7, 1), n7;
    }))), a15 = (0, import_react90.useMemo)(() => ({ register: s18, slot: e5.slot, name: e5.name, props: e5.props }), [s18, e5.slot, e5.name, e5.props]);
    return import_react90.default.createElement(d11.Provider, { value: a15 }, e5.children);
  }, [t17])];
}
var A2 = "label";
function h10(o13, t17) {
  let i9 = I(), { id: e5 = `headlessui-label-${i9}`, passive: s18 = false, ...a15 } = o13, r9 = u9(), l11 = y2(t17);
  l(() => r9.register(e5), [e5, r9.register]);
  let n7 = { ref: l11, ...r9.props, id: e5 };
  return s18 && ("onClick" in n7 && (delete n7.htmlFor, delete n7.onClick), "onClick" in a15 && delete a15.onClick), X({ ourProps: n7, theirProps: a15, slot: r9.slot || {}, defaultTag: A2, name: r9.name || "Label" });
}
var v3 = D2(h10);
...
var ke2 = { [0](r9, o13) {
  let t17 = [...r9.options, { id: o13.id, element: o13.element, propsRef: o13.propsRef }];
  return { ...r9, options: I2(t17, (p7) => p7.element.current) };
}, [1](r9, o13) {
  let t17 = r9.options.slice(), p7 = r9.options.findIndex((T9) => T9.id === o13.id);
  return p7 === -1 ? r9 : (t17.splice(p7, 1), { ...r9, options: t17 });
} };
var B = (0, import_react91.createContext)(null);
B.displayName = "RadioGroupDataContext";
function oe3(r9) {
  let o13 = (0, import_react91.useContext)(B);
  if (o13 === null) {
...
function ne2(r9) {
  let o13 = (0, import_react91.useContext)($3);
  if (o13 === null) {
    let t17 = new Error(`<${r9} /> is missing a parent <RadioGroup /> component.`);
...
function Le2(r9, o13) {
  return u(o13.type, ke2, r9, o13);
}
var he3 = "div";
function Fe(r9, o13) {
  let t17 = I(), { id: p7 = `headlessui-radiogroup-${t17}`, value: T9, defaultValue: v5, form: S10, name: m12, onChange: M12, by: G2 = (e5, i9) => e5 === i9, disabled: C5 = false, ...H7 } = r9, y8 = o4(typeof G2 == "string" ? (e5, i9) => {
    let n7 = G2;
    return (e5 == null ? void 0 : e5[n7]) === (i9 == null ? void 0 : i9[n7]);
  } : G2), [P5, h11] = (0, import_react91.useReducer)(Le2, { options: [] }), a15 = P5.options, [N7, R3] = H5(), [k2, U5] = M3(), L3 = (0, import_react91.useRef)(null), W2 = y2(L3, o13), [l11, s18] = T4(T9, M12, v5), b8 = (0, import_react91.useMemo)(() => a15.find((e5) => !e5.propsRef.current.disabled), [a15]), F8 = (0, import_react91.useMemo)(() => a15.some((e5) => y8(e5.propsRef.current.value, l11)), [a15, l11]), d13 = o4((e5) => {
    var n7;
    if (C5 || y8(e5, l11))
      return false;
    let i9 = (n7 = a15.find((f14) => y8(f14.propsRef.current.value, e5))) == null ? void 0 : n7.propsRef.current;
  ...
  let x6 = o4((e5) => {
    ...
    if (!i9)
      return;
    let n7 = e(i9), f14 = a15.filter((u10) => u10.propsRef.current.disabled === false).map((u10) => u10.element.current);
    switch (e5.key) {
      case o8.Enter:
        p2(e5.currentTarget);
        break;
      ...
      case o8.ArrowUp:
        if (e5.preventDefault(), e5.stopPropagation(), O(f14, M.Previous | M.WrapAround) === N.Success) {
          let g6 = a15.find((K5) => K5.element.current === (n7 == null ? void 0 : n7.activeElement));
      ...
      case o8.Space:
        {
          ...
          let u10 = a15.find((g6) => g6.element.current === (n7 == null ? void 0 : n7.activeElement));
          u10 && d13(u10.propsRef.current.value);
        }
        break;
    }
  }), c15 = o4((e5) => (h11({ type: 0, ...e5 }), () => h11({ type: 1, id: e5.id }))), _7 = (0, import_react91.useMemo)(() => ({ value: l11, firstOption: b8, containsCheckedOption: F8, disabled: C5, compare: y8, ...P5 }), [l11, b8, F8, C5, y8, P5]), ie5 = (0, import_react91.useMemo)(() => ({ registerOption: c15, change: d13 }), [c15, d13]), ae5 = { ref: W2, id: p7, role: "radiogroup", "aria-labelledby": N7, "aria-describedby": k2, onKeyDown: x6 }, pe4 = (0, import_react91.useMemo)(() => ({ value: l11 }), [l11]), w6 = (0, import_react91.useRef)(null), le5 = p();
  return (0, import_react91.useEffect)(() => {
    w6.current && v5 !== void 0 && le5.addEventListener(w6.current, "reset", () => {
      d13(v5);
    });
  }, [w6, d13]), import_react91.default.createElement(U5, { name: "RadioGroup.Description" }, import_react91.default.createElement(R3, { name: "RadioGroup.Label" }, import_react91.default.createElement($3.Provider, { value: ie5 }, import_react91.default.createElement(B.Provider, { value: _7 }, m12 != null && l11 != null && e2({ [m12]: l11 }).map(([e5, i9], n7) => import_react91.default.createElement(c5, { features: p3.Hidden, ref: n7 === 0 ? (f14) => {
    var u10;
    w6.current = (u10 = f14 == null ? void 0 : f14.closest("form")) != null ? u10 : null;
  } : void 0, ...R({ key: e5, as: "input", type: "radio", checked: i9 != null, hidden: true, readOnly: true, form: S10, name: e5, value: i9 }) })), X({ ourProps: ae5, theirProps: H7, slot: pe4, defaultTag: he3, name: "RadioGroup" })))));
}
var xe4 = ((t17) => (t17[t17.Empty = 1] = "Empty", t17[t17.Active = 2] = "Active", t17))(xe4 || {});
var _e3 = "div";
function we4(r9, o13) {
  var x6;
  let t17 = I(), { id: p7 = `headlessui-radiogroup-option-${t17}`, value: T9, disabled: v5 = false, ...S10 } = r9, m12 = (0, import_react91.useRef)(null), M12 = y2(m12, o13), [G2, C5] = H5(), [H7, y8] = M3(), { addFlag: P5, removeFlag: h11, hasFlag: a15 } = c12(1), N7 = s2({ value: T9, disabled: v5 }), R3 = oe3("RadioGroup.Option"), k2 = ne2("RadioGroup.Option");
  l(() => k2.registerOption({ id: p7, element: m12, propsRef: N7 }), [p7, k2, m12, r9]);
  let U5 = o4((c15) => {
    var _7;
    if (r2(c15.currentTarget))
      return c15.preventDefault();
    k2.change(T9) && (P5(2), (_7 = m12.current) == null || _7.focus());
  }), L3 = o4((c15) => {
    if (r2(c15.currentTarget))
      return c15.preventDefault();
    P5(2);
  }), W2 = o4(() => h11(2)), l11 = ((x6 = R3.firstOption) == null ? void 0 : x6.id) === p7, s18 = R3.disabled || v5, b8 = R3.compare(R3.value, T9), F8 = { ref: M12, id: p7, role: "radio", "aria-checked": b8 ? "true" : "false", "aria-labelledby": G2, "aria-describedby": H7, "aria-disabled": s18 ? true : void 0, tabIndex: (() => s18 ? -1 : b8 || !R3.containsCheckedOption && l11 ? 0 : -1)(), onClick: s18 ? void 0 : U5, onFocus: s18 ? void 0 : L3, onBlur: s18 ? void 0 : W2 }, d13 = (0, import_react91.useMemo)(() => ({ checked: b8, disabled: s18, active: a15(2) }), [b8, s18, a15]);
  return import_react91.default.createElement(y8, { name: "RadioGroup.Description" }, import_react91.default.createElement(C5, { name: "RadioGroup.Label" }, X({ ourProps: F8, theirProps: S10, slot: d13, defaultTag: _e3, name: "RadioGroup.Option" })));
}
var Ie3 = D2(Fe);
var Se2 = D2(we4);
var yt = Object.assign(Ie3, { Option: Se2, Label: M6, Description: b3 });

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/components/switch/switch.js
var import_react92 = __toESM(require_react(), 1);
var y7 = (0, import_react92.createContext)(null);
y7.displayName = "GroupContext";
var Y3 = import_react92.Fragment;
function Z6(s18) {
  var d13;
  let [n7, p7] = (0, import_react92.useState)(null), [c15, f14] = H5(), [r9, h11] = M3(), l11 = (0, import_react92.useMemo)(() => ({ switch: n7, setSwitch: p7, labelledby: c15, describedby: r9 }), [n7, p7, c15, r9]), T9 = {}, b8 = s18;
  return import_react92.default.createElement(h11, { name: "Switch.Description" }, import_react92.default.createElement(f14, { name: "Switch.Label", props: { htmlFor: (d13 = l11.switch) == null ? void 0 : d13.id, onClick(t17) {
    n7 && (t17.currentTarget.tagName === "LABEL" && t17.preventDefault(), n7.click(), n7.focus({ preventScroll: true }));
  } } }, import_react92.default.createElement(y7.Provider, { value: l11 }, X({ ourProps: T9, theirProps: b8, defaultTag: Y3, name: "Switch.Group" }))));
}
var ee5 = "button";
function te3(s18, n7) {
  let p7 = I(), { id: c15 = `headlessui-switch-${p7}`, checked: f14, defaultChecked: r9 = false, onChange: h11, name: l11, value: T9, form: b8, ...d13 } = s18, t17 = (0, import_react92.useContext)(y7), u10 = (0, import_react92.useRef)(null), D6 = y2(u10, n7, t17 === null ? null : t17.setSwitch), [o13, a15] = T4(f14, h11, r9), S10 = o4(() => a15 == null ? void 0 : a15(!o13)), C5 = o4((e5) => {
  ...
  }), v5 = o4((e5) => e5.preventDefault()), G2 = (0, import_react92.useMemo)(() => ({ checked: o13 }), [o13]), R3 = { id: c15, ref: D6, role: "switch", type: s7(s18, u10), tabIndex: 0, "aria-checked": o13, "aria-labelledby": t17 == null ? void 0 : t17.labelledby, "aria-describedby": t17 == null ? void 0 : t17.describedby, onClick: C5, onKeyUp: L3, onKeyPress: v5 }, k2 = p();
  ...
  }, [u10, a15]), import_react92.default.createElement(import_react92.default.Fragment, null, l11 != null && o13 && import_react92.default.createElement(c5, { features: p3.Hidden, ...R({ as: "input", type: "checkbox", hidden: true, readOnly: true, form: b8, checked: o13, name: l11, value: T9 }) }), X({ ourProps: R3, theirProps: d13, slot: G2, defaultTag: ee5, name: "Switch" }));
}
var ne3 = D2(te3);
var re3 = Z6;
var Ge5 = Object.assign(ne3, { Group: re3, Label: M6, Description: b3 });
...
function A5({ onFocus: n7 }) {
  let [r9, o13] = (0, import_react93.useState)(true), u10 = f7();
  return r9 ? import_react93.default.createElement(c5, { as: "button", type: "button", features: p3.Focusable, onFocus: (a15) => {
    a15.preventDefault();
    let e5, i9 = 50;
    function t17() {
      if (i9-- <= 0) {
...
function a13() {
  return { groups: /* @__PURE__ */ new Map(), get(n7, t17) {
    ...
    let l11 = (c15 = e5.get(t17)) != null ? c15 : 0;
    e5.set(t17, l11 + 1);
    let o13 = Array.from(e5.keys()).indexOf(t17);
    function i9() {
      let u10 = e5.get(t17);
...
function d12(n7) {
  ...
  let e5 = f13(), [l11, o13] = t17.current.get(n7, e5);
  return r8.useEffect(() => o13, []), l11;
}
function f13() {
  var l11, o13, i9;
  let n7 = (i9 = (o13 = (l11 = r8.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) == null ? void 0 : l11.ReactCurrentOwner) == null ? void 0 : o13.current) != null ? i9 : null;
  if (!n7)
    return Symbol();
  let t17 = [], e5 = n7;
  for (; e5; )
...
var ce3 = { [0](e5, n7) {
  var u10;
  let t17 = I2(e5.tabs, (T9) => T9.current), o13 = I2(e5.panels, (T9) => T9.current), s18 = t17.filter((T9) => {
    var l11;
    return !((l11 = T9.current) != null && l11.hasAttribute("disabled"));
  }), r9 = { ...e5, tabs: t17, panels: o13 };
  if (n7.index < 0 || n7.index > t17.length - 1) {
    let T9 = u(Math.sign(n7.index - e5.selectedIndex), { [-1]: () => 1, [0]: () => u(Math.sign(n7.index), { [-1]: () => 0, [0]: () => 0, [1]: () => 1 }), [1]: () => 0 });
    if (s18.length === 0)
      return r9;
    let l11 = u(T9, { [0]: () => t17.indexOf(s18[0]), [1]: () => t17.indexOf(s18[s18.length - 1]) });
    return { ...r9, selectedIndex: l11 === -1 ? e5.selectedIndex : l11 };
  }
  let i9 = t17.slice(0, n7.index), b8 = [...t17.slice(n7.index), ...i9].find((T9) => s18.includes(T9));
  if (!b8)
    return r9;
  let c15 = (u10 = t17.indexOf(b8)) != null ? u10 : e5.selectedIndex;
  return c15 === -1 && (c15 = e5.selectedIndex), { ...r9, selectedIndex: c15 };
}, [1](e5, n7) {
  var r9;
  if (e5.tabs.includes(n7.tab))
    return e5;
  let t17 = e5.tabs[e5.selectedIndex], o13 = I2([...e5.tabs, n7.tab], (i9) => i9.current), s18 = (r9 = o13.indexOf(t17)) != null ? r9 : e5.selectedIndex;
  return s18 === -1 && (s18 = e5.selectedIndex), { ...e5, tabs: o13, selectedIndex: s18 };
}, [2](e5, n7) {
...
var X4 = (0, import_react94.createContext)(null);
X4.displayName = "TabsDataContext";
function M8(e5) {
  let n7 = (0, import_react94.useContext)(X4);
  if (n7 === null) {
...
function me3(e5, n7) {
  let { defaultIndex: t17 = 0, vertical: o13 = false, manual: s18 = false, onChange: r9, selectedIndex: i9 = null, ...R3 } = e5;
  const b8 = o13 ? "vertical" : "horizontal", c15 = s18 ? "manual" : "auto";
  let u10 = i9 !== null, T9 = y2(n7), [l11, d13] = (0, import_react94.useReducer)(fe3, { selectedIndex: i9 != null ? i9 : t17, tabs: [], panels: [] }), g6 = (0, import_react94.useMemo)(() => ({ selectedIndex: l11.selectedIndex }), [l11.selectedIndex]), m12 = s2(r9 || (() => {
  })), y8 = s2(l11.tabs), E9 = (0, import_react94.useMemo)(() => ({ orientation: b8, activation: c15, ...l11 }), [b8, c15, l11]), I7 = o4((p7) => (d13({ type: 1, tab: p7 }), () => d13({ type: 2, tab: p7 }))), A6 = o4((p7) => (d13({ type: 3, panel: p7 }), () => d13({ type: 4, panel: p7 }))), L3 = o4((p7) => {
    C5.current !== p7 && m12.current(p7), u10 || d13({ type: 0, index: p7 });
  }), C5 = s2(u10 ? e5.selectedIndex : l11.selectedIndex), N7 = (0, import_react94.useMemo)(() => ({ registerTab: I7, registerPanel: A6, change: L3 }), []);
  l(() => {
    d13({ type: 0, index: i9 != null ? i9 : t17 });
  }, [i9]), l(() => {
    if (C5.current === void 0 || l11.tabs.length <= 0)
      return;
    let p7 = I2(l11.tabs, (a15) => a15.current);
    p7.some((a15, f14) => l11.tabs[f14] !== a15) && L3(p7.indexOf(l11.tabs[C5.current]));
  });
  let B3 = { ref: T9 };
  return import_react94.default.createElement(C3, null, import_react94.default.createElement($4.Provider, { value: N7 }, import_react94.default.createElement(X4.Provider, { value: E9 }, E9.tabs.length <= 0 && import_react94.default.createElement(A5, { onFocus: () => {
    var p7, D6;
    for (let a15 of y8.current)
      if (((p7 = a15.current) == null ? void 0 : p7.tabIndex) === 0)
        return (D6 = a15.current) == null || D6.focus(), true;
    return false;
  } }), X({ ourProps: B3, theirProps: R3, slot: g6, defaultTag: be3, name: "Tabs" }))));
}
var Pe4 = "div";
function xe5(e5, n7) {
  let { orientation: t17, selectedIndex: o13 } = M8("Tab.List"), s18 = y2(n7);
  return X({ ourProps: { ref: s18, role: "tablist", "aria-orientation": t17 }, theirProps: e5, slot: { selectedIndex: o13 }, defaultTag: Pe4, name: "Tabs.List" });
}
var ge6 = "button";
function ye4(e5, n7) {
  var p7, D6;
  let t17 = I(), { id: o13 = `headlessui-tabs-tab-${t17}`, ...s18 } = e5, { orientation: r9, activation: i9, selectedIndex: R3, tabs: b8, panels: c15 } = M8("Tab"), u10 = q4("Tab"), T9 = M8("Tab"), l11 = (0, import_react94.useRef)(null), d13 = y2(l11, n7);
  l(() => u10.registerTab(l11), [u10, l11]);
  let g6 = d12("tabs"), m12 = b8.indexOf(l11);
  m12 === -1 && (m12 = g6);
  let y8 = m12 === R3, E9 = o4((a15) => {
    var j7;
    let f14 = a15();
    if (f14 === N.Success && i9 === "auto") {
      let W2 = (j7 = e(l11)) == null ? void 0 : j7.activeElement, z6 = T9.tabs.findIndex((te5) => te5.current === W2);
      z6 !== -1 && u10.change(z6);
    }
    return f14;
  }), I7 = o4((a15) => {
    let f14 = b8.map((W2) => W2.current).filter(Boolean);
    ...
    switch (a15.key) {
      case o8.Home:
      case o8.PageUp:
        return a15.preventDefault(), a15.stopPropagation(), E9(() => O(f14, M.First));
      case o8.End:
      case o8.PageDown:
        return a15.preventDefault(), a15.stopPropagation(), E9(() => O(f14, M.Last));
    }
    if (E9(() => u(r9, { vertical() {
      return a15.key === o8.ArrowUp ? O(f14, M.Previous | M.WrapAround) : a15.key === o8.ArrowDown ? O(f14, M.Next | M.WrapAround) : N.Error;
    }, horizontal() {
      return a15.key === o8.ArrowLeft ? O(f14, M.Previous | M.WrapAround) : a15.key === o8.ArrowRight ? O(f14, M.Next | M.WrapAround) : N.Error;
    } })) === N.Success)
      return a15.preventDefault();
  }), A6 = (0, import_react94.useRef)(false), L3 = o4(() => {
    var a15;
    A6.current || (A6.current = true, (a15 = l11.current) == null || a15.focus({ preventScroll: true }), u10.change(m12), t3(() => {
      A6.current = false;
    }));
  }), C5 = o4((a15) => {
    a15.preventDefault();
  }), N7 = (0, import_react94.useMemo)(() => ({ selected: y8 }), [y8]), B3 = { ref: d13, onKeyDown: I7, onMouseDown: C5, onClick: L3, id: o13, role: "tab", type: s7(e5, l11), "aria-controls": (D6 = (p7 = c15[m12]) == null ? void 0 : p7.current) == null ? void 0 : D6.id, "aria-selected": y8, tabIndex: y8 ? 0 : -1 };
  return X({ ourProps: B3, theirProps: s18, slot: N7, defaultTag: ge6, name: "Tabs.Tab" });
}
var Ee3 = "div";
function Ae2(e5, n7) {
  let { selectedIndex: t17 } = M8("Tab.Panels"), o13 = y2(n7), s18 = (0, import_react94.useMemo)(() => ({ selectedIndex: t17 }), [t17]);
  return X({ ourProps: { ref: o13 }, theirProps: e5, slot: s18, defaultTag: Ee3, name: "Tabs.Panels" });
}
var Re2 = "div";
var Le3 = S2.RenderStrategy | S2.Static;
function Se3(e5, n7) {
  var E9, I7, A6, L3;
  let t17 = I(), { id: o13 = `headlessui-tabs-panel-${t17}`, tabIndex: s18 = 0, ...r9 } = e5, { selectedIndex: i9, tabs: R3, panels: b8 } = M8("Tab.Panel"), c15 = q4("Tab.Panel"), u10 = (0, import_react94.useRef)(null), T9 = y2(u10, n7);
  l(() => c15.registerPanel(u10), [c15, u10]);
  let l11 = d12("panels"), d13 = b8.indexOf(u10);
  d13 === -1 && (d13 = l11);
  let g6 = d13 === i9, m12 = (0, import_react94.useMemo)(() => ({ selected: g6 }), [g6]), y8 = { ref: T9, id: o13, role: "tabpanel", "aria-labelledby": (I7 = (E9 = R3[d13]) == null ? void 0 : E9.current) == null ? void 0 : I7.id, tabIndex: g6 ? s18 : -1 };
  return !g6 && ((A6 = r9.unmount) == null || A6) && !((L3 = r9.static) != null && L3) ? import_react94.default.createElement(c5, { as: "span", ...y8 }) : X({ ourProps: y8, theirProps: r9, slot: m12, defaultTag: Re2, features: Le3, visible: g6, name: "Tabs.Panel" });
}
var Ie4 = D2(ye4);
var De3 = D2(me3);
var Fe2 = D2(xe5);
...
function b7(t17, e5) {
  ...
  if (!t17)
    return n7.dispose;
  let { transitionDuration: m12, transitionDelay: a15 } = getComputedStyle(t17), [u10, p7] = [m12, a15].map((l11) => {
    let [r9 = 0] = l11.split(",").filter(Boolean).map((i9) => i9.includes("ms") ? parseFloat(i9) : parseFloat(i9) * 1e3).sort((i9, T9) => T9 - i9);
    return r9;
  }), o13 = u10 + p7;
  if (o13 !== 0) {
    n7.group((r9) => {
      r9.setTimeout(() => {
        e5(), r9.dispose();
      }, o13), r9.addEventListener(t17, "transitionrun", (i9) => {
...
function M9(t17, e5, n7, m12) {
  let a15 = n7 ? "enter" : "leave", u10 = o2(), p7 = m12 !== void 0 ? l10(m12) : () => {
  };
  a15 === "enter" && (t17.removeAttribute("hidden"), t17.style.display = "");
  let o13 = u(a15, { enter: () => e5.enter, leave: () => e5.leave }), l11 = u(a15, { enter: () => e5.enterTo, leave: () => e5.leaveTo }), r9 = u(a15, { enter: () => e5.enterFrom, leave: () => e5.leaveFrom });
  return v4(t17, ...e5.base, ...e5.enter, ...e5.enterTo, ...e5.enterFrom, ...e5.leave, ...e5.leaveFrom, ...e5.leaveTo, ...e5.entered), g5(t17, ...e5.base, ...o13, ...r9), u10.nextFrame(() => {
    v4(t17, ...e5.base, ...o13, ...r9), g5(t17, ...e5.base, ...o13, ...l11), b7(t17, () => (v4(t17, ...e5.base, ...o13), g5(t17, ...e5.base, ...e5.entered), p7()));
  }), u10.dispose;
}

// node_modules/@graphiql/react/node_modules/@headlessui/react/dist/hooks/use-transition.js
function E8({ immediate: t17, container: s18, direction: n7, classes: u10, onStart: a15, onStop: c15 }) {
  ...
  l(() => {
    ...
    if (i9 && e5.current !== "idle" && l11.current)
      return r9.dispose(), a15.current(e5.current), r9.add(M9(i9, u10.current, e5.current === "enter", () => {
        r9.dispose(), c15.current(e5.current);
      })), r9.dispose;
  }, [n7]);
}
...
var _6 = (0, import_react95.createContext)(null);
_6.displayName = "TransitionContext";
var be4 = ((r9) => (r9.Visible = "visible", r9.Hidden = "hidden", r9))(be4 || {});
function Se4() {
  let t17 = (0, import_react95.useContext)(_6);
  if (t17 === null)
    throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return t17;
}
function Ne5() {
  let t17 = (0, import_react95.useContext)(M10);
  if (t17 === null)
    throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return t17;
}
var M10 = (0, import_react95.createContext)(null);
...
function oe4(t17, n7) {
  let r9 = s2(t17), s18 = (0, import_react95.useRef)([]), y8 = f7(), D6 = p(), c15 = o4((i9, e5 = j.Hidden) => {
    let a15 = s18.current.findIndex(({ el: o13 }) => o13 === i9);
    a15 !== -1 && (u(e5, { [j.Unmount]() {
      s18.current.splice(a15, 1);
    }, [j.Hidden]() {
      s18.current[a15].state = "hidden";
    } }), D6.microTask(() => {
      var o13;
      !U4(s18) && y8.current && ((o13 = r9.current) == null || o13.call(r9));
    }));
  }), x6 = o4((i9) => {
    let e5 = s18.current.find(({ el: a15 }) => a15 === i9);
    return e5 ? e5.state !== "visible" && (e5.state = "visible") : s18.current.push({ el: i9, state: "visible" }), () => c15(i9, j.Unmount);
  }), p7 = (0, import_react95.useRef)([]), h11 = (0, import_react95.useRef)(Promise.resolve()), u10 = (0, import_react95.useRef)({ enter: [], leave: [], idle: [] }), v5 = o4((i9, e5, a15) => {
    p7.current.splice(0), n7 && (n7.chains.current[e5] = n7.chains.current[e5].filter(([o13]) => o13 !== i9)), n7 == null || n7.chains.current[e5].push([i9, new Promise((o13) => {
      p7.current.push(o13);
    })]), n7 == null || n7.chains.current[e5].push([i9, new Promise((o13) => {
      Promise.all(u10.current[e5].map(([f14, P5]) => P5)).then(() => o13());
    })]), e5 === "enter" ? h11.current = h11.current.then(() => n7 == null ? void 0 : n7.wait.current).then(() => a15(e5)) : a15(e5);
  }), d13 = o4((i9, e5, a15) => {
    Promise.all(u10.current[e5].splice(0).map(([o13, f14]) => f14)).then(() => {
      var o13;
      (o13 = p7.current.shift()) == null || o13();
    }).then(() => a15(e5));
  });
  return (0, import_react95.useMemo)(() => ({ children: s18, register: x6, unregister: c15, onStart: v5, onStop: d13, wait: h11, chains: u10 }), [x6, c15, s18, v5, d13, u10, h11]);
}
function xe6() {
}
...
function se4(t17) {
  ...
  let n7 = {};
  for (let s18 of Pe5)
    n7[s18] = (r9 = t17[s18]) != null ? r9 : xe6;
  return n7;
}
function Re3(t17) {
  let n7 = (0, import_react95.useRef)(se4(t17));
...
function De4(t17, n7) {
  var K5, Q6;
  let { beforeEnter: r9, afterEnter: s18, beforeLeave: y8, afterLeave: D6, enter: c15, enterFrom: x6, enterTo: p7, entered: h11, leave: u10, leaveFrom: v5, leaveTo: d13, ...i9 } = t17, e5 = (0, import_react95.useRef)(null), a15 = y2(e5, n7), o13 = (K5 = i9.unmount) == null || K5 ? j.Unmount : j.Hidden, { show: f14, appear: P5, initial: T9 } = Se4(), [l11, j7] = (0, import_react95.useState)(f14 ? "visible" : "hidden"), q6 = Ne5(), { register: O4, unregister: V4 } = q6;
  (0, import_react95.useEffect)(() => O4(e5), [O4, e5]), (0, import_react95.useEffect)(() => {
    if (o13 === j.Hidden && e5.current) {
      if (f14 && l11 !== "visible") {
        j7("visible");
        return;
      }
  ...
  }, [l11, e5, O4, V4, f14, o13]);
  let k2 = s2({ base: S9(i9.className), enter: S9(c15), enterFrom: S9(x6), enterTo: S9(p7), entered: S9(h11), leave: S9(u10), leaveFrom: S9(v5), leaveTo: S9(d13) }), w6 = Re3({ beforeEnter: r9, afterEnter: s18, beforeLeave: y8, afterLeave: D6 }), G2 = l2();
  (0, import_react95.useEffect)(() => {
    if (G2 && l11 === "visible" && e5.current === null)
      throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e5, l11, G2]);
  let ue6 = T9 && !P5, z6 = P5 && f14 && T9, Te4 = (() => !G2 || ue6 ? "idle" : f14 ? "enter" : "leave")(), H7 = c12(0), de5 = o4((g6) => u(g6, { enter: () => {
    H7.addFlag(d5.Opening), w6.current.beforeEnter();
  }, leave: () => {
    H7.addFlag(d5.Closing), w6.current.beforeLeave();
  }, idle: () => {
  } })), fe5 = o4((g6) => u(g6, { enter: () => {
  ...
  E8({ immediate: z6, container: e5, classes: k2, direction: Te4, onStart: s2((g6) => {
    A6.onStart(e5, g6, de5);
  }), onStop: s2((g6) => {
    A6.onStop(e5, g6, fe5), g6 === "leave" && !U4(A6) && (j7("hidden"), V4(e5));
  }) });
  let R3 = i9, me5 = { ref: a15 };
  return z6 ? R3 = { ...R3, className: t6(i9.className, ...k2.current.enter, ...k2.current.enterFrom) } : (R3.className = t6(i9.className, (Q6 = e5.current) == null ? void 0 : Q6.className), R3.className === "" && delete R3.className), import_react95.default.createElement(M10.Provider, { value: A6 }, import_react95.default.createElement(c6, { value: u(l11, { ["visible"]: d5.Open, ["hidden"]: d5.Closed }) | H7.flags }, X({ ourProps: me5, theirProps: R3, defaultTag: ye5, features: ae3, visible: l11 === "visible", name: "Transition.Child" })));
}
function He5(t17, n7) {
  let { show: r9, appear: s18 = false, unmount: y8 = true, ...D6 } = t17, c15 = (0, import_react95.useRef)(null), x6 = y2(c15, n7);
  l2();
  let p7 = C();
  if (r9 === void 0 && p7 !== null && (r9 = (p7 & d5.Open) === d5.Open), ![true, false].includes(r9))
    throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
  let [h11, u10] = (0, import_react95.useState)(r9 ? "visible" : "hidden"), v5 = oe4(() => {
    u10("hidden");
  }), [d13, i9] = (0, import_react95.useState)(true), e5 = (0, import_react95.useRef)([r9]);
  l(() => {
    d13 !== false && e5.current[e5.current.length - 1] !== r9 && (e5.current.push(r9), i9(false));
  }, [e5, r9]);
  let a15 = (0, import_react95.useMemo)(() => ({ show: r9, appear: s18, initial: d13 }), [r9, s18, d13]);
  (0, import_react95.useEffect)(() => {
    if (r9)
      u10("visible");
    else if (!U4(v5))
      ...
      if (!T9)
        return;
      let l11 = T9.getBoundingClientRect();
      l11.x === 0 && l11.y === 0 && l11.width === 0 && l11.height === 0 && u10("hidden");
    }
  }, [r9, v5]);
  let o13 = { unmount: y8 }, f14 = o4(() => {
    var T9;
    d13 && i9(false), (T9 = t17.beforeEnter) == null || T9.call(t17);
  }), P5 = o4(() => {
    var T9;
    d13 && i9(false), (T9 = t17.beforeLeave) == null || T9.call(t17);
  });
  return import_react95.default.createElement(M10.Provider, { value: v5 }, import_react95.default.createElement(_6.Provider, { value: a15 }, X({ ourProps: { ...o13, as: import_react95.Fragment, children: import_react95.default.createElement(le3, { ref: x6, ...o13, ...D6, beforeEnter: f14, beforeLeave: P5 }) }, theirProps: {}, defaultTag: import_react95.Fragment, features: ae3, visible: h11 === "visible", name: "Transition" })));
}
function Fe3(t17, n7) {
  let r9 = (0, import_react95.useContext)(_6) !== null, s18 = C() !== null;
  return import_react95.default.createElement(import_react95.default.Fragment, null, !r9 && s18 ? import_react95.default.createElement(W, { ref: n7, ...t17 }) : import_react95.default.createElement(le3, { ref: n7, ...t17 }));
}
var W = D2(He5);
var le3 = D2(De4);
var Le4 = D2(Fe3);
...
var s17 = (e5, t17) => cn(e5, "name", { value: t17, configurable: true });
function ce4(e5) {
  const t17 = (0, import_react96.createContext)(null);
  return t17.displayName = e5, t17;
}
s17(ce4, "createNullableContext");
function ue5(e5) {
  function t17(n7) {
    var l11;
    const r9 = (0, import_react96.useContext)(e5);
    if (r9 === null && (n7 != null && n7.nonNull))
      throw new Error(
        `Tried to use \`${((l11 = n7.caller) == null ? void 0 : l11.name) || t17.caller.name}\` without the necessary context. Make sure to render the \`${e5.displayName}Provider\` component higher up the tree.`
      );
    return r9;
  }
  return s17(t17, "useGivenContext"), Object.defineProperty(t17, "name", {
    value: `use${e5.displayName}`
  }), t17;
}
s17(ue5, "createContextHook");
var Ht = ce4("StorageContext");
function Fn(e5) {
  const t17 = (0, import_react96.useRef)(true), [n7, r9] = (0, import_react96.useState)(new StorageAPI(e5.storage));
  return (0, import_react96.useEffect)(() => {
    t17.current ? t17.current = false : r9(new StorageAPI(e5.storage));
  }, [e5.storage]), (0, import_jsx_runtime.jsx)(Ht.Provider, { value: n7, children: e5.children });
}
...
var Bn = s17(({
  ...
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("path", { d: "M5.0484 1.40838C6.12624 0.33054 7.87376 0.330541 8.9516 1.40838L12.5916 5.0484C13.6695 6.12624 13.6695 7.87376 12.5916 8.9516L8.9516 12.5916C7.87376 13.6695 6.12624 13.6695 5.0484 12.5916L1.40838 8.9516C0.33054 7.87376 0.330541 6.12624 1.40838 5.0484L5.0484 1.40838Z", stroke: "currentColor", strokeWidth: 1.2 }), a14.createElement("rect", { x: 6, y: 6, width: 2, height: 2, rx: 1, fill: "currentColor" })), "SvgArgument");
var Wn = s17(({
  title: e5,
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "0 0 14 9", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("path", { d: "M1 1L7 7L13 1", stroke: "currentColor", strokeWidth: 1.5 })), "SvgChevronDown");
var $n = s17(({
  title: e5,
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "0 0 7 10", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("path", { d: "M6 1.04819L2 5.04819L6 9.04819", stroke: "currentColor", strokeWidth: 1.75 })), "SvgChevronLeft");
var _n = s17(({
  title: e5,
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "0 0 14 9", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("path", { d: "M13 8L7 2L1 8", stroke: "currentColor", strokeWidth: 1.5 })), "SvgChevronUp");
var Zn = s17(({
  title: e5,
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("path", { d: "M1 1L12.9998 12.9997", stroke: "currentColor", strokeWidth: 1.5 }), a14.createElement("path", { d: "M13 1L1.00079 13.0003", stroke: "currentColor", strokeWidth: 1.5 })), "SvgClose");
var Gn = s17(({
  title: e5,
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "-2 -2 22 22", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("path", { d: "M11.25 14.2105V15.235C11.25 16.3479 10.3479 17.25 9.23501 17.25H2.76499C1.65214 17.25 0.75 16.3479 0.75 15.235L0.75 8.76499C0.75 7.65214 1.65214 6.75 2.76499 6.75L3.78947 6.75", stroke: "currentColor", strokeWidth: 1.5 }), a14.createElement("rect", { x: 6.75, y: 0.75, width: 10.5, height: 10.5, rx: 2.2069, stroke: "currentColor", strokeWidth: 1.5 })), "SvgCopy");
var Qn = s17(({
  title: e5,
  titleId: t17,
  ...n7
...
var pr = s17(({
  ...
  titleId: t17,
  ...n7
}) => a14.createElement("svg", { height: "1em", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-labelledby": t17, ...n7 }, e5 ? a14.createElement("title", { id: t17 }, e5) : null, a14.createElement("rect", { width: 16, height: 16, rx: 2, fill: "currentColor" })), "SvgStop");
var fr = s17(({
  title: e5,
  titleId: t17,
  ...n7
...
var Rr = q5(ur);
var rl = q5(dr);
var Hr = q5(hr, "filled star icon");
var Ar = q5(mr);
var Pr = q5(pr);
var ke3 = q5(fr);
function q5(e5, t17 = e5.name.replace("Svg", "").replaceAll(/([A-Z])/g, " $1").trimStart().toLowerCase() + " icon") {
  return e5.defaultProps = { title: t17 }, e5;
}
s17(q5, "generateIcon");
var X5 = (0, import_react96.forwardRef)((e5, t17) => (0, import_jsx_runtime.jsx)(
  "button",
  {
    ...e5,
    ref: t17,
    className: clsx("graphiql-un-styled", e5.className)
  }
));
X5.displayName = "UnStyledButton";
var Fe4 = (0, import_react96.forwardRef)((e5, t17) => (0, import_jsx_runtime.jsx)(
  "button",
  {
    ...e5,
    ref: t17,
...
Fe4.displayName = "Button";
var qr = (0, import_react96.forwardRef)((e5, t17) => (0, import_jsx_runtime.jsx)(
  "div",
  {
    ...e5,
    ref: t17,
    className: clsx("graphiql-button-group", e5.className)
  }
));
qr.displayName = "ButtonGroup";
var Le5 = s17((e5, t17) => Object.entries(t17).reduce((n7, [r9, l11]) => (n7[r9] = l11, n7), e5), "createComponentGroup");
var At = (0, import_react96.forwardRef)((e5, t17) => (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$f39c2d165cd861fe, { asChild: true, children: (0, import_jsx_runtime.jsxs)(
  X5,
  {
    ...e5,
    ref: t17,
    type: "button",
    className: clsx("graphiql-dialog-close", e5.className),
    children: [
...
function Dr({
  ...
  return (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, { ...t17, children: (0, import_jsx_runtime.jsxs)($5d3850c4d0b4e6c7$export$602eac185826482c, { children: [
    (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, { className: "graphiql-dialog-overlay" }),
    (0, import_jsx_runtime.jsx)($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, { className: "graphiql-dialog", children: e5 })
  ] }) });
}
s17(Dr, "DialogRoot");
var ol = Le5(Dr, {
...
var Pt = (0, import_react96.forwardRef)(
  (e5, t17) => (0, import_jsx_runtime.jsx)($d08ef79370b62062$export$41fb9f06171c75f4, { asChild: true, children: (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...e5,
      ref: t17,
...
s17(Ir, "Content");
var Or = s17(({ className: e5, children: t17, ...n7 }) => (0, import_jsx_runtime.jsx)($d08ef79370b62062$export$6d08773d2e66f8f2, { className: clsx("graphiql-dropdown-item", e5), ...n7, children: t17 }), "Item");
var le4 = Le5($d08ef79370b62062$export$be92b6f5f03c0fe9, {
  Button: Pt,
  Item: Or,
  Content: Ir
});
...
var ne5 = (0, import_react96.forwardRef)(({ children: e5, onlyShowFirstChild: t17, type: n7, ...r9 }, l11) => (0, import_jsx_runtime.jsx)(
  "div",
  {
    ...r9,
    ref: l11,
    className: clsx(
      ...
      t17 && "graphiql-markdown-preview",
      r9.className
    ),
    dangerouslySetInnerHTML: { __html: Ae3.render(e5) }
  }
));
ne5.displayName = "MarkdownContent";
var qt = (0, import_react96.forwardRef)(
  (e5, t17) => (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...e5,
      ref: t17,
      className: clsx("graphiql-spinner", e5.className)
    }
  )
);
...
function Fr({
  ...
  return (0, import_jsx_runtime.jsxs)($a093c7e1ec25a057$export$be92b6f5f03c0fe9, { children: [
    (0, import_jsx_runtime.jsx)($a093c7e1ec25a057$export$41fb9f06171c75f4, { asChild: true, children: e5 }),
...
var Dt = (0, import_react96.forwardRef)(
  ({ isActive: e5, value: t17, children: n7, className: r9, ...l11 }, c15) => (0, import_jsx_runtime.jsx)(
    Reorder.Item,
    {
      ...l11,
      ref: c15,
      value: t17,
      "aria-selected": e5 ? "true" : void 0,
      role: "tab",
      className: clsx(
        "graphiql-tab",
        e5 && "graphiql-tab-active",
        r9
      ),
      children: n7
    }
...
Dt.displayName = "Tab";
var It = (0, import_react96.forwardRef)((e5, t17) => (0, import_jsx_runtime.jsx)(
  X5,
  {
    ...e5,
    ref: t17,
    type: "button",
    className: clsx("graphiql-tab-button", e5.className),
    children: e5.children
  }
));
It.displayName = "Tab.Button";
var Ot = (0, import_react96.forwardRef)(
  (e5, t17) => (0, import_jsx_runtime.jsx)(ae4, { label: "Close Tab", children: (0, import_jsx_runtime.jsx)(
    X5,
    {
      ...
      ref: t17,
      type: "button",
      className: clsx("graphiql-tab-close", e5.className),
...
var Br = (0, import_react96.forwardRef)(
  ({ values: e5, onReorder: t17, children: n7, className: r9, ...l11 }, c15) => (0, import_jsx_runtime.jsx)(
    Reorder.Group,
    {
      ...l11,
      ref: c15,
...
function Wr(e5) {
  var p7;
  const t17 = de4(), n7 = (0, import_react96.useRef)(
    new HistoryStore(
      // Fall back to a noop storage when the StorageContext is empty
      t17 || new StorageAPI(null),
      e5.maxHistoryLength || $r
    )
  ), [r9, l11] = (0, import_react96.useState)(((p7 = n7.current) == null ? void 0 : p7.queries) || []), c15 = (0, import_react96.useCallback)(
    ({ query: m12, variables: y8, headers: u10, operationName: g6 }) => {
      var C5;
    ...
    ({ query: m12, variables: y8, headers: u10, operationName: g6, label: C5, favorite: d13 }) => {
    ...
    []
  ), h11 = (0, import_react96.useCallback)(
    ({ query: m12, variables: y8, headers: u10, operationName: g6, label: C5, favorite: d13 }) => {
    ...
    []
  ), f14 = (0, import_react96.useMemo)(
    () => ({ addToHistory: c15, editLabel: i9, items: r9, toggleFavorite: h11 }),
    [c15, i9, r9, h11]
  );
  return (0, import_jsx_runtime.jsx)(Ft.Provider, { value: f14, children: e5.children });
}
s17(Wr, "HistoryContextProvider");
var Be3 = ue5(Ft);
var $r = 20;
function _r() {
  const { items: e5 } = Be3({ nonNull: true }), t17 = e5.slice().reverse();
  return (0, import_jsx_runtime.jsxs)("section", { "aria-label": "History", className: "graphiql-history", children: [
    ...
    (0, import_jsx_runtime.jsx)("ul", { className: "graphiql-history-items", children: t17.map((n7, r9) => (0, import_jsx_runtime.jsxs)(import_react96.Fragment, { children: [
      (0, import_jsx_runtime.jsx)(Xe5, { item: n7 }),
      n7.favorite && t17[r9 + 1] && !t17[r9 + 1].favorite ? (0, import_jsx_runtime.jsx)("div", { className: "graphiql-history-item-spacer" }) : null
    ] }, `${r9}:${n7.label || n7.query}`)) })
  ] });
}
s17(_r, "History");
function Xe5(e5) {
  const { editLabel: t17, toggleFavorite: n7 } = Be3({
    nonNull: true,
    caller: Xe5
  }), { headerEditor: r9, queryEditor: l11, variableEditor: c15 } = j6({
    nonNull: true,
    caller: Xe5
  }), i9 = (0, import_react96.useRef)(null), h11 = (0, import_react96.useRef)(null), [f14, p7] = (0, import_react96.useState)(false);
  (0, import_react96.useEffect)(() => {
    var b8;
    f14 && ((b8 = i9.current) == null || b8.focus());
  }, [f14]);
  const m12 = e5.item.label || e5.item.operationName || Zr(e5.item.query), y8 = (0, import_react96.useCallback)(() => {
    var b8;
    p7(false), t17({ ...e5.item, label: (b8 = i9.current) == null ? void 0 : b8.value });
  }, [t17, e5.item]), u10 = (0, import_react96.useCallback)(() => {
    p7(false);
  }, []), g6 = (0, import_react96.useCallback)(
    (b8) => {
      b8.stopPropagation(), p7(true);
    },
    []
  ), C5 = (0, import_react96.useCallback)(() => {
    const { query: b8, variables: N7, headers: L3 } = e5.item;
    l11 == null || l11.setValue(b8 ?? ""), c15 == null || c15.setValue(N7 ?? ""), r9 == null || r9.setValue(L3 ?? "");
  }, [e5.item, l11, c15, r9]), d13 = (0, import_react96.useCallback)(
    (b8) => {
      b8.stopPropagation(), n7(e5.item);
    },
    [e5.item, n7]
  );
  return (0, import_jsx_runtime.jsx)("li", { className: clsx("graphiql-history-item", f14 && "editable"), children: f14 ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(
      ...
      {
        type: "text",
        defaultValue: e5.item.label,
        ref: i9,
        onKeyDown: (b8) => {
          b8.key === "Esc" ? p7(false) : b8.key === "Enter" && (p7(false), t17({ ...e5.item, label: b8.currentTarget.value }));
        },
        placeholder: "Type a label"
      }
    ),
    (0, import_jsx_runtime.jsx)(X5, { type: "button", ref: h11, onClick: y8, children: "Save" }),
    (0, import_jsx_runtime.jsx)(X5, { type: "button", ref: h11, onClick: u10, children: (0, import_jsx_runtime.jsx)(st, {}) })
    ...
    (0, import_jsx_runtime.jsx)(ae4, { label: "Edit label", children: (0, import_jsx_runtime.jsx)(
      X5,
      {
        type: "button",
    ...
    (0, import_jsx_runtime.jsx)(
      ae4,
      {
        label: e5.item.favorite ? "Remove favorite" : "Add favorite",
        children: (0, import_jsx_runtime.jsx)(
          X5,
          {
            ...
            className: "graphiql-history-item-action",
            onClick: d13,
            "aria-label": e5.item.favorite ? "Remove favorite" : "Add favorite",
            children: e5.item.favorite ? (0, import_jsx_runtime.jsx)(Hr, { "aria-hidden": "true" }) : (0, import_jsx_runtime.jsx)(Ar, { "aria-hidden": "true" })
          }
        )
      }
    )
...
s17(Xe5, "HistoryItem");
function Zr(e5) {
  return e5 == null ? void 0 : e5.split(`
`).map((t17) => t17.replace(/#(.*)/, "")).join(" ").replaceAll("{", " { ").replaceAll("}", " } ").replaceAll(/[\s]{2,}/g, " ");
}
s17(Zr, "formatQuery");
var Bt = ce4("ExecutionContext");
function et3({
  fetcher: e5,
  getDefaultFieldNames: t17,
  children: n7,
  operationName: r9
}) {
  if (!e5)
  ...
  const {
  ...
  } = j6({ nonNull: true, caller: et3 }), m12 = Be3(), y8 = ot2({
    getDefaultFieldNames: t17,
    caller: et3
  }), [u10, g6] = (0, import_react96.useState)(false), [C5, d13] = (0, import_react96.useState)(null), b8 = (0, import_react96.useRef)(0), N7 = (0, import_react96.useCallback)(() => {
    C5 == null || C5.unsubscribe(), g6(false), d13(null);
  }, [C5]), L3 = (0, import_react96.useCallback)(async () => {
    if (!i9 || !h11)
      return;
    if (C5) {
      N7();
    ...
    const V4 = s17((k2) => {
      h11.setValue(k2), p7({ response: k2 });
    }, "setResponse");
    b8.current += 1;
    const B3 = b8.current;
    let _7 = y8() || i9.getValue();
    const D6 = f14 == null ? void 0 : f14.getValue();
    let O4;
    try {
      O4 = gt({
        json: D6,
      ...
      V4(k2 instanceof Error ? k2.message : `${k2}`);
      return;
    }
    const W2 = c15 == null ? void 0 : c15.getValue();
    let F8;
    try {
      F8 = gt({
        json: W2,
    ...
    if (l11) {
      const k2 = i9.documentAST ? getFragmentDependenciesForAST(
        i9.documentAST,
        l11
      ) : [];
      k2.length > 0 && (_7 += `
` + k2.map((H7) => print(H7)).join(`
`));
    }
    V4(""), g6(true);
    const A6 = r9 ?? i9.operationName ?? void 0;
    ...
    try {
      ...
      const H7 = s17((v5) => {
        if (B3 !== b8.current)
          return;
        let S10 = Array.isArray(v5) ? v5 : false;
        if (!S10 && typeof v5 == "object" && v5 !== null && "hasNext" in v5 && (S10 = [v5]), S10) {
          const R3 = {
            data: k2.data
          }, U5 = [
            ...(k2 == null ? void 0 : k2.errors) || [],
            ...S10.flatMap((Y5) => Y5.errors).filter(Boolean)
          ];
          U5.length && (R3.errors = U5);
          for (const Y5 of S10) {
          ...
          g6(false), V4(formatResult(k2));
        } else {
          const R3 = formatResult(v5);
          g6(false), V4(R3);
        }
      }, "handleResponse"), E9 = e5(
        {
          query: _7,
          variables: O4,
          operationName: A6
      ...
      if (isObservable(Z8))
        d13(
          Z8.subscribe({
            ...
            error(v5) {
              g6(false), v5 && V4(formatError(v5)), d13(null);
            },
            complete() {
              g6(false), d13(null);
            }
      ...
      else if (isAsyncIterable(Z8)) {
        d13({
          unsubscribe: () => {
            var v5, S10;
            return (S10 = (v5 = Z8[Symbol.asyncIterator]()).return) == null ? void 0 : S10.call(v5);
          }
        });
        for await (const v5 of Z8)
          H7(v5);
        g6(false), d13(null);
      } else
        H7(Z8);
    } catch (k2) {
      g6(false), V4(formatError(k2)), d13(null);
    }
  }, [
    y8,
    l11,
    ...
    p7,
    f14
  ]), x6 = !!C5, w6 = (0, import_react96.useMemo)(
    () => ({
      isFetching: u10,
      isSubscribed: x6,
...
function gt({
  json: e5,
  errorMessageParse: t17,
  errorMessageType: n7
}) {
  let r9;
  try {
    r9 = e5 && e5.trim() !== "" ? JSON.parse(e5) : void 0;
  } catch (c15) {
    throw new Error(
      `${t17}: ${c15 instanceof Error ? c15.message : c15}.`
    );
  }
  const l11 = typeof r9 == "object" && r9 !== null && !Array.isArray(r9);
  if (r9 !== void 0 && !l11)
    throw new Error(n7);
  return r9;
}
...
async function Se5(e5, t17) {
  ...
  return await Promise.all(
    (t17 == null ? void 0 : t17.useCommonAddons) === false ? e5 : [
...
var Gr = s17((e5) => e5 ? print(e5) : "", "printDefault");
function $t({ field: e5 }) {
  if (!("defaultValue" in e5) || e5.defaultValue === void 0)
    return null;
  const t17 = astFromValue(e5.defaultValue, e5.type);
  return t17 ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    " = ",
    (0, import_jsx_runtime.jsx)("span", { className: "graphiql-doc-explorer-default-value", children: Gr(t17) })
  ] }) : null;
}
s17($t, "DefaultValue");
...
function Zt(e5) {
  ...
  const { initialHeaders: t17, headerEditor: n7 } = j6({
    nonNull: true,
    caller: Zt
  }), [r9, l11] = (0, import_react96.useState)(), [c15, i9] = (0, import_react96.useState)(false), [h11, f14] = (0, import_react96.useState)(null), p7 = (0, import_react96.useRef)(0);
  (0, import_react96.useEffect)(() => {
    l11(
      isSchema(e5.schema) || e5.schema === null || e5.schema === void 0 ? e5.schema : void 0
    ), p7.current++;
  }, [e5.schema]);
  const m12 = (0, import_react96.useRef)(t17);
  (0, import_react96.useEffect)(() => {
    n7 && (m12.current = n7.getValue());
  });
  const {
    introspectionQuery: y8,
    introspectionQueryName: u10,
    introspectionQuerySansSubscriptions: g6
  } = Qr({
    inputValueDeprecation: e5.inputValueDeprecation,
    introspectionQueryName: e5.introspectionQueryName,
    schemaDescription: e5.schemaDescription
  }), { fetcher: C5, onSchemaChange: d13, dangerouslyAssumeSchemaIsValid: b8, children: N7 } = e5, L3 = (0, import_react96.useCallback)(() => {
    if (isSchema(e5.schema) || e5.schema === null)
      return;
    const V4 = ++p7.current, B3 = e5.schema;
    async function _7() {
      if (B3)
        return B3;
      const D6 = jr(m12.current);
      if (!D6.isValidJSON) {
        f14("Introspection failed as headers are invalid.");
        return;
      }
      const O4 = D6.headers ? { headers: D6.headers } : {}, W2 = fetcherReturnToPromise(
        C5(
          {
            query: y8,
            operationName: u10
      ...
      if (i9(false), F8 != null && F8.data && "__schema" in F8.data)
        return F8.data;
      const A6 = typeof F8 == "string" ? F8 : formatResult(F8);
      f14(A6);
    }
    s17(_7, "fetchIntrospectionData"), _7().then((D6) => {
      if (!(V4 !== p7.current || !D6))
        try {
          const O4 = buildClientSchema(D6);
          l11(O4), d13 == null || d13(O4);
        } catch (O4) {
          f14(formatError(O4));
        }
    }).catch((D6) => {
      V4 === p7.current && (f14(formatError(D6)), i9(false));
    });
  }, [
    C5,
    u10,
  ...
  (0, import_react96.useEffect)(() => {
    L3();
  }, [L3]), (0, import_react96.useEffect)(() => {
    function V4(B3) {
      B3.ctrlKey && B3.key === "R" && L3();
    }
    return s17(V4, "triggerIntrospection"), window.addEventListener("keydown", V4), () => window.removeEventListener("keydown", V4);
  });
  const x6 = (0, import_react96.useMemo)(() => !r9 || b8 ? [] : validateSchema(r9), [r9, b8]), w6 = (0, import_react96.useMemo)(
    () => ({
      fetchError: h11,
      introspect: L3,
      isFetching: c15,
...
var re5 = ue5(_t2);
function Qr({
  inputValueDeprecation: e5,
  introspectionQueryName: t17,
  schemaDescription: n7
}) {
  return (0, import_react96.useMemo)(() => {
    const r9 = t17 || "IntrospectionQuery";
    let l11 = getIntrospectionQuery({
      inputValueDeprecation: e5,
      schemaDescription: n7
    });
    t17 && (l11 = l11.replace("query IntrospectionQuery", `query ${r9}`));
    const c15 = l11.replace(
    ...
    return {
      ...
      introspectionQuerySansSubscriptions: c15
    };
  }, [e5, t17, n7]);
}
s17(Qr, "useIntrospectionQuery");
function jr(e5) {
  let t17 = null, n7 = true;
  try {
    e5 && (t17 = JSON.parse(e5));
  } catch {
    n7 = false;
  }
  return { headers: t17, isValidJSON: n7 };
}
s17(jr, "parseHeaderString");
var Te3 = { name: "Docs" };
var Gt = ce4("ExplorerContext");
function Qt(e5) {
  const { schema: t17, validationErrors: n7 } = re5({
    nonNull: true,
    caller: Qt
  }), [r9, l11] = (0, import_react96.useState)([
    Te3
  ]), c15 = (0, import_react96.useCallback)((p7) => {
    l11((m12) => m12.at(-1).def === p7.def ? (
  ...
  (0, import_react96.useEffect)(() => {
    t17 == null || n7.length > 0 ? h11() : l11((p7) => {
      if (p7.length === 1)
        return p7;
      const m12 = [Te3];
      let y8 = null;
        ...
        if (u10 !== Te3)
          if (u10.def)
            if (isNamedType(u10.def)) {
              const g6 = t17.getType(u10.def.name);
              if (g6)
                m12.push({
                  name: u10.name,
                  def: g6
              ...
              if (y8 === null)
                break;
              if (isObjectType(y8) || isInputObjectType(y8)) {
                const g6 = y8.getFields()[u10.name];
                if (g6)
                  m12.push({
                    name: u10.name,
                    def: g6
                ...
                if (isScalarType(y8) || isEnumType(y8) || isInterfaceType(y8) || isUnionType(y8))
                  break;
                {
                  const g6 = y8;
                  if (g6.args.find((d13) => d13.name === u10.name))
                    m12.push({
                      name: u10.name,
                      def: g6
                    });
            ...
            y8 = null, m12.push(u10);
      return m12;
    });
  }, [h11, t17, n7]);
  const f14 = (0, import_react96.useMemo)(
    () => ({ explorerNavStack: r9, push: c15, pop: i9, reset: h11 }),
    [r9, c15, i9, h11]
  );
  return (0, import_jsx_runtime.jsx)(Gt.Provider, { value: f14, children: e5.children });
}
s17(Qt, "ExplorerContextProvider");
var ie4 = ue5(Gt);
function Pe6(e5, t17) {
  return isNonNullType(e5) ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    Pe6(e5.ofType, t17),
    "!"
  ] }) : isListType(e5) ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    "[",
    Pe6(e5.ofType, t17),
    "]"
  ] }) : t17(e5);
...
s17(Pe6, "renderType");
function ee6(e5) {
  const { push: t17 } = ie4({ nonNull: true, caller: ee6 });
  return e5.type ? Pe6(e5.type, (n7) => (0, import_jsx_runtime.jsx)(
    "a",
    {
      className: "graphiql-doc-explorer-type-name",
      onClick: (r9) => {
        r9.preventDefault(), t17({ name: n7.name, def: n7 });
      },
      href: "#",
      children: n7.name
    }
...
s17(ee6, "TypeLink");
function qe5({ arg: e5, showDefaultValue: t17, inline: n7 }) {
  const r9 = (0, import_jsx_runtime.jsxs)("span", { children: [
    (0, import_jsx_runtime.jsx)("span", { className: "graphiql-doc-explorer-argument-name", children: e5.name }),
    ": ",
    (0, import_jsx_runtime.jsx)(ee6, { type: e5.type }),
    t17 !== false && (0, import_jsx_runtime.jsx)($t, { field: e5 })
  ] });
  return n7 ? r9 : (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-argument", children: [
    r9,
    e5.description ? (0, import_jsx_runtime.jsx)(ne5, { type: "description", children: e5.description }) : null,
    e5.deprecationReason ? (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-argument-deprecation", children: [
      (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-argument-deprecation-label", children: "Deprecated" }),
      (0, import_jsx_runtime.jsx)(ne5, { type: "deprecation", children: e5.deprecationReason })
    ] }) : null
  ] });
}
s17(qe5, "Argument");
function jt(e5) {
  return e5.children ? (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-deprecation", children: [
    (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-deprecation-label", children: "Deprecated" }),
    (0, import_jsx_runtime.jsx)(ne5, { type: "deprecation", onlyShowFirstChild: true, children: e5.children })
  ] }) : null;
}
s17(jt, "DeprecationReason");
function zr({ directive: e5 }) {
...
function K4(e5) {
  ...
  return (0, import_jsx_runtime.jsxs)("div", { children: [
    (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-section-title", children: [
      (0, import_jsx_runtime.jsx)(t17, {}),
      e5.title
    ] }),
    (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-section-content", children: e5.children })
  ] });
}
...
function Kr(e5) {
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    e5.field.description ? (0, import_jsx_runtime.jsx)(ne5, { type: "description", children: e5.field.description }) : null,
    (0, import_jsx_runtime.jsx)(jt, { children: e5.field.deprecationReason }),
    (0, import_jsx_runtime.jsx)(K4, { title: "Type", children: (0, import_jsx_runtime.jsx)(ee6, { type: e5.field.type }) }),
    (0, import_jsx_runtime.jsx)(Jr, { field: e5.field }),
    (0, import_jsx_runtime.jsx)(Yr, { field: e5.field })
  ] });
}
s17(Kr, "FieldDocumentation");
function Jr({ field: e5 }) {
  const [t17, n7] = (0, import_react96.useState)(false), r9 = (0, import_react96.useCallback)(() => {
    n7(true);
  }, []);
  if (!("args" in e5))
    return null;
  const l11 = [], c15 = [];
  for (const i9 of e5.args)
    i9.deprecationReason ? c15.push(i9) : l11.push(i9);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    l11.length > 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Arguments", children: l11.map((i9) => (0, import_jsx_runtime.jsx)(qe5, { arg: i9 }, i9.name)) }) : null,
    c15.length > 0 ? t17 || l11.length === 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Deprecated Arguments", children: c15.map((i9) => (0, import_jsx_runtime.jsx)(qe5, { arg: i9 }, i9.name)) }) : (0, import_jsx_runtime.jsx)(Fe4, { type: "button", onClick: r9, children: "Show Deprecated Arguments" }) : null
  ] });
}
s17(Jr, "Arguments");
function Yr({ field: e5 }) {
  var n7;
  const t17 = ((n7 = e5.astNode) == null ? void 0 : n7.directives) || [];
  return !t17 || t17.length === 0 ? null : (0, import_jsx_runtime.jsx)(K4, { title: "Directives", children: t17.map((r9) => (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(zr, { directive: r9 }) }, r9.name.value)) });
}
s17(Yr, "Directives");
function Xr(e5) {
  var i9, h11, f14, p7;
  const t17 = e5.schema.getQueryType(), n7 = (h11 = (i9 = e5.schema).getMutationType) == null ? void 0 : h11.call(i9), r9 = (p7 = (f14 = e5.schema).getSubscriptionType) == null ? void 0 : p7.call(f14), l11 = e5.schema.getTypeMap(), c15 = [
    t17 == null ? void 0 : t17.name,
    n7 == null ? void 0 : n7.name,
    r9 == null ? void 0 : r9.name
  ];
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(ne5, { type: "description", children: e5.schema.description || "A GraphQL schema provides a root type for each kind of operation." }),
    (0, import_jsx_runtime.jsxs)(K4, { title: "Root Types", children: [
      t17 ? (0, import_jsx_runtime.jsxs)("div", { children: [
        (0, import_jsx_runtime.jsx)("span", { className: "graphiql-doc-explorer-root-type", children: "query" }),
        ": ",
        (0, import_jsx_runtime.jsx)(ee6, { type: t17 })
      ] }) : null,
      ...
      r9 && (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        ": ",
        (0, import_jsx_runtime.jsx)(ee6, { type: r9 })
      ] })
    ] }),
    (0, import_jsx_runtime.jsx)(K4, { title: "All Schema Types", children: l11 && (0, import_jsx_runtime.jsx)("div", { children: Object.values(l11).map((m12) => c15.includes(m12.name) || m12.name.startsWith("__") ? null : (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(ee6, { type: m12 }) }, m12.name)) }) })
  ] });
}
...
s17(pe3, "debounce");
function zt() {
  const { explorerNavStack: e5, push: t17 } = ie4({
    nonNull: true,
    caller: zt
  }), n7 = (0, import_react96.useRef)(null), r9 = tt4(), [l11, c15] = (0, import_react96.useState)(""), [i9, h11] = (0, import_react96.useState)(r9(l11)), f14 = (0, import_react96.useMemo)(
    () => pe3(200, (d13) => {
      h11(r9(d13));
    }),
    [r9]
  ...
  (0, import_react96.useEffect)(() => {
    f14(l11);
  }, [f14, l11]), (0, import_react96.useEffect)(() => {
    function d13(b8) {
      var N7;
      b8.metaKey && b8.key === "k" && ((N7 = n7.current) == null || N7.focus());
    }
    return s17(d13, "handleKeyDown"), window.addEventListener("keydown", d13), () => window.removeEventListener("keydown", d13);
  }, []);
  const p7 = e5.at(-1), m12 = (0, import_react96.useCallback)(
    (d13) => {
      t17(
        "field" in d13 ? { name: d13.field.name, def: d13.field } : { name: d13.type.name, def: d13.type }
      );
    },
    [t17]
  ), [y8, u10] = (0, import_react96.useState)(false), g6 = (0, import_react96.useCallback)((d13) => {
    u10(d13.type === "focus");
  }, []);
  return e5.length === 1 || isObjectType(p7.def) || isInterfaceType(p7.def) || isInputObjectType(p7.def) ? (0, import_jsx_runtime.jsxs)(
    qo,
    {
      as: "div",
      className: "graphiql-doc-explorer-search",
      onChange: m12,
      "data-state": y8 ? void 0 : "idle",
      ...
      children: [
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(
                qo.Input,
                {
                  ...
                  onFocus: g6,
                  onBlur: g6,
                  onChange: (d13) => c15(d13.target.value),
                  placeholder: "⌘ K",
                  ref: n7,
                  value: l11,
        ...
        y8 && (0, import_jsx_runtime.jsxs)(qo.Options, { "data-cy": "doc-explorer-list", children: [
          i9.within.length + i9.types.length + i9.fields.length === 0 ? (0, import_jsx_runtime.jsx)("li", { className: "graphiql-doc-explorer-search-empty", children: "No results found" }) : i9.within.map((d13, b8) => (0, import_jsx_runtime.jsx)(
            qo.Option,
            {
              value: d13,
              "data-cy": "doc-explorer-option",
              children: (0, import_jsx_runtime.jsx)(Ct, { field: d13.field, argument: d13.argument })
            },
            `within-${b8}`
          )),
          ...
          i9.types.map((d13, b8) => (0, import_jsx_runtime.jsx)(
            qo.Option,
            {
              value: d13,
              "data-cy": "doc-explorer-option",
              children: (0, import_jsx_runtime.jsx)(nt2, { type: d13.type })
            },
            `type-${b8}`
          )),
          i9.fields.map((d13, b8) => (0, import_jsx_runtime.jsxs)(
            qo.Option,
            {
              value: d13,
              "data-cy": "doc-explorer-option",
              children: [
                (0, import_jsx_runtime.jsx)(nt2, { type: d13.type }),
                ".",
                (0, import_jsx_runtime.jsx)(Ct, { field: d13.field, argument: d13.argument })
              ]
            },
            `field-${b8}`
          ))
...
s17(zt, "Search");
function tt4(e5) {
  const { explorerNavStack: t17 } = ie4({
    nonNull: true,
    caller: e5 || tt4
  }), { schema: n7 } = re5({
    nonNull: true,
  ...
  return (0, import_react96.useCallback)(
    (l11) => {
      ...
      if (!n7)
        return c15;
      const i9 = r9.def, h11 = n7.getTypeMap();
      let f14 = Object.keys(h11);
      i9 && (f14 = f14.filter((p7) => p7 !== i9.name), f14.unshift(i9.name));
      for (const p7 of f14) {
        if (c15.within.length + c15.types.length + c15.fields.length >= 100)
          break;
        const m12 = h11[p7];
        if (i9 !== m12 && je5(p7, l11) && c15.types.push({ type: m12 }), !isObjectType(m12) && !isInterfaceType(m12) && !isInputObjectType(m12))
          continue;
        const y8 = m12.getFields();
        for (const u10 in y8) {
          const g6 = y8[u10];
          let C5;
          if (!je5(u10, l11))
            if ("args" in g6) {
              if (C5 = g6.args.filter(
                (d13) => je5(d13.name, l11)
              ), C5.length === 0)
                continue;
            } else
              continue;
          c15[i9 === m12 ? "within" : "fields"].push(
            ...C5 ? C5.map((d13) => ({ type: m12, field: g6, argument: d13 })) : [{ type: m12, field: g6 }]
          );
        }
      }
      return c15;
...
s17(tt4, "useSearchResults");
function je5(e5, t17) {
  try {
    const n7 = t17.replaceAll(/[^_0-9A-Za-z]/g, (r9) => "\\" + r9);
    return e5.search(new RegExp(n7, "i")) !== -1;
  } catch {
    return e5.toLowerCase().includes(t17.toLowerCase());
  }
}
s17(je5, "isMatch");
function nt2(e5) {
  return (0, import_jsx_runtime.jsx)("span", { className: "graphiql-doc-explorer-search-type", children: e5.type.name });
}
s17(nt2, "Type");
function Ct({ field: e5, argument: t17 }) {
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)("span", { className: "graphiql-doc-explorer-search-field", children: e5.name }),
    t17 ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      "(",
      (0, import_jsx_runtime.jsx)("span", { className: "graphiql-doc-explorer-search-argument", children: t17.name }),
      ":",
      " ",
      Pe6(t17.type, (n7) => (0, import_jsx_runtime.jsx)(nt2, { type: n7 })),
      ")"
    ] }) : null
  ] });
}
s17(Ct, "Field$1");
function eo2(e5) {
  const { push: t17 } = ie4({ nonNull: true });
  return (0, import_jsx_runtime.jsx)(
    "a",
    {
      className: "graphiql-doc-explorer-field-name",
      onClick: (n7) => {
        n7.preventDefault(), t17({ name: e5.field.name, def: e5.field });
      },
      href: "#",
      children: e5.field.name
    }
  );
}
s17(eo2, "FieldLink");
function to2(e5) {
  return isNamedType(e5.type) ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    e5.type.description ? (0, import_jsx_runtime.jsx)(ne5, { type: "description", children: e5.type.description }) : null,
    (0, import_jsx_runtime.jsx)(no2, { type: e5.type }),
    (0, import_jsx_runtime.jsx)(ro2, { type: e5.type }),
    (0, import_jsx_runtime.jsx)(oo2, { type: e5.type }),
    (0, import_jsx_runtime.jsx)(lo2, { type: e5.type })
  ] }) : null;
}
s17(to2, "TypeDocumentation");
function no2({ type: e5 }) {
  return isObjectType(e5) && e5.getInterfaces().length > 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Implements", children: e5.getInterfaces().map((n7) => (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(ee6, { type: n7 }) }, n7.name)) }) : null;
}
s17(no2, "ImplementsInterfaces");
function ro2({ type: e5 }) {
  const [t17, n7] = (0, import_react96.useState)(false), r9 = (0, import_react96.useCallback)(() => {
    n7(true);
  }, []);
  if (!isObjectType(e5) && !isInterfaceType(e5) && !isInputObjectType(e5))
    return null;
  const l11 = e5.getFields(), c15 = [], i9 = [];
  for (const h11 of Object.keys(l11).map((f14) => l11[f14]))
    h11.deprecationReason ? i9.push(h11) : c15.push(h11);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    c15.length > 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Fields", children: c15.map((h11) => (0, import_jsx_runtime.jsx)(yt2, { field: h11 }, h11.name)) }) : null,
    i9.length > 0 ? t17 || c15.length === 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Deprecated Fields", children: i9.map((h11) => (0, import_jsx_runtime.jsx)(yt2, { field: h11 }, h11.name)) }) : (0, import_jsx_runtime.jsx)(Fe4, { type: "button", onClick: r9, children: "Show Deprecated Fields" }) : null
  ] });
}
s17(ro2, "Fields");
function yt2({ field: e5 }) {
  const t17 = "args" in e5 ? e5.args.filter((n7) => !n7.deprecationReason) : [];
  return (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-item", children: [
    (0, import_jsx_runtime.jsxs)("div", { children: [
      (0, import_jsx_runtime.jsx)(eo2, { field: e5 }),
      t17.length > 0 ? (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        "(",
        (0, import_jsx_runtime.jsx)("span", { children: t17.map(
          (n7) => t17.length === 1 ? (0, import_jsx_runtime.jsx)(qe5, { arg: n7, inline: true }, n7.name) : (0, import_jsx_runtime.jsx)(
            "div",
            {
      ...
      ": ",
      (0, import_jsx_runtime.jsx)(ee6, { type: e5.type }),
      (0, import_jsx_runtime.jsx)($t, { field: e5 })
    ] }),
    e5.description ? (0, import_jsx_runtime.jsx)(ne5, { type: "description", onlyShowFirstChild: true, children: e5.description }) : null,
    (0, import_jsx_runtime.jsx)(jt, { children: e5.deprecationReason })
  ] });
}
s17(yt2, "Field");
function oo2({ type: e5 }) {
  const [t17, n7] = (0, import_react96.useState)(false), r9 = (0, import_react96.useCallback)(() => {
    n7(true);
  }, []);
  if (!isEnumType(e5))
    return null;
  const l11 = [], c15 = [];
  for (const i9 of e5.getValues())
    i9.deprecationReason ? c15.push(i9) : l11.push(i9);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    l11.length > 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Enum Values", children: l11.map((i9) => (0, import_jsx_runtime.jsx)(vt, { value: i9 }, i9.name)) }) : null,
    c15.length > 0 ? t17 || l11.length === 0 ? (0, import_jsx_runtime.jsx)(K4, { title: "Deprecated Enum Values", children: c15.map((i9) => (0, import_jsx_runtime.jsx)(vt, { value: i9 }, i9.name)) }) : (0, import_jsx_runtime.jsx)(Fe4, { type: "button", onClick: r9, children: "Show Deprecated Values" }) : null
  ] });
}
s17(oo2, "EnumValues");
function vt({ value: e5 }) {
  return (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-item", children: [
    (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-enum-value", children: e5.name }),
    e5.description ? (0, import_jsx_runtime.jsx)(ne5, { type: "description", children: e5.description }) : null,
    e5.deprecationReason ? (0, import_jsx_runtime.jsx)(ne5, { type: "deprecation", children: e5.deprecationReason }) : null
  ] });
}
s17(vt, "EnumValue");
function lo2({ type: e5 }) {
  const { schema: t17 } = re5({ nonNull: true });
  return !t17 || !isAbstractType(e5) ? null : (0, import_jsx_runtime.jsx)(
    K4,
    {
      title: isInterfaceType(e5) ? "Implementations" : "Possible Types",
      children: t17.getPossibleTypes(e5).map((n7) => (0, import_jsx_runtime.jsx)("div", { children: (0, import_jsx_runtime.jsx)(ee6, { type: n7 }) }, n7.name))
    }
  );
}
s17(lo2, "PossibleTypes");
function rt3() {
  const { fetchError: e5, isFetching: t17, schema: n7, validationErrors: r9 } = re5(
    { nonNull: true, caller: rt3 }
  ), { explorerNavStack: l11, pop: c15 } = ie4({
    nonNull: true,
    caller: rt3
  }), i9 = l11.at(-1);
  let h11 = null;
  e5 ? h11 = (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-error", children: "Error fetching schema" }) : r9.length > 0 ? h11 = (0, import_jsx_runtime.jsxs)("div", { className: "graphiql-doc-explorer-error", children: [
    "Schema is invalid: ",
    r9[0].message
  ] }) : t17 ? h11 = (0, import_jsx_runtime.jsx)(qt, {}) : n7 ? l11.length === 1 ? h11 = (0, import_jsx_runtime.jsx)(Xr, { schema: n7 }) : isType(i9.def) ? h11 = (0, import_jsx_runtime.jsx)(to2, { type: i9.def }) : i9.def && (h11 = (0, import_jsx_runtime.jsx)(Kr, { field: i9.def })) : h11 = (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-error", children: "No GraphQL schema available" });
  let f14;
  return l11.length > 1 && (f14 = l11.at(-2).name), (0, import_jsx_runtime.jsxs)(
    "section",
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime.jsx)("div", { className: "graphiql-doc-explorer-content", children: h11 })
      ]
    }
  );
}
...
var ve3 = {
  ...
  icon: s17(function() {
    const t17 = at();
    return (t17 == null ? void 0 : t17.visiblePlugin) === ve3 ? (0, import_jsx_runtime.jsx)(xr, {}) : (0, import_jsx_runtime.jsx)(Er, {});
  }, "Icon"),
  content: rt3
};
var bt = {
...
function io2(e5) {
  const t17 = de4(), n7 = ie4(), r9 = Be3(), l11 = !!n7, c15 = !!r9, i9 = (0, import_react96.useMemo)(() => {
    const g6 = [], C5 = {};
    l11 && (g6.push(ve3), C5[ve3.title] = true), c15 && (g6.push(bt), C5[bt.title] = true);
    for (const d13 of e5.plugins || []) {
      if (typeof d13.title != "string" || !d13.title)
        throw new Error("All GraphiQL plugins must have a unique title");
      if (C5[d13.title])
        throw new Error(
          `All GraphiQL plugins must have a unique title, found two plugins with the title '${d13.title}'`
        );
      g6.push(d13), C5[d13.title] = true;
    }
    return g6;
  }, [l11, c15, e5.plugins]), [h11, f14] = (0, import_react96.useState)(() => {
    const g6 = t17 == null ? void 0 : t17.get(wt), C5 = i9.find(
      (d13) => d13.title === g6
    );
    return C5 || (g6 && (t17 == null || t17.set(wt, "")), e5.visiblePlugin && i9.find(
      (d13) => (typeof e5.visiblePlugin == "string" ? d13.title : d13) === e5.visiblePlugin
    ) || null);
  }), { onTogglePluginVisibility: p7, children: m12 } = e5, y8 = (0, import_react96.useCallback)(
    (g6) => {
      const C5 = g6 && i9.find(
        (d13) => (typeof g6 == "string" ? d13.title : d13) === g6
      ) || null;
      f14((d13) => C5 === d13 ? d13 : (p7 == null || p7(C5), C5));
    },
    [p7, i9]
  );
  (0, import_react96.useEffect)(() => {
    e5.visiblePlugin && y8(e5.visiblePlugin);
  }, [i9, e5.visiblePlugin, y8]);
  const u10 = (0, import_react96.useMemo)(
    () => ({ plugins: i9, setVisiblePlugin: y8, visiblePlugin: h11 }),
    [i9, y8, h11]
  );
...
function so(e5, t17, n7, r9, l11, c15) {
  Se5([], { useCommonAddons: false }).then((h11) => {
    let f14, p7, m12, y8, u10, g6, C5, d13, b8;
    h11.on(
      t17,
      "select",
      // @ts-expect-error
      (N7, L3) => {
        if (!f14) {
          const x6 = L3.parentNode;
          f14 = document.createElement("div"), f14.className = "CodeMirror-hint-information", x6.append(f14);
          const w6 = document.createElement("header");
          w6.className = "CodeMirror-hint-information-header", f14.append(w6), p7 = document.createElement("span"), p7.className = "CodeMirror-hint-information-field-name", w6.append(p7), m12 = document.createElement("span"), m12.className = "CodeMirror-hint-information-type-name-pill", w6.append(m12), y8 = document.createElement("span"), m12.append(y8), u10 = document.createElement("a"), u10.className = "CodeMirror-hint-information-type-name", u10.href = "javascript:void 0", u10.addEventListener("click", i9), m12.append(u10), g6 = document.createElement("span"), m12.append(g6), C5 = document.createElement("div"), C5.className = "CodeMirror-hint-information-description", f14.append(C5), d13 = document.createElement("div"), d13.className = "CodeMirror-hint-information-deprecation", f14.append(d13);
          const V4 = document.createElement("span");
          V4.className = "CodeMirror-hint-information-deprecation-label", V4.textContent = "Deprecated", d13.append(V4), b8 = document.createElement("div"), b8.className = "CodeMirror-hint-information-deprecation-reason", d13.append(b8);
          const B3 = parseInt(
            ...
            f14 && (f14.style.paddingTop = x6.scrollTop + B3 + "px", f14.style.maxHeight = x6.scrollTop + _7 + "px");
          }, "handleScroll");
          x6.addEventListener("scroll", D6);
          let O4;
          x6.addEventListener(
            "DOMNodeRemoved",
            O4 = s17((W2) => {
              W2.target === x6 && (x6.removeEventListener("scroll", D6), x6.removeEventListener("DOMNodeRemoved", O4), f14 && f14.removeEventListener(
                "click",
                i9
              ), f14 = null, p7 = null, m12 = null, y8 = null, u10 = null, g6 = null, C5 = null, d13 = null, b8 = null, O4 = null);
            }, "onRemoveFn")
          );
        }
        if (p7 && (p7.textContent = N7.text), m12 && y8 && u10 && g6)
          if (N7.type) {
            m12.style.display = "inline";
            const x6 = s17((w6) => {
              isNonNullType(w6) ? (g6.textContent = "!" + g6.textContent, x6(w6.ofType)) : isListType(w6) ? (y8.textContent += "[", g6.textContent = "]" + g6.textContent, x6(w6.ofType)) : u10.textContent = w6.name;
            }, "renderType");
            y8.textContent = "", g6.textContent = "", x6(N7.type);
          } else
            y8.textContent = "", u10.textContent = "", g6.textContent = "", m12.style.display = "none";
        C5 && (N7.description ? (C5.style.display = "block", C5.innerHTML = Ae3.render(N7.description)) : (C5.style.display = "none", C5.innerHTML = "")), d13 && b8 && (N7.deprecationReason ? (d13.style.display = "block", b8.innerHTML = Ae3.render(
          N7.deprecationReason
        )) : (d13.style.display = "none", b8.innerHTML = ""));
      }
    );
  });
  function i9(h11) {
    if (!n7 || !r9 || !l11 || !(h11.currentTarget instanceof HTMLElement))
      return;
    const f14 = h11.currentTarget.textContent || "", p7 = n7.getType(f14);
    p7 && (l11.setVisiblePlugin(ve3), r9.push({ name: p7.name, def: p7 }), c15 == null || c15(p7));
  }
...
function Me4(e5, t17) {
  (0, import_react96.useEffect)(() => {
    e5 && typeof t17 == "string" && t17 !== e5.getValue() && e5.setValue(t17);
  }, [e5, t17]);
}
s17(Me4, "useSynchronizeValue");
function Ge6(e5, t17, n7) {
  (0, import_react96.useEffect)(() => {
    e5 && e5.setOption(t17, n7);
  }, [e5, t17, n7]);
}
s17(Ge6, "useSynchronizeOption");
function Kt(e5, t17, n7, r9, l11) {
  const { updateActiveTabValues: c15 } = j6({ nonNull: true, caller: l11 }), i9 = de4();
  (0, import_react96.useEffect)(() => {
    if (!e5)
      return;
    const h11 = pe3(500, (m12) => {
      !i9 || n7 === null || i9.set(n7, m12);
    }), f14 = pe3(100, (m12) => {
      c15({ [r9]: m12 });
    }), p7 = s17((m12, y8) => {
      if (!y8)
      ...
      h11(u10), f14(u10), t17 == null || t17(u10);
    }, "handleChange");
    return e5.on("change", p7), () => e5.off("change", p7);
  }, [
    t17,
    e5,
    i9,
...
function Jt(e5, t17, n7) {
  const { schema: r9 } = re5({ nonNull: true, caller: n7 }), l11 = ie4(), c15 = at();
  (0, import_react96.useEffect)(() => {
    if (!e5)
      return;
    const i9 = s17((h11, f14) => {
      so(h11, f14, r9, l11, c15, (p7) => {
        t17 == null || t17({ kind: "Type", type: p7, schema: r9 || void 0 });
      });
    }, "handleCompletion");
    return e5.on(
...
s17(te4, "useKeyMap");
function Yt({ caller: e5, onCopyQuery: t17 } = {}) {
  ...
  return (0, import_react96.useCallback)(() => {
    ...
    (0, import_copy_to_clipboard.default)(r9), t17 == null || t17(r9);
  }, [n7, t17]);
}
s17(Yt, "useCopyQuery");
function be5({ caller: e5 } = {}) {
  const { queryEditor: t17 } = j6({
    nonNull: true,
    caller: e5 || be5
  }), { schema: n7 } = re5({ nonNull: true, caller: be5 });
  return (0, import_react96.useCallback)(() => {
    const r9 = t17 == null ? void 0 : t17.documentAST, l11 = t17 == null ? void 0 : t17.getValue();
    !r9 || !l11 || t17.setValue(print(mergeAst(r9, n7)));
  }, [t17, n7]);
}
s17(be5, "useMergeQuery");
function Qe5({ caller: e5 } = {}) {
  const { queryEditor: t17, headerEditor: n7, variableEditor: r9 } = j6({
    nonNull: true,
    caller: e5 || Qe5
  });
  return (0, import_react96.useCallback)(() => {
    if (r9) {
      const l11 = r9.getValue();
      try {
        const c15 = JSON.stringify(
          JSON.parse(l11),
          null,
          2
        );
        c15 !== l11 && r9.setValue(c15);
      } catch {
      }
    }
    if (n7) {
      ...
      try {
        ...
        c15 !== l11 && n7.setValue(c15);
      } catch {
      }
    }
    if (t17) {
      const l11 = t17.getValue(), c15 = print(parse(l11));
      c15 !== l11 && t17.setValue(c15);
    }
  }, [t17, r9, n7]);
}
s17(Qe5, "usePrettifyEditors");
function ot2({
  getDefaultFieldNames: e5,
  caller: t17
} = {}) {
  const { schema: n7 } = re5({
    nonNull: true,
  ...
  return (0, import_react96.useCallback)(() => {
    if (!r9)
      return;
    const l11 = r9.getValue(), { insertions: c15, result: i9 } = fillLeafs(
      n7,
      l11,
      e5
    );
    return c15 && c15.length > 0 && r9.operation(() => {
      const h11 = r9.getCursor(), f14 = r9.indexFromPos(h11);
      r9.setValue(i9 || "");
      let p7 = 0;
      const m12 = c15.map(
        ({ index: u10, string: g6 }) => r9.markText(
          r9.posFromIndex(u10 + p7),
          r9.posFromIndex(u10 + (p7 += g6.length)),
          {
      ...
      let y8 = f14;
      for (const { index: u10, string: g6 } of c15)
        u10 < f14 && (y8 += g6.length);
      r9.setCursor(r9.posFromIndex(y8));
    }), i9;
  }, [e5, r9, n7]);
}
...
function Ce3({
  ...
  const {
    ...
    nonNull: true,
    caller: l11 || Ce3
  }), p7 = We5(), m12 = be5({ caller: l11 || Ce3 }), y8 = Qe5({ caller: l11 || Ce3 }), u10 = (0, import_react96.useRef)(null);
  return (0, import_react96.useEffect)(() => {
    let g6 = true;
    return Se5([
      // @ts-expect-error
      import("./javascript.es-EHSZPHW6.js").then((C5) => C5.j)
    ]).then((C5) => {
      if (!g6)
        return;
      const d13 = u10.current;
      if (!d13)
        return;
      const b8 = C5(d13, {
        value: c15,
      ...
      b8.addKeyMap({
        "Cmd-Space"() {
          b8.showHint({ completeSingle: false, container: d13 });
        },
        "Ctrl-Space"() {
          b8.showHint({ completeSingle: false, container: d13 });
        },
        ...
        const { code: x6, key: w6, shiftKey: V4 } = L3, B3 = x6.startsWith("Key"), _7 = !V4 && x6.startsWith("Digit");
        (B3 || _7 || w6 === "_" || w6 === '"') && N7.execCommand("autocomplete");
      }), h11(b8);
    }), () => {
      g6 = false;
    };
  }, [e5, c15, r9, h11]), Ge6(i9, "keyMap", t17), Kt(
    i9,
    n7,
    f14 ? He6 : null,
    "headers",
    Ce3
  ), te4(i9, ["Cmd-Enter", "Ctrl-Enter"], p7 == null ? void 0 : p7.run), te4(i9, ["Shift-Ctrl-P"], y8), te4(i9, ["Shift-Ctrl-M"], m12), u10;
}
s17(Ce3, "useHeaderEditor");
var He6 = "headers";
var ao2 = Array.from({ length: 11 }, (e5, t17) => String.fromCharCode(8192 + t17)).concat(["\u2028", "\u2029", " ", " "]);
var co = new RegExp("[" + ao2.join("") + "]", "g");
function uo2(e5) {
  return e5.replace(co, " ");
}
s17(uo2, "normalizeWhitespace");
function se5({
  editorTheme: e5 = $e5,
  keyMap: t17 = _e4,
  onClickReference: n7,
  ...
  const { schema: h11 } = re5({
    ...
    validationRules: g6,
    variableEditor: C5,
    updateActiveTabValues: d13
  } = j6({
    nonNull: true,
    caller: i9 || se5
  }), b8 = We5(), N7 = de4(), L3 = ie4(), x6 = at(), w6 = Yt({ caller: i9 || se5, onCopyQuery: r9 }), V4 = be5({ caller: i9 || se5 }), B3 = Qe5({ caller: i9 || se5 }), _7 = (0, import_react96.useRef)(null), D6 = (0, import_react96.useRef)(), O4 = (0, import_react96.useRef)(() => {
  });
  (0, import_react96.useEffect)(() => {
    O4.current = (A6) => {
      if (!(!L3 || !x6)) {
        switch (x6.setVisiblePlugin(ve3), A6.kind) {
          case "Type": {
            L3.push({ name: A6.type.name, def: A6.type });
            break;
          }
          case "Field": {
            L3.push({ name: A6.field.name, def: A6.field });
            break;
          }
          case "Argument": {
            A6.field && L3.push({ name: A6.field.name, def: A6.field });
            break;
          }
          case "EnumValue": {
            A6.type && L3.push({ name: A6.type.name, def: A6.type });
            break;
          }
        }
        n7 == null || n7(A6);
  ...
  }, [L3, n7, x6]), (0, import_react96.useEffect)(() => {
    let A6 = true;
    return Se5([
      import("./comment.es-6G2M2AYB.js").then((k2) => k2.c),
      import("./search.es-IKQJJVAQ.js").then((k2) => k2.s),
      import("./hint.es-KAXELDE7.js"),
      import("./lint.es2-B37BX2YB.js"),
      import("./info.es-UZNTDYRV.js"),
      import("./jump.es-YXD3DYEL.js"),
      import("./mode.es-C75IRUXD.js")
    ]).then((k2) => {
      if (!A6)
        return;
      D6.current = k2;
      ...
      E9.addKeyMap({
        "Cmd-Space"() {
          E9.showHint({ completeSingle: true, container: H7 });
        },
        "Ctrl-Space"() {
          E9.showHint({ completeSingle: true, container: H7 });
        },
        ...
        fo.test(S10.key) && v5.execCommand("autocomplete");
      });
      let Z8 = false;
      E9.on("startCompletion", () => {
        ...
        Z8 = false;
      }), E9.on("keydown", (v5, S10) => {
        S10.key === "Escape" && Z8 && S10.stopPropagation();
      }), E9.on("beforeChange", (v5, S10) => {
        var R3;
        if (S10.origin === "paste") {
          const U5 = S10.text.map(uo2);
          (R3 = S10.update) == null || R3.call(S10, S10.from, S10.to, U5);
        }
      }), E9.documentAST = null, E9.operationName = null, E9.operations = null, E9.variableToType = null, u10(E9);
    }), () => {
      A6 = false;
    };
  }, [e5, p7, c15, u10]), Ge6(m12, "keyMap", t17), (0, import_react96.useEffect)(() => {
    if (!m12)
      return;
    function A6(H7) {
      var v5;
      const E9 = getOperationFacts(
        h11,
        H7.getValue()
      ), Z8 = getSelectedOperationName(
        H7.operations ?? void 0,
        H7.operationName ?? void 0,
        E9 == null ? void 0 : E9.operations
      );
      return H7.documentAST = (E9 == null ? void 0 : E9.documentAST) ?? null, H7.operationName = Z8 ?? null, H7.operations = (E9 == null ? void 0 : E9.operations) ?? null, C5 && (C5.state.lint.linterOptions.variableToType = E9 == null ? void 0 : E9.variableToType, C5.options.lint.variableToType = E9 == null ? void 0 : E9.variableToType, C5.options.hintOptions.variableToType = E9 == null ? void 0 : E9.variableToType, (v5 = D6.current) == null || v5.signal(C5, "change", C5)), E9 ? { ...E9, operationName: Z8 } : null;
    }
    s17(A6, "getAndUpdateOperationFacts");
    const k2 = pe3(
      100,
      (H7) => {
        const E9 = H7.getValue();
        N7 == null || N7.set(Xt, E9);
        const Z8 = H7.operationName, v5 = A6(H7);
        (v5 == null ? void 0 : v5.operationName) !== void 0 && (N7 == null || N7.set(
          go,
          v5.operationName
        )), l11 == null || l11(E9, v5 == null ? void 0 : v5.documentAST), v5 != null && v5.operationName && Z8 !== v5.operationName && y8(v5.operationName), d13({
          query: E9,
          operationName: (v5 == null ? void 0 : v5.operationName) ?? null
        });
      }
    );
    return A6(m12), m12.on("change", k2), () => m12.off("change", k2);
  }, [
    l11,
    m12,
    h11,
  ...
  const W2 = b8 == null ? void 0 : b8.run, F8 = (0, import_react96.useCallback)(() => {
    var H7;
    if (!W2 || !m12 || !m12.operations || !m12.hasFocus()) {
      W2 == null || W2();
      return;
    }
    const A6 = m12.indexFromPos(m12.getCursor());
    let k2;
    for (const E9 of m12.operations)
      E9.loc && E9.loc.start <= A6 && E9.loc.end >= A6 && (k2 = (H7 = E9.name) == null ? void 0 : H7.value);
    k2 && k2 !== m12.operationName && y8(k2), W2();
  }, [m12, W2, y8]);
  return te4(m12, ["Cmd-Enter", "Ctrl-Enter"], F8), te4(m12, ["Shift-Ctrl-C"], w6), te4(
    ...
    B3
  ), te4(m12, ["Shift-Ctrl-M"], V4), _7;
}
s17(se5, "useQueryEditor");
function ho(e5, t17, n7) {
  (0, import_react96.useEffect)(() => {
    if (!e5)
      return;
    const r9 = e5.options.lint.schema !== t17;
    e5.state.lint.linterOptions.schema = t17, e5.options.lint.schema = t17, e5.options.hintOptions.schema = t17, e5.options.info.schema = t17, e5.options.jump.schema = t17, r9 && n7.current && n7.current.signal(e5, "change", e5);
  }, [e5, t17, n7]);
}
s17(ho, "useSynchronizeSchema");
function mo(e5, t17, n7) {
  (0, import_react96.useEffect)(() => {
    if (!e5)
      return;
    const r9 = e5.options.lint.validationRules !== t17;
    e5.state.lint.linterOptions.validationRules = t17, e5.options.lint.validationRules = t17, r9 && n7.current && n7.current.signal(e5, "change", e5);
  }, [e5, t17, n7]);
}
s17(mo, "useSynchronizeValidationRules");
function po(e5, t17, n7) {
  ...
  (0, import_react96.useEffect)(() => {
    if (!e5)
      return;
    const l11 = e5.options.lint.externalFragments !== r9;
    e5.state.lint.linterOptions.externalFragments = r9, e5.options.lint.externalFragments = r9, e5.options.hintOptions.externalFragments = r9, l11 && n7.current && n7.current.signal(e5, "change", e5);
  }, [e5, r9, n7]);
}
...
function Co({
  ...
  const h11 = i9 == null ? void 0 : i9.get(we5);
  try {
    if (!h11)
      throw new Error("Storage for tabs is empty");
    const f14 = JSON.parse(h11);
    if (yo(f14)) {
      const p7 = De5({ query: l11, variables: c15, headers: n7 });
      let m12 = -1;
      for (let y8 = 0; y8 < f14.tabs.length; y8++) {
        const u10 = f14.tabs[y8];
        u10.hash = De5({
          query: u10.query,
      ...
      if (m12 >= 0)
        f14.activeTabIndex = m12;
      else {
        const y8 = l11 ? ct(l11) : null;
        f14.tabs.push({
          id: rn(),
          hash: p7,
          title: y8 || ut,
...
function yo(e5) {
  return e5 && typeof e5 == "object" && !Array.isArray(e5) && bo(e5, "activeTabIndex") && "tabs" in e5 && Array.isArray(e5.tabs) && e5.tabs.every(vo);
}
s17(yo, "isTabsState");
function vo(e5) {
  return e5 && typeof e5 == "object" && !Array.isArray(e5) && xt(e5, "id") && xt(e5, "title") && fe4(e5, "query") && fe4(e5, "variables") && fe4(e5, "headers") && fe4(e5, "operationName") && fe4(e5, "response");
}
s17(vo, "isTabState");
function bo(e5, t17) {
  return t17 in e5 && typeof e5[t17] == "number";
}
s17(bo, "hasNumberKey");
function xt(e5, t17) {
  return t17 in e5 && typeof e5[t17] == "string";
}
s17(xt, "hasStringKey");
function fe4(e5, t17) {
  return t17 in e5 && (typeof e5[t17] == "string" || e5[t17] === null);
}
...
function wo({
  ...
  return (0, import_react96.useCallback)(
    (l11) => {
      const c15 = (e5 == null ? void 0 : e5.getValue()) ?? null, i9 = (t17 == null ? void 0 : t17.getValue()) ?? null, h11 = (n7 == null ? void 0 : n7.getValue()) ?? null, f14 = (e5 == null ? void 0 : e5.operationName) ?? null, p7 = (r9 == null ? void 0 : r9.getValue()) ?? null;
      return nn(l11, {
        query: c15,
        variables: i9,
        headers: h11,
...
function en(e5, t17 = false) {
  return JSON.stringify(
    e5,
    (n7, r9) => n7 === "hash" || n7 === "response" || !t17 && n7 === "headers" ? null : r9
  );
}
s17(en, "serializeTabState");
function xo({
  storage: e5,
  shouldPersistHeaders: t17
}) {
  const n7 = (0, import_react96.useMemo)(
    () => pe3(500, (r9) => {
      e5 == null || e5.set(we5, r9);
    }),
    [e5]
  );
  return (0, import_react96.useCallback)(
...
function Eo({
  ...
  return (0, import_react96.useCallback)(
    ({
      ...
      e5 == null || e5.setValue(l11 ?? ""), t17 == null || t17.setValue(c15 ?? ""), n7 == null || n7.setValue(i9 ?? ""), r9 == null || r9.setValue(h11 ?? "");
    },
    [n7, e5, r9, t17]
  );
}
...
function tn({
  ...
  return {
    id: rn(),
    hash: De5({ query: e5, variables: t17, headers: n7 }),
    title: e5 && ct(e5) || ut,
    query: e5,
    variables: t17,
    headers: n7,
...
function nn(e5, t17) {
  return {
    ...e5,
    tabs: e5.tabs.map((n7, r9) => {
      if (r9 !== e5.activeTabIndex)
        return n7;
      const l11 = { ...n7, ...t17 };
      return {
        ...l11,
...
function rn() {
  const e5 = s17(() => Math.floor((1 + Math.random()) * 65536).toString(16).slice(1), "s4");
  return `${e5()}${e5()}-${e5()}-${e5()}-${e5()}-${e5()}${e5()}${e5()}`;
}
s17(rn, "guid");
function De5(e5) {
  return [e5.query ?? "", e5.variables ?? "", e5.headers ?? ""].join("|");
}
s17(De5, "hashFromTabContents");
function ct(e5) {
  const n7 = /^(?!#).*(query|subscription|mutation)\s+([a-zA-Z0-9_]+)/m.exec(e5);
  return (n7 == null ? void 0 : n7[2]) ?? null;
}
s17(ct, "fuzzyExtractOperationName");
function Lo(e5) {
  const t17 = e5 == null ? void 0 : e5.get(we5);
  if (t17) {
    const n7 = JSON.parse(t17);
    e5 == null || e5.set(
      we5,
      JSON.stringify(
        n7,
        (r9, l11) => r9 === "headers" ? null : l11
      )
    );
  }
}
...
function me4({
  ...
  const { initialVariables: i9, variableEditor: h11, setVariableEditor: f14 } = j6({
    nonNull: true,
    caller: c15 || me4
  }), p7 = We5(), m12 = be5({ caller: c15 || me4 }), y8 = Qe5({ caller: c15 || me4 }), u10 = (0, import_react96.useRef)(null), g6 = (0, import_react96.useRef)();
  return (0, import_react96.useEffect)(() => {
    let C5 = true;
    return Se5([
      import("./hint.es2-7PXVN23E.js"),
      import("./lint.es3-QU3BKKRF.js"),
      import("./mode.es2-Q6N5WNSU.js")
    ]).then((d13) => {
      if (!C5)
        return;
      g6.current = d13;
      const b8 = u10.current;
      if (!b8)
        return;
      const N7 = d13(b8, {
        value: i9,
      ...
      N7.addKeyMap({
        ...
        const { code: w6, key: V4, shiftKey: B3 } = x6, _7 = w6.startsWith("Key"), D6 = !B3 && w6.startsWith("Digit");
        (_7 || D6 || V4 === "_" || V4 === '"') && L3.execCommand("autocomplete");
      }), f14(N7);
    }), () => {
      C5 = false;
    };
  }, [e5, i9, l11, f14]), Ge6(h11, "keyMap", t17), Kt(
    h11,
    r9,
    on,
    "variables",
    me4
  ), Jt(h11, n7 || null, me4), te4(h11, ["Cmd-Enter", "Ctrl-Enter"], p7 == null ? void 0 : p7.run), te4(h11, ["Shift-Ctrl-P"], y8), te4(h11, ["Shift-Ctrl-M"], m12), u10;
}
s17(me4, "useVariableEditor");
var on = "variables";
var ln = ce4("EditorContext");
function So(e5) {
  const t17 = de4(), [n7, r9] = (0, import_react96.useState)(
    null
  ), [l11, c15] = (0, import_react96.useState)(null), [i9, h11] = (0, import_react96.useState)(
    null
  ), [f14, p7] = (0, import_react96.useState)(
    null
  ), [m12, y8] = (0, import_react96.useState)(
    () => {
      const v5 = (t17 == null ? void 0 : t17.get(ze5)) !== null;
      return e5.shouldPersistHeaders !== false && v5 ? (t17 == null ? void 0 : t17.get(ze5)) === "true" : !!e5.shouldPersistHeaders;
    }
  );
  Me4(n7, e5.headers), Me4(l11, e5.query), Me4(i9, e5.response), Me4(f14, e5.variables);
  const u10 = xo({
    storage: t17,
    shouldPersistHeaders: m12
  }), [g6] = (0, import_react96.useState)(() => {
    const v5 = e5.query ?? (t17 == null ? void 0 : t17.get(Xt)) ?? null, S10 = e5.variables ?? (t17 == null ? void 0 : t17.get(on)) ?? null, R3 = e5.headers ?? (t17 == null ? void 0 : t17.get(He6)) ?? null, U5 = e5.response ?? "", Y5 = Co({
      query: v5,
      variables: S10,
      headers: R3,
      defaultTabs: e5.defaultTabs,
      defaultQuery: e5.defaultQuery || No,
      defaultHeaders: e5.defaultHeaders,
      storage: t17
    });
    return u10(Y5), {
      query: v5 ?? (Y5.activeTabIndex === 0 ? Y5.tabs[0].query : null) ?? "",
      variables: S10 ?? "",
      headers: R3 ?? e5.defaultHeaders ?? "",
      response: U5,
      tabState: Y5
    };
  }), [C5, d13] = (0, import_react96.useState)(g6.tabState), b8 = (0, import_react96.useCallback)(
    (v5) => {
      if (v5) {
        t17 == null || t17.set(He6, (n7 == null ? void 0 : n7.getValue()) ?? "");
        const S10 = en(C5, true);
        t17 == null || t17.set(we5, S10);
      } else
        t17 == null || t17.set(He6, ""), Lo(t17);
      y8(v5), t17 == null || t17.set(ze5, v5.toString());
    },
    [t17, C5, n7]
  ), N7 = (0, import_react96.useRef)();
  (0, import_react96.useEffect)(() => {
    const v5 = !!e5.shouldPersistHeaders;
    N7.current !== v5 && (b8(v5), N7.current = v5);
  }, [e5.shouldPersistHeaders, b8]);
  const L3 = wo({
    queryEditor: l11,
    variableEditor: f14,
    headerEditor: n7,
    ...
    headerEditor: n7,
    responseEditor: i9
  }), { onTabChange: w6, defaultHeaders: V4, children: B3 } = e5, _7 = (0, import_react96.useCallback)(() => {
    d13((v5) => {
      const S10 = L3(v5), R3 = {
        tabs: [...S10.tabs, tn({ headers: V4 })],
        activeTabIndex: S10.tabs.length
      };
      return u10(R3), x6(R3.tabs[R3.activeTabIndex]), w6 == null || w6(R3), R3;
    });
  }, [
    V4,
    w6,
    ...
    u10,
    L3
  ]), D6 = (0, import_react96.useCallback)(
    (v5) => {
      d13((S10) => {
        const R3 = {
          ...S10,
    ...
    (v5) => {
      d13((S10) => {
        const R3 = S10.tabs[S10.activeTabIndex], U5 = {
          tabs: v5,
          activeTabIndex: v5.indexOf(R3)
        };
        return u10(U5), x6(U5.tabs[U5.activeTabIndex]), w6 == null || w6(U5), U5;
      });
    },
    [w6, x6, u10]
  ), W2 = (0, import_react96.useCallback)(
    (v5) => {
      d13((S10) => {
        const R3 = {
          tabs: S10.tabs.filter((U5, Y5) => v5 !== Y5),
    ...
    [w6, x6, u10]
  ), F8 = (0, import_react96.useCallback)(
    (v5) => {
      d13((S10) => {
        const R3 = nn(S10, v5);
    ...
    [w6, u10]
  ), { onEditOperationName: A6 } = e5, k2 = (0, import_react96.useCallback)(
    (v5) => {
      l11 && (l11.operationName = v5, F8({ operationName: v5 }), A6 == null || A6(v5));
    },
    [A6, l11, F8]
  ), H7 = (0, import_react96.useMemo)(() => {
    const v5 = /* @__PURE__ */ new Map();
    if (Array.isArray(e5.externalFragments))
      for (const S10 of e5.externalFragments)
        v5.set(S10.name.value, S10);
    else if (typeof e5.externalFragments == "string")
      visit(parse(e5.externalFragments, {}), {
        FragmentDefinition(S10) {
          v5.set(S10.name.value, S10);
        }
      });
    else if (e5.externalFragments)
      throw new Error(
    ...
    return v5;
  }, [e5.externalFragments]), E9 = (0, import_react96.useMemo)(
    () => e5.validationRules || [],
    [e5.validationRules]
  ), Z8 = (0, import_react96.useMemo)(
    () => ({
      ...C5,
      addTab: _7,
      changeTab: D6,
      ...
      setHeaderEditor: r9,
      setQueryEditor: c15,
      setResponseEditor: h11,
      setVariableEditor: p7,
      setOperationName: k2,
      initialQuery: g6.query,
      initialVariables: g6.variables,
      initialHeaders: g6.headers,
      initialResponse: g6.response,
      externalFragments: H7,
      validationRules: E9,
      shouldPersistHeaders: m12,
  ...
  return (0, import_jsx_runtime.jsx)(ln.Provider, { value: Z8, children: B3 });
}
...
`;
function Et({ isHidden: e5, ...t17 }) {
  const { headerEditor: n7 } = j6({
    nonNull: true,
    caller: Et
  }), r9 = Ce3(t17, Et);
  return (0, import_react96.useEffect)(() => {
    e5 || n7 == null || n7.refresh();
  }, [n7, e5]), (0, import_jsx_runtime.jsx)("div", { className: clsx("graphiql-editor", e5 && "hidden"), ref: r9 });
}
s17(Et, "HeaderEditor");
function lt(e5) {
  var f14;
  const [t17, n7] = (0, import_react96.useState)({
    width: null,
    height: null
  }), [r9, l11] = (0, import_react96.useState)(null), c15 = (0, import_react96.useRef)(null), i9 = (f14 = sn(e5.token)) == null ? void 0 : f14.href;
  (0, import_react96.useEffect)(() => {
    if (c15.current) {
      if (!i9) {
      ...
      fetch(i9, { method: "HEAD" }).then((p7) => {
        l11(p7.headers.get("Content-Type"));
      }).catch(() => {
        l11(null);
      });
    }
  }, [i9]);
  const h11 = t17.width !== null && t17.height !== null ? (0, import_jsx_runtime.jsxs)("div", { children: [
    t17.width,
    "x",
    t17.height,
    r9 === null ? null : " " + r9
    ...
    (0, import_jsx_runtime.jsx)(
      "img",
      {
        onLoad: () => {
          var p7, m12;
          n7({
            width: ((p7 = c15.current) == null ? void 0 : p7.naturalWidth) ?? null,
            height: ((m12 = c15.current) == null ? void 0 : m12.naturalHeight) ?? null
          });
        },
        ref: c15,
        src: i9
...
s17(lt, "ImagePreview");
lt.shouldRender = s17(function(t17) {
  const n7 = sn(t17);
...
function sn(e5) {
  if (e5.type !== "string")
    return;
  const t17 = e5.string.slice(1).slice(0, -1).trim();
  try {
    const { location: n7 } = window;
    return new URL(t17, n7.protocol + "//" + n7.host);
  } catch {
    return;
  }
}
s17(sn, "tokenToURL");
function ko(e5) {
  return /(bmp|gif|jpeg|jpg|png|svg)$/.test(e5.pathname);
}
s17(ko, "isImageURL");
function To(e5) {
  const t17 = se5(e5, To);
  return (0, import_jsx_runtime.jsx)("div", { className: "graphiql-editor", ref: t17 });
}
s17(To, "QueryEditor");
function it3({
  responseTooltip: e5,
  ...
  const { fetchError: l11, validationErrors: c15 } = re5({
    nonNull: true,
    caller: r9 || it3
  }), { initialResponse: i9, responseEditor: h11, setResponseEditor: f14 } = j6({
    nonNull: true,
    caller: r9 || it3
  }), p7 = (0, import_react96.useRef)(null), m12 = (0, import_react96.useRef)(
    e5
  );
  return (0, import_react96.useEffect)(() => {
    m12.current = e5;
  }, [e5]), (0, import_react96.useEffect)(() => {
    let y8 = true;
    return Se5(
      [
        import("./foldgutter.es-NKOXVEC5.js").then((u10) => u10.f),
        import("./brace-fold.es-VP5LGWRX.js").then((u10) => u10.b),
        import("./dialog.es-Y4ZXCP44.js").then((u10) => u10.d),
        import("./search.es-IKQJJVAQ.js").then((u10) => u10.s),
        import("./searchcursor.es-RKXSKNER.js").then((u10) => u10.s),
        import("./jump-to-line.es-VF5DKLXF.js").then((u10) => u10.j),
        // @ts-expect-error
        import("./sublime.es-6WJ2CBJK.js").then((u10) => u10.s),
        import("./mode.es3-CKXVZABF.js"),
      ...
      u10.registerHelper(
        ...
        "graphql-results",
        (b8, N7, L3, x6) => {
          const w6 = [], V4 = m12.current;
          return V4 && w6.push(
            (0, import_jsx_runtime.jsx)(V4, { pos: x6, token: b8 })
          ), lt.shouldRender(b8) && w6.push(
            (0, import_jsx_runtime.jsx)(lt, { token: b8 }, "image-preview")
          ), w6.length ? (import_react_dom2.default.render(w6, g6), g6) : (import_react_dom2.default.unmountComponentAtNode(g6), null);
        }
      );
      const C5 = p7.current;
      if (!C5)
  ...
  }, [t17, i9, f14]), Ge6(h11, "keyMap", n7), (0, import_react96.useEffect)(() => {
    l11 && (h11 == null || h11.setValue(l11)), c15.length > 0 && (h11 == null || h11.setValue(formatError(c15)));
  }, [h11, l11, c15]), p7;
}
...
function il({
  children: e5,
  dangerouslyAssumeSchemaIsValid: t17,
  defaultQuery: n7,
  defaultHeaders: r9,
  defaultTabs: l11,
  externalFragments: c15,
  fetcher: i9,
  getDefaultFieldNames: h11,
  headers: f14,
  ...
  onSchemaChange: g6,
  onTabChange: C5,
  onTogglePluginVisibility: d13,
  operationName: b8,
  plugins: N7,
  query: L3,
  response: x6,
  schema: w6,
  schemaDescription: V4,
  ...
  return (0, import_jsx_runtime.jsx)(Fn, { storage: _7, children: (0, import_jsx_runtime.jsx)(Wr, { maxHistoryLength: y8, children: (0, import_jsx_runtime.jsx)(
    So,
    {
      defaultQuery: n7,
      defaultHeaders: r9,
...
function sl() {
  const e5 = de4(), [t17, n7] = (0, import_react96.useState)(() => {
    if (!e5)
      return null;
    const l11 = e5.get(Ue4);
    switch (l11) {
      case "light":
        return "light";
      case "dark":
        return "dark";
      default:
        return typeof l11 == "string" && e5.set(Ue4, ""), null;
    }
  });
  (0, import_react96.useLayoutEffect)(() => {
    typeof window > "u" || (document.body.classList.remove("graphiql-light", "graphiql-dark"), t17 && document.body.classList.add(`graphiql-${t17}`));
  }, [t17]);
  const r9 = (0, import_react96.useCallback)(
    (l11) => {
      e5 == null || e5.set(Ue4, l11 || ""), n7(l11);
    },
    [e5]
  );
  return (0, import_react96.useMemo)(() => ({ theme: t17, setTheme: r9 }), [t17, r9]);
}
s17(sl, "useTheme");
var Ue4 = "theme";
function al({
  defaultSizeRelation: e5 = Vo,
  direction: t17,
  initiallyHidden: n7,
  onHiddenElementChange: r9,
  sizeThresholdFirst: l11 = 100,
  sizeThresholdSecond: c15 = 100,
  storageKey: i9
}) {
  const h11 = de4(), f14 = (0, import_react96.useMemo)(
    () => pe3(500, (L3) => {
      i9 && (h11 == null || h11.set(i9, L3));
    }),
    [h11, i9]
  ), [p7, m12] = (0, import_react96.useState)(
    () => {
      const L3 = i9 && (h11 == null ? void 0 : h11.get(i9));
      return L3 === Ve4 || n7 === "first" ? "first" : L3 === Re4 || n7 === "second" ? "second" : null;
    }
  ), y8 = (0, import_react96.useCallback)(
    (L3) => {
      L3 !== p7 && (m12(L3), r9 == null || r9(L3));
    },
    [p7, r9]
  ), u10 = (0, import_react96.useRef)(null), g6 = (0, import_react96.useRef)(null), C5 = (0, import_react96.useRef)(null), d13 = (0, import_react96.useRef)(`${e5}`);
  (0, import_react96.useLayoutEffect)(() => {
    const L3 = i9 && (h11 == null ? void 0 : h11.get(i9)) || d13.current;
    u10.current && (u10.current.style.display = "flex", u10.current.style.flex = L3 === Ve4 || L3 === Re4 ? d13.current : L3), C5.current && (C5.current.style.display = "flex", C5.current.style.flex = "1"), g6.current && (g6.current.style.display = "flex");
  }, [t17, h11, i9]);
  const b8 = (0, import_react96.useCallback)((L3) => {
    const x6 = L3 === "first" ? u10.current : C5.current;
    if (x6 && (x6.style.left = "-1000px", x6.style.position = "absolute", x6.style.opacity = "0", x6.style.height = "500px", x6.style.width = "500px", u10.current)) {
    ...
    (L3) => {
      const x6 = L3 === "first" ? u10.current : C5.current;
      if (x6 && (x6.style.width = "", x6.style.height = "", x6.style.opacity = "", x6.style.position = "", x6.style.left = "", h11 && i9)) {
        const w6 = h11.get(i9);
        u10.current && w6 !== Ve4 && w6 !== Re4 && (u10.current.style.flex = w6 || d13.current);
      }
    },
    [h11, i9]
  );
  ...
  }, [p7, b8, N7]), (0, import_react96.useEffect)(() => {
    if (!g6.current || !u10.current || !C5.current)
      return;
    const L3 = g6.current, x6 = u10.current, w6 = x6.parentElement, V4 = t17 === "horizontal" ? "clientX" : "clientY", B3 = t17 === "horizontal" ? "left" : "top", _7 = t17 === "horizontal" ? "right" : "bottom", D6 = t17 === "horizontal" ? "clientWidth" : "clientHeight";
    function O4(F8) {
      F8.preventDefault();
      const A6 = F8[V4] - L3.getBoundingClientRect()[B3];
      function k2(E9) {
        if (E9.buttons === 0)
          return H7();
        const Z8 = E9[V4] - w6.getBoundingClientRect()[B3] - A6, v5 = w6.getBoundingClientRect()[_7] - E9[V4] + A6 - L3[D6];
        if (Z8 < l11)
          y8("first"), f14(Ve4);
        else if (v5 < c15)
          y8("second"), f14(Re4);
          ...
          y8(null);
          const S10 = `${Z8 / v5}`;
          x6.style.flex = S10, f14(S10);
        }
      }
      s17(k2, "handleMouseMove");
      function H7() {
        document.removeEventListener("mousemove", k2), document.removeEventListener("mouseup", H7);
      }
      s17(H7, "handleMouseUp"), document.addEventListener("mousemove", k2), document.addEventListener("mouseup", H7);
    }
    s17(O4, "handleMouseDown"), L3.addEventListener("mousedown", O4);
    function W2() {
      u10.current && (u10.current.style.flex = d13.current), f14(d13.current), y8(null);
    }
...
var Ve4 = "hide-first";
var Re4 = "hide-second";
var Ro = (0, import_react96.forwardRef)(({ label: e5, onClick: t17, ...n7 }, r9) => {
  const [l11, c15] = (0, import_react96.useState)(null), i9 = (0, import_react96.useCallback)(
    (h11) => {
      try {
        t17 == null || t17(h11), c15(null);
      } catch (f14) {
        c15(
  ...
  return (0, import_jsx_runtime.jsx)(ae4, { label: e5, children: (0, import_jsx_runtime.jsx)(
    X5,
    {
      ...n7,
      ref: r9,
...
function St() {
  const { queryEditor: e5, setOperationName: t17 } = j6({
    nonNull: true,
    caller: St
  }), { isFetching: n7, isSubscribed: r9, operationName: l11, run: c15, stop: i9 } = We5({
    nonNull: true,
    caller: St
  }), h11 = (e5 == null ? void 0 : e5.operations) || [], f14 = h11.length > 1 && typeof l11 != "string", p7 = n7 || r9, m12 = `${p7 ? "Stop" : "Execute"} query (Ctrl-Enter)`, y8 = {
    type: "button",
    className: "graphiql-execute-button",
    children: p7 ? (0, import_jsx_runtime.jsx)(Pr, {}) : (0, import_jsx_runtime.jsx)(Vr, {}),
    "aria-label": m12
  };
  return f14 && !p7 ? (0, import_jsx_runtime.jsxs)(le4, { children: [
    (0, import_jsx_runtime.jsx)(ae4, { label: m12, children: (0, import_jsx_runtime.jsx)(le4.Button, { ...y8 }) }),
    (0, import_jsx_runtime.jsx)(le4.Content, { children: h11.map((u10, g6) => {
      ...
      return (0, import_jsx_runtime.jsx)(
        le4.Item,
        {
          onSelect: () => {
            var b8;
            const d13 = (b8 = u10.name) == null ? void 0 : b8.value;
            e5 && d13 && d13 !== e5.operationName && t17(d13), c15();
          },
          children: C5
        },
        `${C5}-${g6}`
  ...
  ] }) : (0, import_jsx_runtime.jsx)(ae4, { label: m12, children: (0, import_jsx_runtime.jsx)(
    "button",
    {
      ...y8,
      onClick: () => {
...
var Ho = s17(({
  ...
  label: n7,
  ...r9
}) => (0, import_jsx_runtime.jsxs)(le4, { ...r9, children: [
  (0, import_jsx_runtime.jsx)(ae4, { label: n7, children: (0, import_jsx_runtime.jsx)(
    le4.Button,
    {
      className: clsx(
  ...
  (0, import_jsx_runtime.jsx)(le4.Content, { children: t17 })
] }), "ToolbarMenuRoot");
var cl = Le5(Ho, {
  Item: le4.Item
});
...
var __assign2 = function() {
  __assign2 = Object.assign || function(t17) {
...
var __rest2 = function(s18, e5) {
  var t17 = {};
  for (var p7 in s18)
    if (Object.prototype.hasOwnProperty.call(s18, p7) && e5.indexOf(p7) < 0)
      t17[p7] = s18[p7];
  if (s18 != null && typeof Object.getOwnPropertySymbols === "function")
    for (var i9 = 0, p7 = Object.getOwnPropertySymbols(s18); i9 < p7.length; i9++) {
      if (e5.indexOf(p7[i9]) < 0 && Object.prototype.propertyIsEnumerable.call(s18, p7[i9]))
        t17[p7[i9]] = s18[p7[i9]];
    }
  return t17;
};
...
function GraphiQLInterface(props) {
  ...
  var handlePluginClick = (0, import_react98.useCallback)(function(e5) {
    var context = pluginContext;
    var pluginIndex = Number(e5.currentTarget.dataset.index);
    var plugin = context.plugins.find(function(_7, index2) {
            ...
            import_react98.default.createElement(
              ...
              import_react98.default.createElement(
                ...
                import_react98.default.createElement(
                  ...
                  executionContext.isFetching ? import_react98.default.createElement(qt, null) : null,
      ...
      import_react98.default.createElement(
        ...
        props.showPersistHeadersSettings ? import_react98.default.createElement(
          ...
          import_react98.default.createElement(
            qr,
            null,
            import_react98.default.createElement(Fe4, { type: "button", id: "enable-persist-headers", className: editorContext.shouldPersistHeaders ? "active" : "", "data-value": "true", onClick: handlePersistHeaders }, "On"),
            import_react98.default.createElement(Fe4, { type: "button", id: "disable-persist-headers", className: editorContext.shouldPersistHeaders ? "" : "active", onClick: handlePersistHeaders }, "Off")
          )
        ) : null,
        import_react98.default.createElement(
          "div",
          ...
          import_react98.default.createElement(
            ...
            import_react98.default.createElement(
              qr,
              null,
              import_react98.default.createElement(Fe4, { type: "button", className: theme === null ? "active" : "", onClick: handleChangeTheme }, "System"),
              import_react98.default.createElement(Fe4, { type: "button", className: theme === "light" ? "active" : "", "data-theme": "light", onClick: handleChangeTheme }, "Light"),
              import_react98.default.createElement(Fe4, { type: "button", className: theme === "dark" ? "active" : "", "data-theme": "dark", onClick: handleChangeTheme }, "Dark")
            )
          )
        ),
        storageContext ? import_react98.default.createElement(
          ...
          import_react98.default.createElement(
            "div",
            null,
            import_react98.default.createElement(Fe4, { type: "button", state: clearStorageStatus || void 0, disabled: clearStorageStatus === "success", onClick: handleClearData }, clearStorageStatus === "success" ? "Cleared data" : clearStorageStatus === "error" ? "Failed" : "Clear data")
          )
        ) : null
      )
    )
